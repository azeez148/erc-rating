...
public class BOPPolltnExclLimitedExcptnForDesignatedPollutants    extends Policy  {
	...
	private int RemedialActionCostsAggregateLimit;
	...
	public int  getRemedialActionCostsAggregateLimit() {
		return this.RemedialActionCostsAggregateLimit;
	}
	...
	public String  getDesignatedPollutants() {
		return this.DesignatedPollutants;
	}
	...
	public void setDesignatedPollutants(String DesignatedPollutants) {
		this.DesignatedPollutants = DesignatedPollutants;
	}
	...
	public void setRemedialActionCostsAggregateLimit(int RemedialActionCostsAggregateLimit) {
		this.RemedialActionCostsAggregateLimit = RemedialActionCostsAggregateLimit;
	}
