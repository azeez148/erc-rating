...
public class BOPUtilitySrvcsTimeElementCommunicationExcludingOverheadEQCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPUtilitySrvcsTimeElementCommunicationExcludingOverheadEQCoverage BOPUtilitySrvcsTimeElementCommunicationExcludingOverheadEQCoverage;
	
	
	
	public  BOPUtilitySrvcsTimeElementCommunicationExcludingOverheadEQCoverage (com.nest.res.bop.al01012026.domain.BOPUtilitySrvcsTimeElementCommunicationExcludingOverheadEQCoverage BOPUtilitySrvcsTimeElementCommunicationExcludingOverheadEQCoverage)  {
