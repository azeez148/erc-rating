...
public class BOPDesignatedProjectsProductsCompletedOperationsAggregateLimit    extends Policy  {
	...
	private List<BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail> BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail) {
			childs.addAll(BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail);
		}
		return childs;
	}
	...
	public List<BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail> getBOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail() {
		return this.BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail;
	}
	...
	public void setBOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail(List<BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail> BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail) {
		this.BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail = BOPDesignatedProjectsProductsCompletedOperationsAggregateLimitDetail;
	}
