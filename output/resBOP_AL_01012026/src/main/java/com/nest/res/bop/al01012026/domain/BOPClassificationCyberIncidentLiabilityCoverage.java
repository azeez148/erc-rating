...
public class BOPClassificationCyberIncidentLiabilityCoverage    extends Policy  {
	...
	private String CyberIncidentAggregateLimit;
	...
	private double CyberIncidentLiabilityFactor;
	...
	private String EachCyberIncidentOccurrenceLimit;
	...
	public String  getCyberIncidentAggregateLimit() {
		return this.CyberIncidentAggregateLimit;
	}
	public double  getShortRatePenalty() {
		return this.ShortRatePenalty;
	}
	public double  getCyberIncidentLiabilityFactor() {
		return this.CyberIncidentLiabilityFactor;
	}
	...
	public String  getEachCyberIncidentOccurrenceLimit() {
		return this.EachCyberIncidentOccurrenceLimit;
	}
	...
	public void setEachCyberIncidentOccurrenceLimit(String EachCyberIncidentOccurrenceLimit) {
		this.EachCyberIncidentOccurrenceLimit = EachCyberIncidentOccurrenceLimit;
	}
	...
	public void setCyberIncidentAggregateLimit(String CyberIncidentAggregateLimit) {
		this.CyberIncidentAggregateLimit = CyberIncidentAggregateLimit;
	}
	...
	public void setCyberIncidentLiabilityFactor(double CyberIncidentLiabilityFactor) {
		this.CyberIncidentLiabilityFactor = CyberIncidentLiabilityFactor;
	}
