...
public class BOPDiscretionaryPayrollExpenseDetail    extends Policy  {
	...
	public String  getMaxNumOfDays() {
		return this.MaxNumOfDays;
	}
	...
	public String  getJobClassOrEmps() {
		return this.JobClassOrEmps;
	}
	...
	public void setJobClassOrEmps(String JobClassOrEmps) {
		this.JobClassOrEmps = JobClassOrEmps;
	}
	public void setMaxNumOfDays(String MaxNumOfDays) {
