package com.nest.res.bop.al01012026.rate;
...
import com.nest.res.bop.al01012026.rules.BOP;
...
public class BOPRateDriver  implements RESRateDriver    {
	...
	private Double processRate (RESCommon resCommon) throws LookupException, FileNotFoundException, NumberFormatException, ParseException {
	  ...
	  com.nest.res.bop.al01012026.domain.PolicyCommon policyCommon = (com.nest.res.bop.al01012026.domain.PolicyCommon)policy;
