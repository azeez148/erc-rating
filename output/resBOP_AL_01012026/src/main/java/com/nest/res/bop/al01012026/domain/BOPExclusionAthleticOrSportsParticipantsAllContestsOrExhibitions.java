...
public class BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitions    extends Policy  {
	...
	private List<BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail> BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail) {
			childs.addAll(BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail);
		}
		return childs;
	}
	...
	public List<BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail> getBOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail() {
		return this.BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail;
	}
	...
	public void setBOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail(List<BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail> BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail) {
		this.BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail = BOPExclusionAthleticOrSportsParticipantsAllContestsOrExhibitionsDetail;
	}
}