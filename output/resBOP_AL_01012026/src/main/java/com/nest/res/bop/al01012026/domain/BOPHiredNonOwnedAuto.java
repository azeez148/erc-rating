...
public class BOPHiredNonOwnedAuto    extends Policy  {
	...
	private List<BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage> BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage;
	private int TermFactorIndicator;
	private double ShortRateFactor;
	private String ParentId;
	private List<BOPHiredNonOwnedAutoHiredCoverage> BOPHiredNonOwnedAutoHiredCoverage;
	private List<BOPHiredNonOwnedAutoNonOwnedCoverage> BOPHiredNonOwnedAutoNonOwnedCoverage;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage) {
			childs.addAll(BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage);
		}
		if(null != BOPHiredNonOwnedAutoHiredCoverage) {
			childs.addAll(BOPHiredNonOwnedAutoHiredCoverage);
		}
		if(null != BOPHiredNonOwnedAutoNonOwnedCoverage) {
			childs.addAll(BOPHiredNonOwnedAutoNonOwnedCoverage);
		}
		return childs;
	}


	public List<BOPHiredNonOwnedAutoNonOwnedCoverage> getBOPHiredNonOwnedAutoNonOwnedCoverage() {
		return this.BOPHiredNonOwnedAutoNonOwnedCoverage;
	}
	public String  getFormName() {
		return this.FormName;
	}
	public List<BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage> getBOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage() {
		return this.BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage;
	}
	...
	public List<BOPHiredNonOwnedAutoHiredCoverage> getBOPHiredNonOwnedAutoHiredCoverage() {
		return this.BOPHiredNonOwnedAutoHiredCoverage;
	}
	...
	public void setBOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage(List<BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage> BOPHiredNonOwnedAutoNonOwnedNoDeliveryCoverage) {
	...
	public void setBOPHiredNonOwnedAutoNonOwnedCoverage(List<BOPHiredNonOwnedAutoNonOwnedCoverage> BOPHiredNonOwnedAutoNonOwnedCoverage) {
	...
	public void setBOPHiredNonOwnedAutoHiredCoverage(List<BOPHiredNonOwnedAutoHiredCoverage> BOPHiredNonOwnedAutoHiredCoverage) {
