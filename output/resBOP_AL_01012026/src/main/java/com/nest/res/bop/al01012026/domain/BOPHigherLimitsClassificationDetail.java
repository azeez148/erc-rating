...
public class BOPHigherLimitsClassificationDetail    extends Policy  {
	...
	private int RevisedAmountOfInsurance;
	private String DescriptionOfCoverage;
	...
	public int  getRevisedAmountOfInsurance() {
		return this.RevisedAmountOfInsurance;
	}
	...
	public String  getDescriptionOfCoverage() {
		return this.DescriptionOfCoverage;
	}
	...
	public void setDescriptionOfCoverage(String DescriptionOfCoverage) {
		this.DescriptionOfCoverage = DescriptionOfCoverage;
	}
	...
	public void setRevisedAmountOfInsurance(int RevisedAmountOfInsurance) {
		this.RevisedAmountOfInsurance = RevisedAmountOfInsurance;
	}
