...
public class BOPBarbersBeauticiansProflLiabBeauticiansCoverage    extends Policy  {
	...
	public int  getNumBeauticians() {
		return this.NumBeauticians;
	}
	...
	public int  getNumPartTimeBeauticians() {
		return this.NumPartTimeBeauticians;
	}
	...
	public String  getBeauticiansHeader() {
		return this.BeauticiansHeader;
	}
	...
	public int  getNumFullTimeBeauticians() {
		return this.NumFullTimeBeauticians;
	}
	...
	public void setNumFullTimeBeauticians(int NumFullTimeBeauticians) {
		this.NumFullTimeBeauticians = NumFullTimeBeauticians;
	}
	...
	public void setBeauticiansHeader(String BeauticiansHeader) {
		this.BeauticiansHeader = BeauticiansHeader;
	}
	...
	public void setNumPartTimeBeauticians(int NumPartTimeBeauticians) {
		this.NumPartTimeBeauticians = NumPartTimeBeauticians;
	}
	...
	public void setNumBeauticians(int NumBeauticians) {
		this.NumBeauticians = NumBeauticians;
	}
	...
	public void setFullTimeRate(double FullTimeRate) {
