...
public class BOPCondoCommercialUnitOwnersOptionalLossAssmtCoverage    extends Policy  {
	...
	private double AddlIncrementPremium;
	private int dsLimit;
	...
	public double  getAddlIncrementPremium() {
		return this.AddlIncrementPremium;
	}
	...
	public void setAddlIncrementPremium(double AddlIncrementPremium) {
		this.AddlIncrementPremium = AddlIncrementPremium;
	}
