...
public class BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage    extends Policy  {
	...
	public double  getNumDaysFactor() {
		return this.NumDaysFactor;
	}
	...
	public void setNumDaysFactor(double NumDaysFactor) {
		this.NumDaysFactor = NumDaysFactor;
	}
