...
public class BOPAbuseOrMolestationExclSpecdSrvcs    extends Policy  {
	...
	public String  getDescOfSrvcs() {
		return this.DescOfSrvcs;
	}
	...
	public void setDescOfSrvcs(String DescOfSrvcs) {
		this.DescOfSrvcs = DescOfSrvcs;
	}
