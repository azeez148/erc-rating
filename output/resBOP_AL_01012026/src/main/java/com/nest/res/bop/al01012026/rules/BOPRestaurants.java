...
import com.nest.res.bop.al01012026.domain.BOPRestaurantsRestaurantsCoverage;
import com.nest.res.bop.al01012026.domain.BOPRestaurantsSpoilageCoverage;
import com.nest.res.bop.al01012026.domain.BOPRestaurantsAdvertisingExpenseCoverage;
import com.nest.res.bop.al01012026.domain.BOPRestaurantFoodContaminationCoverage;
...
public class BOPRestaurants  {
	...
	private com.nest.res.bop.al01012026.rules.BOPRestaurantFoodContaminationCoverage BOPRestaurantFoodContaminationCoverageRule;
	private com.nest.res.bop.al01012026.rules.BOPRestaurantsAdvertisingExpenseCoverage BOPRestaurantsAdvertisingExpenseCoverageRule;
	private List<BOPRestaurantsRestaurantsCoverage> BOPRestaurantsRestaurantsCoverageList;
	private com.nest.res.bop.al01012026.rules.BOPRestaurantsRestaurantsCoverage BOPRestaurantsRestaurantsCoverageRule;
	private List<BOPRestaurantsSpoilageCoverage> BOPRestaurantsSpoilageCoverageList;
	private com.nest.res.bop.al01012026.domain.BOPRestaurants BOPRestaurants;
	private List<BOPRestaurantsAdvertisingExpenseCoverage> BOPRestaurantsAdvertisingExpenseCoverageList;
	private com.nest.res.bop.al01012026.rules.BOPRestaurantsSpoilageCoverage BOPRestaurantsSpoilageCoverageRule;
...
this.BOPRestaurants.setPremium(MathHelper.getDoubleValue(this.BOPRestaurants.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPRestaurants,"BOPRestaurantsSpoilageCoverage/Premium")))));
	...
	public  BOPRestaurants (com.nest.res.bop.al01012026.domain.BOPRestaurants BOPRestaurants)  {
...
this.BOPRestaurantFoodContaminationCoverageList = BOPRestaurants.getBOPRestaurantFoodContaminationCoverage();
	...
	if(null != BOPRestaurantFoodContaminationCoverageList){
		for(BOPRestaurantFoodContaminationCoverage BOPRestaurantFoodContaminationCoverage:BOPRestaurantFoodContaminationCoverageList){
			BOPRestaurantFoodContaminationCoverageRule = new com.nest.res.bop.al01012026.rules.BOPRestaurantFoodContaminationCoverage(BOPRestaurantFoodContaminationCoverage);
	...
	if(null != BOPRestaurantsAdvertisingExpenseCoverageList){
		for(BOPRestaurantsAdvertisingExpenseCoverage BOPRestaurantsAdvertisingExpenseCoverage:BOPRestaurantsAdvertisingExpenseCoverageList){
			BOPRestaurantsAdvertisingExpenseCoverageRule = new com.nest.res.bop.al01012026.rules.BOPRestaurantsAdvertisingExpenseCoverage(BOPRestaurantsAdvertisingExpenseCoverage);
	...
	if(null != BOPRestaurantsRestaurantsCoverageList){
		for(BOPRestaurantsRestaurantsCoverage BOPRestaurantsRestaurantsCoverage:BOPRestaurantsRestaurantsCoverageList){
			BOPRestaurantsRestaurantsCoverageRule = new com.nest.res.bop.al01012026.rules.BOPRestaurantsRestaurantsCoverage(BOPRestaurantsRestaurantsCoverage);
	...
	if(null != BOPRestaurantsSpoilageCoverageList){
		for(BOPRestaurantsSpoilageCoverage BOPRestaurantsSpoilageCoverage:BOPRestaurantsSpoilageCoverageList){
			BOPRestaurantsSpoilageCoverageRule = new com.nest.res.bop.al01012026.rules.BOPRestaurantsSpoilageCoverage(BOPRestaurantsSpoilageCoverage);
