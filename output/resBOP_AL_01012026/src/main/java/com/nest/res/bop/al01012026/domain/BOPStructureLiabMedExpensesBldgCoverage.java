...
public class BOPStructureLiabMedExpensesBldgCoverage    extends Policy  {
	private int FeeIndicator;
	private String PropDamageLiabDedStatAmount;
	private String FormNumber;
	private String LessorLiabilityRatingBasisStatCode;
	private String structClassGroup;
	...
	private int TotalCondominiumBuildingSquareFootage;
	private String PriorId;
	private String LiabilityFormStatCode;
	private String structClassCode;
	private double BaseRateRABOP;
	private double EvaluatedPremium;
	private String FormName;
	private int TermFactorIndicator;
	private String ProdCompdOperHazardMedicalPaymentsStatCode;
	private String CreatedBy;
	private int TaxIndicator;
	private int structBuildingLimit;
	private double IncrLimitFactor;
	private int PremiumIndicator;
	private Date Expiration;
	private int totalArea_1;
	private double ChangePremium;
	private int CondominiumBuildingLimitOfInsurance;
	...
	private String LessorLiabilityACVRatingBasisStatCode;
	private String MoldDamageStatCode;
	private Date Modified;
	private String StateExceptionIndicatorIIStatCode;
	private Date RateDt;
	...
	private double ClassGroupFactor;
	private double baseRateToUse_1;
	private double CombinedBaseRate;
	...
	public String  getPropDamageLiabDedStatAmount() {
	...
	public int  getTotalCondominiumBuildingSquareFootage() {
		return this.TotalCondominiumBuildingSquareFootage;
	}
	public double  getEvaluatedPremium() {
		return this.EvaluatedPremium;
	}
	public int  getTotalArea_1() {
	...
	public String  getStructClassGroup() {
		return this.structClassGroup;
	}
	public int  getCondominiumBuildingLimitOfInsurance() {
		return this.CondominiumBuildingLimitOfInsurance;
	}
	...
	public String  getLessorLiabilityRatingBasisStatCode() {
		return this.LessorLiabilityRatingBasisStatCode;
	}
	...
	public double  getBaseRateRABOP() {
		return this.BaseRateRABOP;
	}
	public String  getStructClassCode() {
		return this.structClassCode;
	}
	...
	public double  getClassGroupFactor() {
		return this.ClassGroupFactor;
	}
	...
	public String  getStateExceptionIndicatorIIStatCode() {
		return this.StateExceptionIndicatorIIStatCode;
	}
	public int  getStructBuildingLimit() {
		return this.structBuildingLimit;
	}
	public String  getLiabilityFormStatCode() {
		return this.LiabilityFormStatCode;
	}
	...
	public String  getLessorLiabilityACVRatingBasisStatCode() {
		return this.LessorLiabilityACVRatingBasisStatCode;
	}
	public String  getProdCompdOperHazardMedicalPaymentsStatCode() {
		return this.ProdCompdOperHazardMedicalPaymentsStatCode;
	}
	...
	public double  getBaseRateToUse_1() {
		return this.baseRateToUse_1;
	}
	...
	public double  getCombinedBaseRate() {
		return this.CombinedBaseRate;
	}
	...
	public void setLessorLiabilityACVRatingBasisStatCode(String LessorLiabilityACVRatingBasisStatCode) {
		this.LessorLiabilityACVRatingBasisStatCode = LessorLiabilityACVRatingBasisStatCode;
	}
	...
	public void setLessorLiabilityRatingBasisStatCode(String LessorLiabilityRatingBasisStatCode) {
		this.LessorLiabilityRatingBasisStatCode = LessorLiabilityRatingBasisStatCode;
	}
	public void setStructClassGroup(String structClassGroup) {
		this.structClassGroup = structClassGroup;
	}
	public void setStructBuildingLimit(int structBuildingLimit) {
		this.structBuildingLimit = structBuildingLimit;
	}
	...
	public void setStructClassCode(String structClassCode) {
		this.structClassCode = structClassCode;
	}
	...
	public void setCombinedBaseRate(double CombinedBaseRate) {
		this.CombinedBaseRate = CombinedBaseRate;
	}
	...
	public void setTotalCondominiumBuildingSquareFootage(int TotalCondominiumBuildingSquareFootage) {
		this.TotalCondominiumBuildingSquareFootage = TotalCondominiumBuildingSquareFootage;
	}
	...
	public void setCondominiumBuildingLimitOfInsurance(int CondominiumBuildingLimitOfInsurance) {
		this.CondominiumBuildingLimitOfInsurance = CondominiumBuildingLimitOfInsurance;
	}
	...
	public void setBaseRateRABOP(double BaseRateRABOP) {
		this.BaseRateRABOP = BaseRateRABOP;
	}
	public void setTotalArea_1(int totalArea_1) {
	...
	public void setBaseRateToUse_1(double baseRateToUse_1) {
		this.baseRateToUse_1 = baseRateToUse_1;
	}
	...
	public void setLiabilityFormStatCode(String LiabilityFormStatCode) {
		this.LiabilityFormStatCode = LiabilityFormStatCode;
	}
	...
	public void setPropDamageLiabDedStatAmount(String PropDamageLiabDedStatAmount) {
	...
	public void setStateExceptionIndicatorIIStatCode(String StateExceptionIndicatorIIStatCode) {
		this.StateExceptionIndicatorIIStatCode = StateExceptionIndicatorIIStatCode;
	}
	public void setProdCompdOperHazardMedicalPaymentsStatCode(String ProdCompdOperHazardMedicalPaymentsStatCode) {
		this.ProdCompdOperHazardMedicalPaymentsStatCode = ProdCompdOperHazardMedicalPaymentsStatCode;
	}
	...
	public void setClassGroupFactor(double ClassGroupFactor) {
		this.ClassGroupFactor = ClassGroupFactor;
	}
