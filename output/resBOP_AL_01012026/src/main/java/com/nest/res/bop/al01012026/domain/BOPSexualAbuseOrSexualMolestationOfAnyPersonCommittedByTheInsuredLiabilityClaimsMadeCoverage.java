...
public class BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverage    extends Policy  {
	private List<BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail> BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail;
	...
	private String RetroDateSelect;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail) {
			childs.addAll(BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail);
		}
		return childs;
	}
	...
	public List<BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail> getBOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail() {
		return this.BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail;
	}
	...
	public int  getEachActDeductible() {
		return this.EachActDeductible;
	}
	public int  getEachActLimit() {
		return this.EachActLimit;
	}
	public String  getRetroDateSelect() {
		return this.RetroDateSelect;
	}
	...
	public void setEachActLimit(int EachActLimit) {
		this.EachActLimit = EachActLimit;
	}
	...
	public void setRetroDateSelect(String RetroDateSelect) {
		this.RetroDateSelect = RetroDateSelect;
	}
	...
	public void setBOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail(List<BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail> BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail) {
		this.BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail = BOPSexualAbuseOrSexualMolestationOfAnyPersonCommittedByTheInsuredLiabilityClaimsMadeCoverageDetail;
	}
	...
	public void setEachActDeductible(int EachActDeductible) {
		this.EachActDeductible = EachActDeductible;
	}
