...
public class BOPMicroRetail    extends Policy  {
	...
	private List<BOPMicroRetailCoverage> BOPMicroRetailCoverage;
	private List<BOPMicroRetailStockCoverage> BOPMicroRetailStockCoverage;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPMicroRetailCoverage) {
			childs.addAll(BOPMicroRetailCoverage);
		}
		if(null != BOPMicroRetailStockCoverage) {
			childs.addAll(BOPMicroRetailStockCoverage);
		}
		return childs;
	}


	public List<BOPMicroRetailCoverage> getBOPMicroRetailCoverage() {
		return this.BOPMicroRetailCoverage;
	}
	...
	public List<BOPMicroRetailStockCoverage> getBOPMicroRetailStockCoverage() {
		return this.BOPMicroRetailStockCoverage;
	}
	...
	public void setBOPMicroRetailStockCoverage(List<BOPMicroRetailStockCoverage> BOPMicroRetailStockCoverage) {
	...
	public void setBOPMicroRetailCoverage(List<BOPMicroRetailCoverage> BOPMicroRetailCoverage) {
