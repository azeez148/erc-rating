...
public class BOPClassificationSwimmingPoolCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPClassificationSwimmingPoolCoverage BOPClassificationSwimmingPoolCoverage;
	
	
	
	public  BOPClassificationSwimmingPoolCoverage (com.nest.res.bop.al01012026.domain.BOPClassificationSwimmingPoolCoverage BOPClassificationSwimmingPoolCoverage)  {
