...
public class BOPAddlInsdOwnersLesseesOrContrctrsCompldOpsStateDetail    extends Policy  {
	...
	public String  getLocationAndDescription() {
		return this.LocationAndDescription;
	}
	...
	public String  getNameOfAddlInsd() {
		return this.NameOfAddlInsd;
	}
	...
	public void setLocationAndDescription(String LocationAndDescription) {
	...
	public void setNameOfAddlInsd(String NameOfAddlInsd) {
		this.NameOfAddlInsd = NameOfAddlInsd;
	}
