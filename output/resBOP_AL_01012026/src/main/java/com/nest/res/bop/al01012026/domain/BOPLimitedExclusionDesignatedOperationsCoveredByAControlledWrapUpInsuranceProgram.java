...
public class BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgram    extends Policy  {
	...
	private List<BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail> BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail) {
			childs.addAll(BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail);
		}
		return childs;
	}
	...
	public List<BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail> getBOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail() {
		return this.BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail;
	}
	...
	public void setBOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail(List<BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail> BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail) {
		this.BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail = BOPLimitedExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail;
	}
