...
public class BOPLiquorLiab  {
	...
	private com.nest.res.bop.al01012026.domain.BOPLiquorLiab BOPLiquorLiab;
	
	
	
	public  BOPLiquorLiab (com.nest.res.bop.al01012026.domain.BOPLiquorLiab BOPLiquorLiab)  {
