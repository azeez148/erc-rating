...
public class BOPAddlInsdCoOwnerInsdPremises    extends Policy  {
	...
	private List<BOPAddlInsdCoOwnerInsdPremisesDetail> BOPAddlInsdCoOwnerInsdPremisesDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdCoOwnerInsdPremisesDetail) {
			childs.addAll(BOPAddlInsdCoOwnerInsdPremisesDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdCoOwnerInsdPremisesDetail> getBOPAddlInsdCoOwnerInsdPremisesDetail() {
		return this.BOPAddlInsdCoOwnerInsdPremisesDetail;
	}
	...
	public void setBOPAddlInsdCoOwnerInsdPremisesDetail(List<BOPAddlInsdCoOwnerInsdPremisesDetail> BOPAddlInsdCoOwnerInsdPremisesDetail) {
		this.BOPAddlInsdCoOwnerInsdPremisesDetail = BOPAddlInsdCoOwnerInsdPremisesDetail;
	}
