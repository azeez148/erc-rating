...
public class BOPExclusionAthleticOrSportsParticipants    extends Policy  {
	...
	private List<BOPExclusionAthleticOrSportsParticipantsDetail> BOPExclusionAthleticOrSportsParticipantsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPExclusionAthleticOrSportsParticipantsDetail) {
			childs.addAll(BOPExclusionAthleticOrSportsParticipantsDetail);
		}
		return childs;
	}
	...
	public List<BOPExclusionAthleticOrSportsParticipantsDetail> getBOPExclusionAthleticOrSportsParticipantsDetail() {
		return this.BOPExclusionAthleticOrSportsParticipantsDetail;
	}
	...
	public void setBOPExclusionAthleticOrSportsParticipantsDetail(List<BOPExclusionAthleticOrSportsParticipantsDetail> BOPExclusionAthleticOrSportsParticipantsDetail) {
		this.BOPExclusionAthleticOrSportsParticipantsDetail = BOPExclusionAthleticOrSportsParticipantsDetail;
	}
