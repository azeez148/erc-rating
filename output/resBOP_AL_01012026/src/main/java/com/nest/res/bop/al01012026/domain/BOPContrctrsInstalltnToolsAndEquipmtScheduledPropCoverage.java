...
public class BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage    extends Policy  {
	...
	public int  getAdjustedTotLimit() {
		return this.AdjustedTotLimit;
	}
	...
	public void setAdjustedTotLimit(int AdjustedTotLimit) {
		this.AdjustedTotLimit = AdjustedTotLimit;
	}
