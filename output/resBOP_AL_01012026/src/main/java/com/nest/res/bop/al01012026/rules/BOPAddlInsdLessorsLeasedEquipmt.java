...
import com.nest.res.bop.al01012026.domain.BOPAddlInsdLessorsLeasedEquipmtDetail;
...
public class BOPAddlInsdLessorsLeasedEquipmt  {
	...
	private com.nest.res.bop.al01012026.rules.BOPAddlInsdLessorsLeasedEquipmtDetail BOPAddlInsdLessorsLeasedEquipmtDetailRule;
	private com.nest.res.bop.al01012026.domain.BOPAddlInsdLessorsLeasedEquipmt BOPAddlInsdLessorsLeasedEquipmt;
	
	
	
	public  BOPAddlInsdLessorsLeasedEquipmt (com.nest.res.bop.al01012026.domain.BOPAddlInsdLessorsLeasedEquipmt BOPAddlInsdLessorsLeasedEquipmt)  {
...
this.BOPAddlInsdLessorsLeasedEquipmtDetailList = BOPAddlInsdLessorsLeasedEquipmt.getBOPAddlInsdLessorsLeasedEquipmtDetail();
	...
	if(null != BOPAddlInsdLessorsLeasedEquipmtDetailList){
		for(BOPAddlInsdLessorsLeasedEquipmtDetail BOPAddlInsdLessorsLeasedEquipmtDetail:BOPAddlInsdLessorsLeasedEquipmtDetailList){
			BOPAddlInsdLessorsLeasedEquipmtDetailRule = new com.nest.res.bop.al01012026.rules.BOPAddlInsdLessorsLeasedEquipmtDetail(BOPAddlInsdLessorsLeasedEquipmtDetail);
