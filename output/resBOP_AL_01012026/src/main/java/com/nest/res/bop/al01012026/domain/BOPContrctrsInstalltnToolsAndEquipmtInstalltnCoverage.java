...
public class BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverage    extends Policy  {
	...
	private int AllCoveredJobSitesLimit;
	...
	private int EachCoveredJobSiteLimit;
	private int dsLimit;
	private int ExposureStatAmountTemp;
	...
	public int  getEachCoveredJobSiteLimit() {
		return this.EachCoveredJobSiteLimit;
	}
	...
	public int  getExposureStatAmountTemp() {
		return this.ExposureStatAmountTemp;
	}
	...
	public int  getAllCoveredJobSitesLimit() {
		return this.AllCoveredJobSitesLimit;
	}
	...
	public void setExposureStatAmountTemp(int ExposureStatAmountTemp) {
		this.ExposureStatAmountTemp = ExposureStatAmountTemp;
	}
	...
	public void setEachCoveredJobSiteLimit(int EachCoveredJobSiteLimit) {
		this.EachCoveredJobSiteLimit = EachCoveredJobSiteLimit;
	}
	...
	public void setAllCoveredJobSitesLimit(int AllCoveredJobSitesLimit) {
		this.AllCoveredJobSitesLimit = AllCoveredJobSitesLimit;
	}
