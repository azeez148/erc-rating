...
public class BOPOrdinanceOrLawCov1Coverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov1Coverage BOPOrdinanceOrLawCov1Coverage;
	
	
	
	public void Premium ()  {
	  this.BOPOrdinanceOrLawCov1Coverage.setPremium(MathHelper.roundUpDoller(MathHelper.roundToThousand(this.BOPOrdinanceOrLawCov1Coverage.getFactor() * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOrdinanceOrLawCov1Coverage,"../PostLossDirectPhysicalDamageFactor")))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOrdinanceOrLawCov1Coverage,"../../BOPStructureBuildingCoverage/Premium")))));
	...
	public  BOPOrdinanceOrLawCov1Coverage (com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov1Coverage BOPOrdinanceOrLawCov1Coverage)  {
