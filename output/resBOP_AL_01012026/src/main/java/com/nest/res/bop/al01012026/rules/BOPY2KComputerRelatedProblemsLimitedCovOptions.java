...
import com.nest.res.bop.al01012026.domain.BOPY2KComputerRelatedProblemsLimitedCovOptionsDetail;
...
public class BOPY2KComputerRelatedProblemsLimitedCovOptions  {
	...
	private com.nest.res.bop.al01012026.rules.BOPY2KComputerRelatedProblemsLimitedCovOptionsDetail BOPY2KComputerRelatedProblemsLimitedCovOptionsDetailRule;
	...
	private com.nest.res.bop.al01012026.domain.BOPY2KComputerRelatedProblemsLimitedCovOptions BOPY2KComputerRelatedProblemsLimitedCovOptions;
	...
	if(null != BOPY2KComputerRelatedProblemsLimitedCovOptionsDetailList){
		for(BOPY2KComputerRelatedProblemsLimitedCovOptionsDetail BOPY2KComputerRelatedProblemsLimitedCovOptionsDetail:BOPY2KComputerRelatedProblemsLimitedCovOptionsDetailList){
			BOPY2KComputerRelatedProblemsLimitedCovOptionsDetailRule = new com.nest.res.bop.al01012026.rules.BOPY2KComputerRelatedProblemsLimitedCovOptionsDetail(BOPY2KComputerRelatedProblemsLimitedCovOptionsDetail);
	...
	public  BOPY2KComputerRelatedProblemsLimitedCovOptions (com.nest.res.bop.al01012026.domain.BOPY2KComputerRelatedProblemsLimitedCovOptions BOPY2KComputerRelatedProblemsLimitedCovOptions)  {
