...
public class BOPLocationFireDeptServiceCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPLocationFireDeptServiceCoverage BOPLocationFireDeptServiceCoverage;
	
	
	
	public  BOPLocationFireDeptServiceCoverage (com.nest.res.bop.al01012026.domain.BOPLocationFireDeptServiceCoverage BOPLocationFireDeptServiceCoverage)  {
