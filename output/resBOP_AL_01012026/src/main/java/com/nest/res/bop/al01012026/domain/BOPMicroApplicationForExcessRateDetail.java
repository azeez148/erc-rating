...
public class BOPMicroApplicationForExcessRateDetail    extends Policy  {
	...
	private double NormalRatesOrPremiums;
	...
	private double ExcessRatesOrPremiums;
	...
	public double  getNormalRatesOrPremiums() {
		return this.NormalRatesOrPremiums;
	}
	...
	public double  getExcessRatesOrPremiums() {
		return this.ExcessRatesOrPremiums;
	}
	...
	public void setExcessRatesOrPremiums(double ExcessRatesOrPremiums) {
		this.ExcessRatesOrPremiums = ExcessRatesOrPremiums;
	}
	...
	public void setNormalRatesOrPremiums(double NormalRatesOrPremiums) {
		this.NormalRatesOrPremiums = NormalRatesOrPremiums;
	}
