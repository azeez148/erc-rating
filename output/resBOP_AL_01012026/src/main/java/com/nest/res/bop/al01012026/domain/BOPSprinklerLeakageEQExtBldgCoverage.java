...
public class BOPSprinklerLeakageEQExtBldgCoverage    extends Policy  {
	...
	public double  getAdjdFactor() {
		return this.AdjdFactor;
	}
	...
	public void setAdjdFactor(double AdjdFactor) {
		this.AdjdFactor = AdjdFactor;
	}
