...
public class BOPSprinklerLeakageEQExt    extends Policy  {
	private int FeeIndicator;
	private double sprinklerLeakageBPPPremiumTemp_1;
	...
	private double SprinklerLeakageBPPPremium;
	...
	private double SprinklerLeakageBuildingPremium;
	...
	private double SprinklerLeakageBPPRate;
	private double SprinklerLeakageRate;
	...
	private double functionalBPPValuationPremiumTemp_1;
	...
	public double  getSprinklerLeakageBPPPremiumTemp_1() {
		return this.sprinklerLeakageBPPPremiumTemp_1;
	}
	...
	public double  getSprinklerLeakageRate() {
		return this.SprinklerLeakageRate;
	}
	public String  getId() {
		return this.Id;
	}
	...
	public double  getSprinklerLeakageBPPPremium() {
		return this.SprinklerLeakageBPPPremium;
	}
	public int  getTaxIndicator() {
		return this.TaxIndicator;
	}
	public double  getFunctionalBPPValuationPremiumTemp_1() {
		return this.functionalBPPValuationPremiumTemp_1;
	}
	...
	public double  getSprinklerLeakageBPPRate() {
		return this.SprinklerLeakageBPPRate;
	}
	public String  getParentId() {
		return this.ParentId;
	}
	public double  getSprinklerLeakageBuildingPremium() {
		return this.SprinklerLeakageBuildingPremium;
	}
	...
	public void setSprinklerLeakageBuildingPremium(double SprinklerLeakageBuildingPremium) {
		this.SprinklerLeakageBuildingPremium = SprinklerLeakageBuildingPremium;
	}
	...
	public void setSprinklerLeakageBPPPremiumTemp_1(double sprinklerLeakageBPPPremiumTemp_1) {
		this.sprinklerLeakageBPPPremiumTemp_1 = sprinklerLeakageBPPPremiumTemp_1;
	}
	...
	public void setFunctionalBPPValuationPremiumTemp_1(double functionalBPPValuationPremiumTemp_1) {
		this.functionalBPPValuationPremiumTemp_1 = functionalBPPValuationPremiumTemp_1;
	}
	...
	public void setSprinklerLeakageBPPPremium(double SprinklerLeakageBPPPremium) {
		this.SprinklerLeakageBPPPremium = SprinklerLeakageBPPPremium;
	}
	...
	public void setSprinklerLeakageRate(double SprinklerLeakageRate) {
		this.SprinklerLeakageRate = SprinklerLeakageRate;
	}
	...
	public void setSprinklerLeakageBPPRate(double SprinklerLeakageBPPRate) {
		this.SprinklerLeakageBPPRate = SprinklerLeakageBPPRate;
	}
