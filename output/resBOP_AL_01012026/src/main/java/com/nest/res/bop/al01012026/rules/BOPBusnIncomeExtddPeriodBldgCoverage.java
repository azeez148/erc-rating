...
public class BOPBusnIncomeExtddPeriodBldgCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPBusnIncomeExtddPeriodBldgCoverage BOPBusnIncomeExtddPeriodBldgCoverage;
	...
	public void CoverageOnPolicyIndicator ()  {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPBusnIncomeExtddPeriodBldgCoverage,"../MicroBOP"))).equals(MathHelper.getStringValue("No"))){
	...
	public  BOPBusnIncomeExtddPeriodBldgCoverage (com.nest.res.bop.al01012026.domain.BOPBusnIncomeExtddPeriodBldgCoverage BOPBusnIncomeExtddPeriodBldgCoverage)  {
