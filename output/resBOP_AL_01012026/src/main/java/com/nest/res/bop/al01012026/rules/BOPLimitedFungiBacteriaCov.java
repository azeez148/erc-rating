...
import com.nest.res.bop.al01012026.domain.BOPLimitedFungiBacteriaCovExcessCoverage;
import com.nest.res.bop.al01012026.domain.BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage;
...
public class BOPLimitedFungiBacteriaCov  {
	...
	private com.nest.res.bop.al01012026.rules.BOPLimitedFungiBacteriaCovExcessCoverage BOPLimitedFungiBacteriaCovExcessCoverageRule;
	...
	private com.nest.res.bop.al01012026.rules.BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverageRule;
	private com.nest.res.bop.al01012026.domain.BOPLimitedFungiBacteriaCov BOPLimitedFungiBacteriaCov;
...
this.BOPLimitedFungiBacteriaCov.setPremium(MathHelper.getDoubleValue(this.BOPLimitedFungiBacteriaCov.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPLimitedFungiBacteriaCov,"BOPLimitedFungiBacteriaCovExcessCoverage/Premium")))));
	...
	if(null != BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverageList){
		for(BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage:BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverageList){
			BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverageRule = new com.nest.res.bop.al01012026.rules.BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage(BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage);
	...
	if(null != BOPLimitedFungiBacteriaCovExcessCoverageList){
		for(BOPLimitedFungiBacteriaCovExcessCoverage BOPLimitedFungiBacteriaCovExcessCoverage:BOPLimitedFungiBacteriaCovExcessCoverageList){
			BOPLimitedFungiBacteriaCovExcessCoverageRule = new com.nest.res.bop.al01012026.rules.BOPLimitedFungiBacteriaCovExcessCoverage(BOPLimitedFungiBacteriaCovExcessCoverage);
	...
	public  BOPLimitedFungiBacteriaCov (com.nest.res.bop.al01012026.domain.BOPLimitedFungiBacteriaCov BOPLimitedFungiBacteriaCov)  {
