...
public class BOPBusnIncomeExtddPeriodBusnPrsnlPropCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPBusnIncomeExtddPeriodBusnPrsnlPropCoverage BOPBusnIncomeExtddPeriodBusnPrsnlPropCoverage;
	...
	public void CoverageOnPolicyIndicator ()  {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPBusnIncomeExtddPeriodBusnPrsnlPropCoverage,"../MicroBOP"))).equals(MathHelper.getStringValue("No"))){
	...
	public  BOPBusnIncomeExtddPeriodBusnPrsnlPropCoverage (com.nest.res.bop.al01012026.domain.BOPBusnIncomeExtddPeriodBusnPrsnlPropCoverage BOPBusnIncomeExtddPeriodBusnPrsnlPropCoverage)  {
