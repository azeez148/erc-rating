...
public class BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsds    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private Date Modified;
	private double PolicyTermPremium;
	private List<BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail> BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail) {
			childs.addAll(BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail);
		}
		return childs;
	}
	...
	public List<BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail> getBOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail() {
		return this.BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail;
	}
	...
	public void setBOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail(List<BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail> BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail) {
		this.BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail = BOPExclDesignatedOpsCoveredByAControlledWrapUpInsuranceProgramLimitedExceptionForAddlInsdsDetail;
	}
