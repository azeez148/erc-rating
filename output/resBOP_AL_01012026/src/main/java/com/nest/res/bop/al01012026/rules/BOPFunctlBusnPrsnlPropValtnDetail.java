...
import com.nest.res.bop.al01012026.domain.BOPNamedPerilsFunctlBusnPrsnlPropCoverage;
import com.nest.res.bop.al01012026.domain.BOPFunctlBusnPrsnlPropValtnCoverage;
...
public class BOPFunctlBusnPrsnlPropValtnDetail  {
	...
	private com.nest.res.bop.al01012026.rules.BOPFunctlBusnPrsnlPropValtnCoverage BOPFunctlBusnPrsnlPropValtnCoverageRule;
	private com.nest.res.bop.al01012026.rules.BOPNamedPerilsFunctlBusnPrsnlPropCoverage BOPNamedPerilsFunctlBusnPrsnlPropCoverageRule;
	private com.nest.res.bop.al01012026.domain.BOPFunctlBusnPrsnlPropValtnDetail BOPFunctlBusnPrsnlPropValtnDetail;
...
this.BOPFunctlBusnPrsnlPropValtnDetail.setPremium(MathHelper.getDoubleValue(this.BOPFunctlBusnPrsnlPropValtnDetail.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPFunctlBusnPrsnlPropValtnDetail,"BOPNamedPerilsFunctlBusnPrsnlPropCoverage/Premium")))));
	...
	public  BOPFunctlBusnPrsnlPropValtnDetail (com.nest.res.bop.al01012026.domain.BOPFunctlBusnPrsnlPropValtnDetail BOPFunctlBusnPrsnlPropValtnDetail)  {
...
this.BOPFunctlBusnPrsnlPropValtnCoverageList = BOPFunctlBusnPrsnlPropValtnDetail.getBOPFunctlBusnPrsnlPropValtnCoverage();
	...
	if(null != BOPFunctlBusnPrsnlPropValtnCoverageList){
		for(BOPFunctlBusnPrsnlPropValtnCoverage BOPFunctlBusnPrsnlPropValtnCoverage:BOPFunctlBusnPrsnlPropValtnCoverageList){
			BOPFunctlBusnPrsnlPropValtnCoverageRule = new com.nest.res.bop.al01012026.rules.BOPFunctlBusnPrsnlPropValtnCoverage(BOPFunctlBusnPrsnlPropValtnCoverage);
	...
	if(null != BOPNamedPerilsFunctlBusnPrsnlPropCoverageList){
		for(BOPNamedPerilsFunctlBusnPrsnlPropCoverage BOPNamedPerilsFunctlBusnPrsnlPropCoverage:BOPNamedPerilsFunctlBusnPrsnlPropCoverageList){
			BOPNamedPerilsFunctlBusnPrsnlPropCoverageRule = new com.nest.res.bop.al01012026.rules.BOPNamedPerilsFunctlBusnPrsnlPropCoverage(BOPNamedPerilsFunctlBusnPrsnlPropCoverage);
