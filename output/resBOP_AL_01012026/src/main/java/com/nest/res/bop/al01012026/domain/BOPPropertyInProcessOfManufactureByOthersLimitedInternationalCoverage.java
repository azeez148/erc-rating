...
public class BOPPropertyInProcessOfManufactureByOthersLimitedInternationalCoverage    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private int Deductible;
	private String ForeignCovTerr;
	...
	private String TheForeignCoverageTerritoryIs;
	...
	public String  getForeignCovTerr() {
		return this.ForeignCovTerr;
	}
	...
	public String  getTheForeignCoverageTerritoryIs() {
		return this.TheForeignCoverageTerritoryIs;
	}
	...
	public void setTheForeignCoverageTerritoryIs(String TheForeignCoverageTerritoryIs) {
		this.TheForeignCoverageTerritoryIs = TheForeignCoverageTerritoryIs;
	}
	...
	public void setForeignCovTerr(String ForeignCovTerr) {
		this.ForeignCovTerr = ForeignCovTerr;
	}
}