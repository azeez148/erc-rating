...
public class BOPLossRentalValueLandlordDesignatedPayee    extends Policy  {
	...
	private List<BOPLossRentalValueLandlordDesignatedPayeeDetail> BOPLossRentalValueLandlordDesignatedPayeeDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPLossRentalValueLandlordDesignatedPayeeDetail) {
			childs.addAll(BOPLossRentalValueLandlordDesignatedPayeeDetail);
		}
		return childs;
	}
	...
	public List<BOPLossRentalValueLandlordDesignatedPayeeDetail> getBOPLossRentalValueLandlordDesignatedPayeeDetail() {
		return this.BOPLossRentalValueLandlordDesignatedPayeeDetail;
	}
	...
	public void setBOPLossRentalValueLandlordDesignatedPayeeDetail(List<BOPLossRentalValueLandlordDesignatedPayeeDetail> BOPLossRentalValueLandlordDesignatedPayeeDetail) {
