...
public class BOPSpecifiedBusinessPersonalPropertyTemporarilyAwayFromPremises    extends Policy  {
	...
	private double SpecifiedBPPTemporarilyAwayFromPremisesNamedPerilsFactor;
	...
	private double NamedPerilsBusnPrsnlPropFactor;
	...
	public double  getSpecifiedBPPTemporarilyAwayFromPremisesNamedPerilsFactor() {
		return this.SpecifiedBPPTemporarilyAwayFromPremisesNamedPerilsFactor;
	}
	...
	public double  getFunctlBusnPrsnlPropFactor() {
		return this.FunctlBusnPrsnlPropFactor;
	}
	...
	public double  getNamedPerilsCredit_1() {
		return this.namedPerilsCredit_1;
	}
	...
	public double  getSpecifiedBPPTemporarilyAwayFromPremisesAllRiskFactor() {
		return this.SpecifiedBPPTemporarilyAwayFromPremisesAllRiskFactor;
	}
	public String  getTypesOrItemsOfBPP() {
		return this.TypesOrItemsOfBPP;
	}
	...
	public double  getNamedPerilsBusnPrsnlPropFactor() {
		return this.NamedPerilsBusnPrsnlPropFactor;
	}
	...
	public void setSpecifiedBPPTemporarilyAwayFromPremisesNamedPerilsFactor(double SpecifiedBPPTemporarilyAwayFromPremisesNamedPerilsFactor) {
		this.SpecifiedBPPTemporarilyAwayFromPremisesNamedPerilsFactor = SpecifiedBPPTemporarilyAwayFromPremisesNamedPerilsFactor;
	}
	public void setModified(Date Modified) {
		this.Modified = Modified;
	}
	public void setTypesOrItemsOfBPP(String TypesOrItemsOfBPP) {
		this.TypesOrItemsOfBPP = TypesOrItemsOfBPP;
	}
	public void setASLOBStatCode(String ASLOBStatCode) {
		this.ASLOBStatCode = ASLOBStatCode;
	}
	public void setNamedPerilsCredit_1(double namedPerilsCredit_1) {
		this.namedPerilsCredit_1 = namedPerilsCredit_1;
	}
	...
	public void setFunctlBusnPrsnlPropFactor(double FunctlBusnPrsnlPropFactor) {
		this.FunctlBusnPrsnlPropFactor = FunctlBusnPrsnlPropFactor;
	}
	...
	public void setNamedPerilsBusnPrsnlPropFactor(double NamedPerilsBusnPrsnlPropFactor) {
		this.NamedPerilsBusnPrsnlPropFactor = NamedPerilsBusnPrsnlPropFactor;
	}
	...
	public void setSpecifiedBPPTemporarilyAwayFromPremisesAllRiskFactor(double SpecifiedBPPTemporarilyAwayFromPremisesAllRiskFactor) {
		this.SpecifiedBPPTemporarilyAwayFromPremisesAllRiskFactor = SpecifiedBPPTemporarilyAwayFromPremisesAllRiskFactor;
	}
}