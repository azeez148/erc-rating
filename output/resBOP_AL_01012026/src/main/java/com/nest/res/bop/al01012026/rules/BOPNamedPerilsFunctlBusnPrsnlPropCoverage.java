...
public class BOPNamedPerilsFunctlBusnPrsnlPropCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPNamedPerilsFunctlBusnPrsnlPropCoverage BOPNamedPerilsFunctlBusnPrsnlPropCoverage;
	
	
	
	public  BOPNamedPerilsFunctlBusnPrsnlPropCoverage (com.nest.res.bop.al01012026.domain.BOPNamedPerilsFunctlBusnPrsnlPropCoverage BOPNamedPerilsFunctlBusnPrsnlPropCoverage)  {
	...
	public void Factor () throws LookupException,NumberFormatException {
		...
		if((XpathNode.selectNodeValue(this.BOPNamedPerilsFunctlBusnPrsnlPropCoverage,"../../../../../../BOPNamedPerils/BurglaryRobberyCoverage")) != null && !(MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPNamedPerilsFunctlBusnPrsnlPropCoverage,"../../../../../../BOPNamedPerils/BurglaryRobberyCoverage"))).equals(MathHelper.getStringValue(""))){
			this.BOPNamedPerilsFunctlBusnPrsnlPropCoverage.setFactor(MathHelper.getDoubleValue(MathHelper.getDoubleValue((String)RateTableLookup.getRateTableLookupValue("NamedPerilsBusnPrsnlPropFactor",String.valueOf(XpathNode.selectNodeValue(this.BOPNamedPerilsFunctlBusnPrsnlPropCoverage,"../../../../../../BOPNamedPerils/BurglaryRobberyCoverage"))))));
		}
		else{
			this.BOPNamedPerilsFunctlBusnPrsnlPropCoverage.setFactor(MathHelper.getDoubleValue(MathHelper.getDoubleValue(0.0)));
		}
