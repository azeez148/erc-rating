...
public class BOPLimitedCoverageForDesignatedUnmannedAircraftBIPDCoverage    extends Policy  {
	...
	private double UACOwnershipAndOperationFactor;
	private double ShortRateFactor;
	private String ParentId;
	private double UACBodilyInjuryPropertyDamageRate;
	...
	public double  getUACUsageFactor() {
		return this.UACUsageFactor;
	}
	...
	public double  getUACOwnershipAndOperationFactor() {
		return this.UACOwnershipAndOperationFactor;
	}
	public double  getUACPrimaryPlaceOfOperationFactor() {
		return this.UACPrimaryPlaceOfOperationFactor;
	}
	...
	public double  getPremiumBIPD() {
		return this.PremiumBIPD;
	}
	public Date  getCoverageAddDt() {
		return this.CoverageAddDt;
	}
	public double  getUACBodilyInjuryPropertyDamageRate() {
		return this.UACBodilyInjuryPropertyDamageRate;
	}
	...
	public void setUACUsageFactor(double UACUsageFactor) {
		this.UACUsageFactor = UACUsageFactor;
	}
	...
	public void setUACOwnershipAndOperationFactor(double UACOwnershipAndOperationFactor) {
		this.UACOwnershipAndOperationFactor = UACOwnershipAndOperationFactor;
	}
	...
	public void setUACPrimaryPlaceOfOperationFactor(double UACPrimaryPlaceOfOperationFactor) {
		this.UACPrimaryPlaceOfOperationFactor = UACPrimaryPlaceOfOperationFactor;
	}
	...
	public void setPremiumBIPD(double PremiumBIPD) {
		this.PremiumBIPD = PremiumBIPD;
	}
	...
	public void setUACBodilyInjuryPropertyDamageRate(double UACBodilyInjuryPropertyDamageRate) {
		this.UACBodilyInjuryPropertyDamageRate = UACBodilyInjuryPropertyDamageRate;
	}
