...
public class BOPBarbersBeauticiansProflLiab    extends Policy  {
	...
	private double FirstOperatorCharge;
	...
	private double EachAddlOperatorCharge;
	private Date Effective;
	private double PartTimeStatRate;
	...
	public double  getFirstOperatorCharge() {
		return this.FirstOperatorCharge;
	}
	...
	public double  getEachAddlOperatorCharge() {
		return this.EachAddlOperatorCharge;
	}
	...
	public double  getPartTimeStatRate() {
		return this.PartTimeStatRate;
	}
	...
	public void setFirstOperatorCharge(double FirstOperatorCharge) {
		this.FirstOperatorCharge = FirstOperatorCharge;
	}
	...
	public void setEachAddlOperatorCharge(double EachAddlOperatorCharge) {
		this.EachAddlOperatorCharge = EachAddlOperatorCharge;
	}
	...
	public void setPartTimeStatRate(double PartTimeStatRate) {
		this.PartTimeStatRate = PartTimeStatRate;
	}
