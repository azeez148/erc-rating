...
public class BOPMicroChangesAmendmentOfCancellationProvisionsOrCoverageChange    extends Policy  {
	...
	private int NumberOfDaysAdvanceNotice;
	...
	public int  getNumberOfDaysAdvanceNotice() {
		return this.NumberOfDaysAdvanceNotice;
	}
	...
	public void setNumberOfDaysAdvanceNotice(int NumberOfDaysAdvanceNotice) {
		this.NumberOfDaysAdvanceNotice = NumberOfDaysAdvanceNotice;
	}
