...
public class BOPTerrorismCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPTerrorismCoverage BOPTerrorismCoverage;
	...
	public void daysUntilTRIAExpirationTemp_1 () throws ParseException {
		...
		if((XpathNode.selectNodeValue(this.BOPTerrorismCoverage,"../TRIAExpirationDate")) != null){
			this.BOPTerrorismCoverage.setDaysUntilTRIAExpirationTemp_1(MathHelper.getIntegerValue(MathHelper.getIntegerValue(this.BOPTerrorismCoverage.getDateDiff_1_Days() + MathHelper.getIntegerValue(1.0))));
		}
		}
	...
	public void terrorismBPPPremiumTemp_1 ()  {
	  this.BOPTerrorismCoverage.setTerrorismBPPPremiumTemp_1(MathHelper.getDoubleValue(0.0));

		for( Policy policy : XpathNode.selectNodes(BOPTerrorismCoverage,"../BOPLocation/BOPStructure/BOPClassification") ){
			this.BOPTerrorismCoverage.setTerrorismBPPPremiumTemp_1(MathHelper.getDoubleValue(MathHelper.getDoubleValue(this.BOPTerrorismCoverage.getTerrorismBPPPremiumTemp_1()) + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(policy,"TerrsmBusnPrsnlPropPremium")))));
		}
	...
	public void TerrorismBPPPremium ()  {
	  this.BOPTerrorismCoverage.setTerrorismBPPPremium(this.BOPTerrorismCoverage.getTerrorismBPPPremiumTemp_1());

	  
	}
	public  BOPTerrorismCoverage (com.nest.res.bop.al01012026.domain.BOPTerrorismCoverage BOPTerrorismCoverage)  {
	  this.BOPTerrorismCoverage = BOPTerrorismCoverage;

	  
	}
	public void TerrorismBldgPremium ()  {
	  this.BOPTerrorismCoverage.setTerrorismBldgPremium(this.BOPTerrorismCoverage.getTerrorismBldgPremiumTemp_1());
	...
	public void terrorismBldgPremiumTemp_1 ()  {
	  this.BOPTerrorismCoverage.setTerrorismBldgPremiumTemp_1(MathHelper.getDoubleValue(0.0));

		for( Policy policy : XpathNode.selectNodes(BOPTerrorismCoverage,"../BOPLocation/BOPStructure") ){
			this.BOPTerrorismCoverage.setTerrorismBldgPremiumTemp_1(MathHelper.getDoubleValue(MathHelper.getDoubleValue(this.BOPTerrorismCoverage.getTerrorismBldgPremiumTemp_1()) + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(policy,"TerrsmBldgPremium")))));
		}
	...
	public void terrorismLiabPremiumTemp_1 ()  {
	  this.BOPTerrorismCoverage.setTerrorismLiabPremiumTemp_1(MathHelper.getDoubleValue(0.0));

		for( Policy policy : XpathNode.selectNodes(BOPTerrorismCoverage,"../BOPLocation/BOPStructure") ){
			this.BOPTerrorismCoverage.setTerrorismLiabPremiumTemp_1(MathHelper.getDoubleValue(MathHelper.getDoubleValue(this.BOPTerrorismCoverage.getTerrorismLiabPremiumTemp_1()) + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(policy,"TerrsmLiabilityPremium")))));
		}
	...
	public void DaysUntilTRIAExpiration () throws ParseException {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPTerrorismCoverage,"../TRIPTerminatesBeforeExpirationDate"))).equals(MathHelper.getStringValue("Yes"))){
		if((XpathNode.selectNodeValue(this.BOPTerrorismCoverage,"../TRIAExpirationDate")) != null){
		if(this.BOPTerrorismCoverage.getDateDiff_1_Days() + MathHelper.getIntegerValue(1.0) >= 0.0){
			this.BOPTerrorismCoverage.setDaysUntilTRIAExpiration(MathHelper.getIntegerValue(this.BOPTerrorismCoverage.getDaysUntilTRIAExpirationTemp_1()));
		}
		else{
	...
	public void CoverageOnPolicyIndicator ()  {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPTerrorismCoverage,"../MicroBOP"))).equals(MathHelper.getStringValue("No"))){
	...
	public void TerrorismLiabPremium ()  {
	  this.BOPTerrorismCoverage.setTerrorismLiabPremium(this.BOPTerrorismCoverage.getTerrorismLiabPremiumTemp_1());
