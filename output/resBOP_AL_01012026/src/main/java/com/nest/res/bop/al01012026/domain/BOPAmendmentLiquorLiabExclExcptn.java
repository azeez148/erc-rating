...
public class BOPAmendmentLiquorLiabExclExcptn    extends Policy  {
	private String ASLOBStatCode;
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private List<BOPAmendmentLiquorLiabExclExcptnDetail> BOPAmendmentLiquorLiabExclExcptnDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAmendmentLiquorLiabExclExcptnDetail) {
			childs.addAll(BOPAmendmentLiquorLiabExclExcptnDetail);
		}
		return childs;
	}
	...
	public List<BOPAmendmentLiquorLiabExclExcptnDetail> getBOPAmendmentLiquorLiabExclExcptnDetail() {
		return this.BOPAmendmentLiquorLiabExclExcptnDetail;
	}
	...
	public void setBOPAmendmentLiquorLiabExclExcptnDetail(List<BOPAmendmentLiquorLiabExclExcptnDetail> BOPAmendmentLiquorLiabExclExcptnDetail) {
