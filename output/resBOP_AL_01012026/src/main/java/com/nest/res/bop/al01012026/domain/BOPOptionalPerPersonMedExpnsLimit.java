...
public class BOPOptionalPerPersonMedExpnsLimit    extends Policy  {
	...
	private double RatingLimitBPP;
	private double ShortRateFactor;
	private String ParentId;
	private double ProRatedPriorPremium;
	private double PremiumBldg;
	private double FinalRateBldg;
	...
	private double CombinedBaseRateBPP;
	...
	public double  getPremiumBPP() {
		return this.PremiumBPP;
	}
	public Date  getExpirationDt() {
		return this.ExpirationDt;
	}
	public double  getCombinedBaseRateBldg() {
		return this.CombinedBaseRateBldg;
	}
	...
	public double  getRatingLimitBPP() {
		return this.RatingLimitBPP;
	}
	...
	public double  getFinalRateBPP() {
		return this.FinalRateBPP;
	}
	...
	public double  getPremiumBldg() {
		return this.PremiumBldg;
	}
	...
	public double  getFinalRateBldg() {
		return this.FinalRateBldg;
	}
	public double  getChangePremium() {
		return this.ChangePremium;
	}
	public double  getCombinedBaseRateBPP() {
		return this.CombinedBaseRateBPP;
	}
	...
	public void setFinalRateBPP(double FinalRateBPP) {
		this.FinalRateBPP = FinalRateBPP;
	}
	...
	public void setPremiumBPP(double PremiumBPP) {
		this.PremiumBPP = PremiumBPP;
	}
	...
	public void setCombinedBaseRateBldg(double CombinedBaseRateBldg) {
		this.CombinedBaseRateBldg = CombinedBaseRateBldg;
	}
	public void setPremiumBldg(double PremiumBldg) {
		this.PremiumBldg = PremiumBldg;
	}
	...
	public void setFinalRateBldg(double FinalRateBldg) {
		this.FinalRateBldg = FinalRateBldg;
	}
	...
	public void setRatingLimitBPP(double RatingLimitBPP) {
		this.RatingLimitBPP = RatingLimitBPP;
	}
	...
	public void setCombinedBaseRateBPP(double CombinedBaseRateBPP) {
		this.CombinedBaseRateBPP = CombinedBaseRateBPP;
	}
