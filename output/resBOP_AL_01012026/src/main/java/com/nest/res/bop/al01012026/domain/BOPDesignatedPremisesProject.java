...
public class BOPDesignatedPremisesProject    extends Policy  {
	...
	private List<BOPDesignatedPremisesProjectDetail> BOPDesignatedPremisesProjectDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPDesignatedPremisesProjectDetail) {
			childs.addAll(BOPDesignatedPremisesProjectDetail);
		}
		return childs;
	}
	...
	public List<BOPDesignatedPremisesProjectDetail> getBOPDesignatedPremisesProjectDetail() {
		return this.BOPDesignatedPremisesProjectDetail;
	}
	...
	public void setBOPDesignatedPremisesProjectDetail(List<BOPDesignatedPremisesProjectDetail> BOPDesignatedPremisesProjectDetail) {
		this.BOPDesignatedPremisesProjectDetail = BOPDesignatedPremisesProjectDetail;
	}
