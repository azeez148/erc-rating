...
public class BOPBrandsAndLabels  {
	...
	private com.nest.res.bop.al01012026.domain.BOPBrandsAndLabels BOPBrandsAndLabels;
	
	
	
	public  BOPBrandsAndLabels (com.nest.res.bop.al01012026.domain.BOPBrandsAndLabels BOPBrandsAndLabels)  {
