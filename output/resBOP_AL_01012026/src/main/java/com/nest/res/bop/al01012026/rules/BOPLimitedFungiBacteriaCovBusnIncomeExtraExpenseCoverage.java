...
public class BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage;
	...
	public  BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage (com.nest.res.bop.al01012026.domain.BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage)  {
	...
	public void CoverageOnPolicyIndicator ()  {
		...
		if(!this.BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage.getNumDays().equals(MathHelper.getStringValue(""))){
