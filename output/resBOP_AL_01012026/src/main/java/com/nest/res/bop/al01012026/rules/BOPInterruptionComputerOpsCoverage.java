...
public class BOPInterruptionComputerOpsCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPInterruptionComputerOpsCoverage BOPInterruptionComputerOpsCoverage;
	...
	public void CoverageOnPolicyIndicator ()  {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPInterruptionComputerOpsCoverage,"../MicroBOP"))).equals(MathHelper.getStringValue("No"))){
	...
	public  BOPInterruptionComputerOpsCoverage (com.nest.res.bop.al01012026.domain.BOPInterruptionComputerOpsCoverage BOPInterruptionComputerOpsCoverage)  {
