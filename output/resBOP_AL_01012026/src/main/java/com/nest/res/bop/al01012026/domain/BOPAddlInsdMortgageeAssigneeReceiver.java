...
public class BOPAddlInsdMortgageeAssigneeReceiver    extends Policy  {
	...
	private List<BOPAddlInsdMortgageeReceiverDetail> BOPAddlInsdMortgageeReceiverDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdMortgageeReceiverDetail) {
			childs.addAll(BOPAddlInsdMortgageeReceiverDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdMortgageeReceiverDetail> getBOPAddlInsdMortgageeReceiverDetail() {
		return this.BOPAddlInsdMortgageeReceiverDetail;
	}
	...
	public void setBOPAddlInsdMortgageeReceiverDetail(List<BOPAddlInsdMortgageeReceiverDetail> BOPAddlInsdMortgageeReceiverDetail) {
		this.BOPAddlInsdMortgageeReceiverDetail = BOPAddlInsdMortgageeReceiverDetail;
	}
