...
import com.nest.res.bop.al01012026.domain.BOPVacancyPermitBldgCoverage;
import com.nest.res.bop.al01012026.domain.BOPVacancyPermitBusnPrsnlPropCoverage;
...
public class BOPVacancyPermit  {
	...
	private com.nest.res.bop.al01012026.rules.BOPVacancyPermitBldgCoverage BOPVacancyPermitBldgCoverageRule;
	private com.nest.res.bop.al01012026.rules.BOPVacancyPermitBusnPrsnlPropCoverage BOPVacancyPermitBusnPrsnlPropCoverageRule;
	private com.nest.res.bop.al01012026.domain.BOPVacancyPermit BOPVacancyPermit;
	...
	if(null != BOPVacancyPermitBldgCoverageList){
		for(BOPVacancyPermitBldgCoverage BOPVacancyPermitBldgCoverage:BOPVacancyPermitBldgCoverageList){
			BOPVacancyPermitBldgCoverageRule = new com.nest.res.bop.al01012026.rules.BOPVacancyPermitBldgCoverage(BOPVacancyPermitBldgCoverage);
	...
	if(null != BOPVacancyPermitBusnPrsnlPropCoverageList){
		for(BOPVacancyPermitBusnPrsnlPropCoverage BOPVacancyPermitBusnPrsnlPropCoverage:BOPVacancyPermitBusnPrsnlPropCoverageList){
			BOPVacancyPermitBusnPrsnlPropCoverageRule = new com.nest.res.bop.al01012026.rules.BOPVacancyPermitBusnPrsnlPropCoverage(BOPVacancyPermitBusnPrsnlPropCoverage);
...
this.BOPVacancyPermit.setPremium(MathHelper.getDoubleValue(this.BOPVacancyPermit.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPVacancyPermit,"BOPVacancyPermitBusnPrsnlPropCoverage/Premium")))));
	...
	public  BOPVacancyPermit (com.nest.res.bop.al01012026.domain.BOPVacancyPermit BOPVacancyPermit)  {
