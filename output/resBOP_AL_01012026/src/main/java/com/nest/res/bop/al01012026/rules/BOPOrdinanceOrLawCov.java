...
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov1EQCoverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov2EQCoverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov2And3EQCoverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov2And3Coverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov3EQCoverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov2Coverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov1Coverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov3Coverage;
import com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage;
...
public class BOPOrdinanceOrLawCov  {
	...
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2EQCoverage BOPOrdinanceOrLawCov2EQCoverageRule;
	...
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2And3EQCoverage BOPOrdinanceOrLawCov2And3EQCoverageRule;
	private com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov BOPOrdinanceOrLawCov;
	...
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov1EQCoverage BOPOrdinanceOrLawCov1EQCoverageRule;
	private List<BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage> BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverageList;
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov3Coverage BOPOrdinanceOrLawCov3CoverageRule;
	private List<BOPOrdinanceOrLawCov3EQCoverage> BOPOrdinanceOrLawCov3EQCoverageList;
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2And3Coverage BOPOrdinanceOrLawCov2And3CoverageRule;
	private List<BOPOrdinanceOrLawCov2Coverage> BOPOrdinanceOrLawCov2CoverageList;
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov3EQCoverage BOPOrdinanceOrLawCov3EQCoverageRule;
	...
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov1Coverage BOPOrdinanceOrLawCov1CoverageRule;
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverageRule;
	private List<BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage> BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverageList;
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2Coverage BOPOrdinanceOrLawCov2CoverageRule;
	private com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverageRule;
	
	
	
	public void PostLossDirectPhysicalDamageFactor () throws LookupException,NumberFormatException {
	  
		if(this.BOPOrdinanceOrLawCov.getPostLossDirectPhysicalDamage().equals(MathHelper.getStringValue("Yes"))){
			this.BOPOrdinanceOrLawCov.setPostLossDirectPhysicalDamageFactor(MathHelper.getDoubleValue(MathHelper.getDoubleValue((String)RateTableLookup.getRateTableLookupValue("PostLossOrdOrLawDirectPDFactor",String.valueOf( "Y")))));
		}
		else{
			this.BOPOrdinanceOrLawCov.setPostLossDirectPhysicalDamageFactor(MathHelper.getDoubleValue(MathHelper.getDoubleValue(1.0)));
		}
	...
	if(null != BOPOrdinanceOrLawCov1CoverageList){
		for(BOPOrdinanceOrLawCov1Coverage BOPOrdinanceOrLawCov1Coverage:BOPOrdinanceOrLawCov1CoverageList){
			BOPOrdinanceOrLawCov1CoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov1Coverage(BOPOrdinanceOrLawCov1Coverage);
	...
	if(null != BOPOrdinanceOrLawCov1EQCoverageList){
		for(BOPOrdinanceOrLawCov1EQCoverage BOPOrdinanceOrLawCov1EQCoverage:BOPOrdinanceOrLawCov1EQCoverageList){
			BOPOrdinanceOrLawCov1EQCoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov1EQCoverage(BOPOrdinanceOrLawCov1EQCoverage);
	...
	if(null != BOPOrdinanceOrLawCov2CoverageList){
		for(BOPOrdinanceOrLawCov2Coverage BOPOrdinanceOrLawCov2Coverage:BOPOrdinanceOrLawCov2CoverageList){
			BOPOrdinanceOrLawCov2CoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2Coverage(BOPOrdinanceOrLawCov2Coverage);
	...
	if(null != BOPOrdinanceOrLawCov2EQCoverageList){
		for(BOPOrdinanceOrLawCov2EQCoverage BOPOrdinanceOrLawCov2EQCoverage:BOPOrdinanceOrLawCov2EQCoverageList){
			BOPOrdinanceOrLawCov2EQCoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2EQCoverage(BOPOrdinanceOrLawCov2EQCoverage);
	...
	if(null != BOPOrdinanceOrLawCov3CoverageList){
		for(BOPOrdinanceOrLawCov3Coverage BOPOrdinanceOrLawCov3Coverage:BOPOrdinanceOrLawCov3CoverageList){
			BOPOrdinanceOrLawCov3CoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov3Coverage(BOPOrdinanceOrLawCov3Coverage);
	...
	if(null != BOPOrdinanceOrLawCov3EQCoverageList){
		for(BOPOrdinanceOrLawCov3EQCoverage BOPOrdinanceOrLawCov3EQCoverage:BOPOrdinanceOrLawCov3EQCoverageList){
			BOPOrdinanceOrLawCov3EQCoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov3EQCoverage(BOPOrdinanceOrLawCov3EQCoverage);
	...
	if(null != BOPOrdinanceOrLawCov2And3CoverageList){
		for(BOPOrdinanceOrLawCov2And3Coverage BOPOrdinanceOrLawCov2And3Coverage:BOPOrdinanceOrLawCov2And3CoverageList){
			BOPOrdinanceOrLawCov2And3CoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2And3Coverage(BOPOrdinanceOrLawCov2And3Coverage);
	...
	if(null != BOPOrdinanceOrLawCov2And3EQCoverageList){
		for(BOPOrdinanceOrLawCov2And3EQCoverage BOPOrdinanceOrLawCov2And3EQCoverage:BOPOrdinanceOrLawCov2And3EQCoverageList){
			BOPOrdinanceOrLawCov2And3EQCoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawCov2And3EQCoverage(BOPOrdinanceOrLawCov2And3EQCoverage);
	...
	if(null != BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverageList){
		for(BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage:BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverageList){
			BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage(BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage);
	...
	if(null != BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverageList){
		for(BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage:BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverageList){
			BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverageRule = new com.nest.res.bop.al01012026.rules.BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage(BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage);
...
this.BOPOrdinanceOrLawCov.setPremium(MathHelper.getDoubleValue(this.BOPOrdinanceOrLawCov.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOrdinanceOrLawCov,"BOPOrdinanceOrLawIncrdPeriodOfRestorationEQCoverage/Premium")))));
	...
	PostLossBusinessIncomeExtraExpenseFactor();
	
	PostLossDirectPhysicalDamageFactor();
	
	  
	}
	public  BOPOrdinanceOrLawCov (com.nest.res.bop.al01012026.domain.BOPOrdinanceOrLawCov BOPOrdinanceOrLawCov)  {
...
this.BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverageList = BOPOrdinanceOrLawCov.getBOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage();
	...
	public void PostLossBusinessIncomeExtraExpenseFactor () throws LookupException,NumberFormatException {
	  
		if(this.BOPOrdinanceOrLawCov.getPostLossBusinessIncomeExtraExpense().equals(MathHelper.getStringValue("Yes"))){
			this.BOPOrdinanceOrLawCov.setPostLossBusinessIncomeExtraExpenseFactor(MathHelper.getDoubleValue(MathHelper.getDoubleValue((String)RateTableLookup.getRateTableLookupValue("PostLossOrdOrLawDirectBusinessIncomeExtraExpenseFactor",String.valueOf( "Y")))));
		}
		else{
			this.BOPOrdinanceOrLawCov.setPostLossBusinessIncomeExtraExpenseFactor(MathHelper.getDoubleValue(MathHelper.getDoubleValue(1.0)));
		}
