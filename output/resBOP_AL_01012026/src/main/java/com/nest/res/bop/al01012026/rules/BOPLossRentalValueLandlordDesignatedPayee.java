...
import com.nest.res.bop.al01012026.domain.BOPLossRentalValueLandlordDesignatedPayeeDetail;
...
public class BOPLossRentalValueLandlordDesignatedPayee  {
	...
	private com.nest.res.bop.al01012026.domain.BOPLossRentalValueLandlordDesignatedPayee BOPLossRentalValueLandlordDesignatedPayee;
	private List<BOPLossRentalValueLandlordDesignatedPayeeDetail> BOPLossRentalValueLandlordDesignatedPayeeDetailList;
	private com.nest.res.bop.al01012026.rules.BOPLossRentalValueLandlordDesignatedPayeeDetail BOPLossRentalValueLandlordDesignatedPayeeDetailRule;
	...
	public  BOPLossRentalValueLandlordDesignatedPayee (com.nest.res.bop.al01012026.domain.BOPLossRentalValueLandlordDesignatedPayee BOPLossRentalValueLandlordDesignatedPayee)  {
...
this.BOPLossRentalValueLandlordDesignatedPayeeDetailList = BOPLossRentalValueLandlordDesignatedPayee.getBOPLossRentalValueLandlordDesignatedPayeeDetail();
	...
	if(null != BOPLossRentalValueLandlordDesignatedPayeeDetailList){
		for(BOPLossRentalValueLandlordDesignatedPayeeDetail BOPLossRentalValueLandlordDesignatedPayeeDetail:BOPLossRentalValueLandlordDesignatedPayeeDetailList){
			BOPLossRentalValueLandlordDesignatedPayeeDetailRule = new com.nest.res.bop.al01012026.rules.BOPLossRentalValueLandlordDesignatedPayeeDetail(BOPLossRentalValueLandlordDesignatedPayeeDetail);
