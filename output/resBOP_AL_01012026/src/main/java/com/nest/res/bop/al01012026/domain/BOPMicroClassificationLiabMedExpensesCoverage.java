...
public class BOPMicroClassificationLiabMedExpensesCoverage    extends Policy  {
	...
	private double LiabilityHazardGroupFactor;
	private Date ChangeEffectiveDt;
	private Date CoverageAddDt;
	private String VersionedId;
	private int LiabilityLimitsPerAggregateStatCode;
	private int ProRateIndicator;
	private int LiabilityLimitsPerOccurrenceStatCode;
	...
	private double ArtisanSalesFactor;
	...
	public int  getLiabilityLimitsPerOccurrenceStatCode() {
		return this.LiabilityLimitsPerOccurrenceStatCode;
	}
	...
	public double  getLiabilityHazardGroupFactor() {
		return this.LiabilityHazardGroupFactor;
	}
	public int  getLiabilityLimitsPerAggregateStatCode() {
		return this.LiabilityLimitsPerAggregateStatCode;
	}
	...
	public double  getArtisanSalesFactor() {
		return this.ArtisanSalesFactor;
	}
	...
	public void setArtisanSalesFactor(double ArtisanSalesFactor) {
		this.ArtisanSalesFactor = ArtisanSalesFactor;
	}
	...
	public void setLiabilityLimitsPerAggregateStatCode(int LiabilityLimitsPerAggregateStatCode) {
		this.LiabilityLimitsPerAggregateStatCode = LiabilityLimitsPerAggregateStatCode;
	}
	...
	public void setLiabilityLimitsPerOccurrenceStatCode(int LiabilityLimitsPerOccurrenceStatCode) {
		this.LiabilityLimitsPerOccurrenceStatCode = LiabilityLimitsPerOccurrenceStatCode;
	}
	...
	public void setLiabilityHazardGroupFactor(double LiabilityHazardGroupFactor) {
		this.LiabilityHazardGroupFactor = LiabilityHazardGroupFactor;
	}
