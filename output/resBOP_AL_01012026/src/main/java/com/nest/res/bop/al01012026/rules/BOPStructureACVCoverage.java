...
public class BOPStructureACVCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPStructureACVCoverage BOPStructureACVCoverage;
	
	
	
	public  BOPStructureACVCoverage (com.nest.res.bop.al01012026.domain.BOPStructureACVCoverage BOPStructureACVCoverage)  {
	...
	public void setTotalPremiumForCoverage ()  {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPStructureACVCoverage,"../PctOwnerOccupied"))).equals(MathHelper.getStringValue("Less than 50%"))){
