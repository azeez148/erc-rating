...
public class BOPAddlInsdBldgOwners    extends Policy  {
	...
	private List<BOPAddlInsdBldgOwnersDetail> BOPAddlInsdBldgOwnersDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdBldgOwnersDetail) {
			childs.addAll(BOPAddlInsdBldgOwnersDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdBldgOwnersDetail> getBOPAddlInsdBldgOwnersDetail() {
		return this.BOPAddlInsdBldgOwnersDetail;
	}
	...
	public void setBOPAddlInsdBldgOwnersDetail(List<BOPAddlInsdBldgOwnersDetail> BOPAddlInsdBldgOwnersDetail) {
		this.BOPAddlInsdBldgOwnersDetail = BOPAddlInsdBldgOwnersDetail;
	}
