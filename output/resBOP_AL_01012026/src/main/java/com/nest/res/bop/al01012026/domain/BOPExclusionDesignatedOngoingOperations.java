...
public class BOPExclusionDesignatedOngoingOperations    extends Policy  {
	...
	private List<BOPExclusionDesignatedOngoingOperationsDetail> BOPExclusionDesignatedOngoingOperationsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPExclusionDesignatedOngoingOperationsDetail) {
			childs.addAll(BOPExclusionDesignatedOngoingOperationsDetail);
		}
		return childs;
	}
	...
	public List<BOPExclusionDesignatedOngoingOperationsDetail> getBOPExclusionDesignatedOngoingOperationsDetail() {
		return this.BOPExclusionDesignatedOngoingOperationsDetail;
	}
	...
	public void setBOPExclusionDesignatedOngoingOperationsDetail(List<BOPExclusionDesignatedOngoingOperationsDetail> BOPExclusionDesignatedOngoingOperationsDetail) {
		this.BOPExclusionDesignatedOngoingOperationsDetail = BOPExclusionDesignatedOngoingOperationsDetail;
	}
