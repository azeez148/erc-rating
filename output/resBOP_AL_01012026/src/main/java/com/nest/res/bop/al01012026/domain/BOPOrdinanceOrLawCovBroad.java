...
public class BOPOrdinanceOrLawCovBroad    extends Policy  {
	...
	private double Coverage1Factor;
	...
	public double  getCoverage1Factor() {
		return this.Coverage1Factor;
	}
	...
	public void setCoverage1Factor(double Coverage1Factor) {
		this.Coverage1Factor = Coverage1Factor;
	}
