...
public class BOPExclusionViralOrBacterialInfectionsExceptionForDesignatedInfectionOngoingOperationsOrProductsDetail    extends Policy  {
	...
	private Date RateDt;
	private String DescriptionOfInfection;
	private Date EffectiveDt;
	private String DescriptionOfOngoingOperationsOrYourProduct;
	...
	public String  getDescriptionOfInfection() {
		return this.DescriptionOfInfection;
	}
	public int  getEarnedInFullIndicator() {
		return this.EarnedInFullIndicator;
	}
	public String  getDescriptionOfOngoingOperationsOrYourProduct() {
		return this.DescriptionOfOngoingOperationsOrYourProduct;
	}
	...
	public void setDescriptionOfOngoingOperationsOrYourProduct(String DescriptionOfOngoingOperationsOrYourProduct) {
		this.DescriptionOfOngoingOperationsOrYourProduct = DescriptionOfOngoingOperationsOrYourProduct;
	}
	...
	public void setDescriptionOfInfection(String DescriptionOfInfection) {
		this.DescriptionOfInfection = DescriptionOfInfection;
	}
}