...
public class BOPCannabisLiabilityExclusionWithHempExceptionSubjectToHempAggregateLimit    extends Policy  {
	...
	private int HempAggregateLimit;
	...
	public int  getHempAggregateLimit() {
		return this.HempAggregateLimit;
	}
	...
	public void setHempAggregateLimit(int HempAggregateLimit) {
		this.HempAggregateLimit = HempAggregateLimit;
	}
