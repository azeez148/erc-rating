...
public class BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverage    extends Policy  {
	private int FeeIndicator;
	private List<BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail> BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail) {
			childs.addAll(BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail);
		}
		return childs;
	}
	...
	public List<BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail> getBOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail() {
		return this.BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail;
	}
	...
	public void setBOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail(List<BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail> BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail) {
		this.BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail = BOPBusinessIncomeFromDependentPropertiesLimitedInternationalCoverageDetail;
	}
