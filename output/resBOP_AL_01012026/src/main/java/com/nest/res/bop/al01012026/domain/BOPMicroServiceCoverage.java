...
public class BOPMicroServiceCoverage    extends Policy  {
	...
	private double AnimalsPremium;
	private int EarnedInFullIndicator;
	private double AnimalsFactor;
	...
	public double  getAnimalsPremium() {
		return this.AnimalsPremium;
	}
	...
	public double  getAnimalsFactor() {
		return this.AnimalsFactor;
	}
	...
	public void setAnimalsPremium(double AnimalsPremium) {
		this.AnimalsPremium = AnimalsPremium;
	}
	...
	public void setAnimalsFactor(double AnimalsFactor) {
		this.AnimalsFactor = AnimalsFactor;
	}
