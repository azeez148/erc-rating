...
public class BOPBlktRating    extends Policy  {
	...
	private List<BOPBlktRatingDetail> BOPBlktRatingDetail;
	private String Id;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPBlktRatingDetail) {
			childs.addAll(BOPBlktRatingDetail);
		}
		return childs;
	}
	...
	public List<BOPBlktRatingDetail> getBOPBlktRatingDetail() {
		return this.BOPBlktRatingDetail;
	}
	...
	public void setBOPBlktRatingDetail(List<BOPBlktRatingDetail> BOPBlktRatingDetail) {
