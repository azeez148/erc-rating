...
public class BOPFunctlBldgValtnCoverage    extends Policy  {
	...
	private double PostLossOrdinanceOrLawDirectPDFactor;
	...
	public double  getPostLossOrdinanceOrLawDirectPDFactor() {
		return this.PostLossOrdinanceOrLawDirectPDFactor;
	}
	...
	public void setPostLossOrdinanceOrLawDirectPDFactor(double PostLossOrdinanceOrLawDirectPDFactor) {
		this.PostLossOrdinanceOrLawDirectPDFactor = PostLossOrdinanceOrLawDirectPDFactor;
	}
