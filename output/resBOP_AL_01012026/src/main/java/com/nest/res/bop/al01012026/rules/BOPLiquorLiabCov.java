...
public class BOPLiquorLiabCov  {
	...
	private com.nest.res.bop.al01012026.domain.BOPLiquorLiabCov BOPLiquorLiabCov;
	
	
	
	public  BOPLiquorLiabCov (com.nest.res.bop.al01012026.domain.BOPLiquorLiabCov BOPLiquorLiabCov)  {
