...
public class BOPClassificationPermanentYardsStorageCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPClassificationPermanentYardsStorageCoverage BOPClassificationPermanentYardsStorageCoverage;
	...
	public void DedFactor () throws LookupException,NumberFormatException {
		...
		if(!(MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPClassificationPermanentYardsStorageCoverage,"../../../WindHailDeductible"))).equals(MathHelper.getStringValue("Not Applicable")) && (XpathNode.selectNodeValue(this.BOPClassificationPermanentYardsStorageCoverage,"../../BOPWindstormOrHailExclusion")) == null){
	...
	public  BOPClassificationPermanentYardsStorageCoverage (com.nest.res.bop.al01012026.domain.BOPClassificationPermanentYardsStorageCoverage BOPClassificationPermanentYardsStorageCoverage)  {
