...
public class BOPEarthquakeBldgCoverage    extends Policy  {
	...
	private double ProportionateDeductibleFactor;
	...
	public double  getProportionateDeductibleFactor() {
		return this.ProportionateDeductibleFactor;
	}
	...
	public void setProportionateDeductibleFactor(double ProportionateDeductibleFactor) {
		this.ProportionateDeductibleFactor = ProportionateDeductibleFactor;
	}
