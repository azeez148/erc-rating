...
public class BOPBlktRatingDetail    extends Policy  {
	...
	private int classificationAndDetailMatchcount_1;
	...
	private int structureAndDetailMatchcount_1;
	private double totBPPPremiumTemp_1;
	private double PriorPremium;
	private double ShortRatePenalty;
	private Date Effective;
	private int totBldgLimitTemp_1;
	private int EarnedInFullIndicator;
	private String Type;
	private double BlanketPremium;
	private int bldgBlktCount;
	...
	public int  getTotBPPLimitTemp_1() {
		return this.totBPPLimitTemp_1;
	}
	...
	public int  getStructureAndDetailMatchcount_1() {
		return this.structureAndDetailMatchcount_1;
	}
	...
	public double  getTotBPPPremiumTemp_1() {
		return this.totBPPPremiumTemp_1;
	}
	...
	public int  getTotBldgLimitTemp_1() {
		return this.totBldgLimitTemp_1;
	}
	public int  getClassificationAndDetailMatchcount_1() {
		return this.classificationAndDetailMatchcount_1;
	}
	public int  getBppBlktCount() {
		return this.bppBlktCount;
	}
	...
	public int  getBldgBlktCount() {
		return this.bldgBlktCount;
	}
	...
	public double  getBlanketPremium() {
		return this.BlanketPremium;
	}
	...
	public void setTotBPPPremiumTemp_1(double totBPPPremiumTemp_1) {
		this.totBPPPremiumTemp_1 = totBPPPremiumTemp_1;
	}
	...
	public void setBlanketPremium(double BlanketPremium) {
		this.BlanketPremium = BlanketPremium;
	}
	public void setStructureAndDetailMatchcount_1(int structureAndDetailMatchcount_1) {
		this.structureAndDetailMatchcount_1 = structureAndDetailMatchcount_1;
	}
	...
	public void setTotBldgLimitTemp_1(int totBldgLimitTemp_1) {
		this.totBldgLimitTemp_1 = totBldgLimitTemp_1;
	}
	public void setBldgBlktCount(int bldgBlktCount) {
		this.bldgBlktCount = bldgBlktCount;
	}
	public void setClassificationAndDetailMatchcount_1(int classificationAndDetailMatchcount_1) {
		this.classificationAndDetailMatchcount_1 = classificationAndDetailMatchcount_1;
	}
	...
	public void setTotBPPLimitTemp_1(int totBPPLimitTemp_1) {
		this.totBPPLimitTemp_1 = totBPPLimitTemp_1;
	}
	public void setBppBlktCount(int bppBlktCount) {
		this.bppBlktCount = bppBlktCount;
	}
	...
	public void setTotLimit(int TotLimit) {
