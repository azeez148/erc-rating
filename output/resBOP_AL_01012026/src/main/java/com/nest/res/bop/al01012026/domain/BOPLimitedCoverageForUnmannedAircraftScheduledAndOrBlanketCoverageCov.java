...
public class BOPLimitedCoverageForUnmannedAircraftScheduledAndOrBlanketCoverageCov    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private Date Modified;
	private double PolicyTermPremium;
	private double BusinessInterruptionPremium;
	...
	public double  getBusinessInterruptionPremium() {
		return this.BusinessInterruptionPremium;
	}
	...
	public void setBusinessInterruptionPremium(double BusinessInterruptionPremium) {
		this.BusinessInterruptionPremium = BusinessInterruptionPremium;
	}
