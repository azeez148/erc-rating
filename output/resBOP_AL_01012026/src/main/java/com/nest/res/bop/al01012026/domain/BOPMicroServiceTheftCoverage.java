...
public class BOPMicroServiceTheftCoverage    extends Policy  {
	...
	private double PropertyOfOthersTheftFactor;
	...
	public double  getPropertyOfOthersTheftFactor() {
		return this.PropertyOfOthersTheftFactor;
	}
	...
	public void setPropertyOfOthersTheftFactor(double PropertyOfOthersTheftFactor) {
		this.PropertyOfOthersTheftFactor = PropertyOfOthersTheftFactor;
	}
}