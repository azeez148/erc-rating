...
public class BOPGeneticallyModifiedOrganismExclusionForDesignatedOperationsOrProductsDetail    extends Policy  {
	...
	private String DesignatedProduct;
	...
	public String  getDescriptionOfOperation() {
		return this.DescriptionOfOperation;
	}
	...
	public String  getDesignatedProduct() {
	...
	public void setDesignatedProduct(String DesignatedProduct) {
		this.DesignatedProduct = DesignatedProduct;
	}
