...
import com.nest.res.bop.al01012026.domain.BOPInformationSecurityProtectionEndorsementDetail;
...
public class BOPInformationSecurityProtectionEndorsement  {
	...
	private com.nest.res.bop.al01012026.rules.BOPInformationSecurityProtectionEndorsementDetail BOPInformationSecurityProtectionEndorsementDetailRule;
	private com.nest.res.bop.al01012026.domain.BOPInformationSecurityProtectionEndorsement BOPInformationSecurityProtectionEndorsement;
	...
	if(null != BOPInformationSecurityProtectionEndorsementDetailList){
		for(BOPInformationSecurityProtectionEndorsementDetail BOPInformationSecurityProtectionEndorsementDetail:BOPInformationSecurityProtectionEndorsementDetailList){
			BOPInformationSecurityProtectionEndorsementDetailRule = new com.nest.res.bop.al01012026.rules.BOPInformationSecurityProtectionEndorsementDetail(BOPInformationSecurityProtectionEndorsementDetail);
	...
	public  BOPInformationSecurityProtectionEndorsement (com.nest.res.bop.al01012026.domain.BOPInformationSecurityProtectionEndorsement BOPInformationSecurityProtectionEndorsement)  {
