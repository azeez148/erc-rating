...
public class BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverage    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private List<BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail> BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail) {
			childs.addAll(BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail);
		}
		return childs;
	}
	...
	public List<BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail> getBOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail() {
		return this.BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail;
	}
	...
	public void setBOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail(List<BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail> BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail) {
		this.BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail = BOPExtraExpenseFromDependentPropertiesLimitedInternationalCoverageDetail;
	}
}