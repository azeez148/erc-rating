...
public class BOPChangesAttorneysFees    extends Policy  {
	...
	private double EachOccLimitConverted;
	...
	public double  getEachOccLimitConverted() {
		return this.EachOccLimitConverted;
	}
	...
	public void setEachOccLimitConverted(double EachOccLimitConverted) {
		this.EachOccLimitConverted = EachOccLimitConverted;
	}
