...
public class BOPEmpBenefitsLiabCov  {
	...
	private com.nest.res.bop.al01012026.domain.BOPEmpBenefitsLiabCov BOPEmpBenefitsLiabCov;
	
	
	
	public  BOPEmpBenefitsLiabCov (com.nest.res.bop.al01012026.domain.BOPEmpBenefitsLiabCov BOPEmpBenefitsLiabCov)  {
