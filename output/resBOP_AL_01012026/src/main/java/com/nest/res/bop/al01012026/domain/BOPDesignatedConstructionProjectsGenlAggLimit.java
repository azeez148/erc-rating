...
public class BOPDesignatedConstructionProjectsGenlAggLimit    extends Policy  {
	private String ASLOBStatCode;
	private int FeeIndicator;
	private double AnnualPremium;
	private String DesignatedProjects;
	...
	private String DesignatedLocations;
	...
	public String  getDesignatedLocations() {
		return this.DesignatedLocations;
	}
	...
	public String  getDesignatedProjects() {
		return this.DesignatedProjects;
	}
	...
	public void setDesignatedProjects(String DesignatedProjects) {
		this.DesignatedProjects = DesignatedProjects;
	}
	...
	public void setDesignatedLocations(String DesignatedLocations) {
		this.DesignatedLocations = DesignatedLocations;
	}
