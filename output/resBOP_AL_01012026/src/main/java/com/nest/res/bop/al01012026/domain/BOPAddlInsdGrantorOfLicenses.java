...
public class BOPAddlInsdGrantorOfLicenses    extends Policy  {
	...
	private List<BOPAddlInsdGrantorOfLicensesDetail> BOPAddlInsdGrantorOfLicensesDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdGrantorOfLicensesDetail) {
			childs.addAll(BOPAddlInsdGrantorOfLicensesDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdGrantorOfLicensesDetail> getBOPAddlInsdGrantorOfLicensesDetail() {
		return this.BOPAddlInsdGrantorOfLicensesDetail;
	}
	...
	public void setBOPAddlInsdGrantorOfLicensesDetail(List<BOPAddlInsdGrantorOfLicensesDetail> BOPAddlInsdGrantorOfLicensesDetail) {
		this.BOPAddlInsdGrantorOfLicensesDetail = BOPAddlInsdGrantorOfLicensesDetail;
	}
