...
public class BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverage    extends Policy  {
	...
	private List<BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail> BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail;
	...
	private double UnmannedAircraftPropertyLimitedCoveragePremium;
	private double ShortRateFactor;
	private String ExceptedCountriesOrJurisdictions;
	...
	private double unmannedAircraftPropertyLimitedCoveragePremiumTemp_1;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail) {
			childs.addAll(BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail);
		}
		return childs;
	}


	public double  getUnmannedAircraftPropertyLimitedCoveragePremium() {
		return this.UnmannedAircraftPropertyLimitedCoveragePremium;
	}
	...
	public List<BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail> getBOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail() {
		return this.BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail;
	}
	...
	public double  getUnmannedAircraftPropertyLimitedCoveragePremiumTemp_1() {
		return this.unmannedAircraftPropertyLimitedCoveragePremiumTemp_1;
	}
	...
	public String  getExceptedCountriesOrJurisdictions() {
		return this.ExceptedCountriesOrJurisdictions;
	}
	...
	public void setUnmannedAircraftPropertyLimitedCoveragePremiumTemp_1(double unmannedAircraftPropertyLimitedCoveragePremiumTemp_1) {
		this.unmannedAircraftPropertyLimitedCoveragePremiumTemp_1 = unmannedAircraftPropertyLimitedCoveragePremiumTemp_1;
	}
	...
	public void setExceptedCountriesOrJurisdictions(String ExceptedCountriesOrJurisdictions) {
		this.ExceptedCountriesOrJurisdictions = ExceptedCountriesOrJurisdictions;
	}
	...
	public void setBOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail(List<BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail> BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail) {
		this.BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail = BOPAmendmentOfCoverageTerritoryForUnmannedAircraftWorldwideCoverageDetail;
	}
	...
	public void setUnmannedAircraftPropertyLimitedCoveragePremium(double UnmannedAircraftPropertyLimitedCoveragePremium) {
		this.UnmannedAircraftPropertyLimitedCoveragePremium = UnmannedAircraftPropertyLimitedCoveragePremium;
	}
