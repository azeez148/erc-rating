...
public class BOPBurglaryAndRobberyProtectiveSafeguardsDetail    extends Policy  {
	...
	public void setBR4Desc(String BR4Desc) {
		this.BR4Desc = BR4Desc;
	}
