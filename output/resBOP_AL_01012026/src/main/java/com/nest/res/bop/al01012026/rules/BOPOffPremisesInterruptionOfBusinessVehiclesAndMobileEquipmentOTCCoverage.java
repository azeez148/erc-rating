...
public class BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage;
	
	
	
	public void AdditionalPremiumFloodCoverage ()  {
	  
		if((XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../../BOPFloodCov")) != null){
			this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage.setAdditionalPremiumFloodCoverage(MathHelper.getDoubleValue(MathHelper.roundUpDoller(MathHelper.roundToThousand(MathHelper.roundToThousand(MathHelper.roundToThousand((MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../OTCLossCosts"))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../../LCM")))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../FloodCoverageFactor")))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../InsuranceToExposureFactor")))) * ((MathHelper.getIntegerValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../dsLimit"))) / MathHelper.getDoubleValue(100.0)))));
		}
		else{
			this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage.setAdditionalPremiumFloodCoverage(MathHelper.getDoubleValue(MathHelper.getDoubleValue(0.0)));
		}
	...
	public void AdditionalPremiumWindHailExclusionCredit ()  {
	  
		if(XpathNode.selectNodes(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../../BOPStructure/BOPWindstormOrHailExclusion").size() > 0.0){
			this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage.setAdditionalPremiumWindHailExclusionCredit(MathHelper.getDoubleValue(MathHelper.roundUpDoller(MathHelper.roundToThousand(MathHelper.roundToThousand(MathHelper.roundToThousand((MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../OTCLossCosts"))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../../LCM")))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../WindHailExclusionFactor")))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../InsuranceToExposureFactor")))) * ((MathHelper.getIntegerValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../dsLimit"))) / MathHelper.getDoubleValue(100.0)))));
		}
		else{
			this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage.setAdditionalPremiumWindHailExclusionCredit(MathHelper.getDoubleValue(MathHelper.getDoubleValue(0.0)));
		}
	...
	AdditionalPremiumEarthquakeCoverage();
	
	AdditionalPremiumFloodCoverage();
	
	AdditionalPremiumWindHailExclusionCredit();
	...
	public  BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage (com.nest.res.bop.al01012026.domain.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage)  {
	...
	public void AdditionalPremiumEarthquakeCoverage ()  {
	  
		if(XpathNode.selectNodes(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../../BOPStructure/BOPEQSubLimit").size() > 0.0 || XpathNode.selectNodes(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../../BOPStructure/BOPEarthquake").size() > 0.0){
			this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage.setAdditionalPremiumEarthquakeCoverage(MathHelper.getDoubleValue(MathHelper.roundUpDoller(MathHelper.roundToThousand(MathHelper.roundToThousand(MathHelper.roundToThousand((MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../OTCLossCosts"))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../../LCM")))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../../EarthquakeCoverageFactor")))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../InsuranceToExposureFactor")))) * ((MathHelper.getIntegerValue(XpathNode.selectNodeValue(this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage,"../dsLimit"))) / MathHelper.getDoubleValue(100.0)))));
		}
		else{
			this.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentOTCCoverage.setAdditionalPremiumEarthquakeCoverage(MathHelper.getDoubleValue(MathHelper.getDoubleValue(0.0)));
		}
