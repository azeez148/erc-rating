...
public class BOPCannabisExclWithDesignatedProductOrWorkExceptionSubjectToCannabisProdsCompldOpsAggregateLimitDetail    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private Date Modified;
	private double PolicyTermPremium;
	private String DescriptionOfYourWork;
	...
	private String DescriptionOfYourProduct;
	...
	public String  getDescriptionOfYourWork() {
		return this.DescriptionOfYourWork;
	}
	...
	public String  getDescriptionOfYourProduct() {
		return this.DescriptionOfYourProduct;
	}
	...
	public void setDescriptionOfYourProduct(String DescriptionOfYourProduct) {
		this.DescriptionOfYourProduct = DescriptionOfYourProduct;
	}
	public void setDescriptionOfYourWork(String DescriptionOfYourWork) {
		this.DescriptionOfYourWork = DescriptionOfYourWork;
	}
