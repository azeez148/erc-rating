...
public class BOPAddlInsdLandLeased    extends Policy  {
	...
	private List<BOPAddlInsdLandLeasedDetail> BOPAddlInsdLandLeasedDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdLandLeasedDetail) {
			childs.addAll(BOPAddlInsdLandLeasedDetail);
		}
		return childs;
	}


	public List<BOPAddlInsdLandLeasedDetail> getBOPAddlInsdLandLeasedDetail() {
		return this.BOPAddlInsdLandLeasedDetail;
	}
	...
	public void setBOPAddlInsdLandLeasedDetail(List<BOPAddlInsdLandLeasedDetail> BOPAddlInsdLandLeasedDetail) {
		this.BOPAddlInsdLandLeasedDetail = BOPAddlInsdLandLeasedDetail;
	}
