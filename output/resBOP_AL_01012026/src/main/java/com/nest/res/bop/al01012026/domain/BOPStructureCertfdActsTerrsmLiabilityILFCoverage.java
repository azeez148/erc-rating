...
public class BOPStructureCertfdActsTerrsmLiabilityILFCoverage    extends Policy  {
	...
	private double EndYearTerrsmFactor;
	...
	private double BeginYearTerrsmFactor;
	...
	public double  getBeginYearTerrsmFactor() {
		return this.BeginYearTerrsmFactor;
	}
	...
	public double  getEndYearTerrsmFactor() {
		return this.EndYearTerrsmFactor;
	}
	...
	public void setEndYearTerrsmFactor(double EndYearTerrsmFactor) {
		this.EndYearTerrsmFactor = EndYearTerrsmFactor;
	}
	...
	public void setBeginYearTerrsmFactor(double BeginYearTerrsmFactor) {
		this.BeginYearTerrsmFactor = BeginYearTerrsmFactor;
	}
