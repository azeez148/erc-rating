...
public class BOPAddlInsdLessorsLeasedEquipmtDetail  {
	...
	private com.nest.res.bop.al01012026.domain.BOPAddlInsdLessorsLeasedEquipmtDetail BOPAddlInsdLessorsLeasedEquipmtDetail;
	
	
	
	public  BOPAddlInsdLessorsLeasedEquipmtDetail (com.nest.res.bop.al01012026.domain.BOPAddlInsdLessorsLeasedEquipmtDetail BOPAddlInsdLessorsLeasedEquipmtDetail)  {
