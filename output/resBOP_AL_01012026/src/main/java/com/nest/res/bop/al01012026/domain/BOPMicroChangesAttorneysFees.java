...
public class BOPMicroChangesAttorneysFees    extends Policy  {
	...
	private double PerOccurrenceLimitConverted;
	...
	public int  getAttorneysFees() {
		return this.AttorneysFees;
	}
	...
	public double  getPerOccurrenceLimitConverted() {
		return this.PerOccurrenceLimitConverted;
	}
	...
	public void setPerOccurrenceLimitConverted(double PerOccurrenceLimitConverted) {
		this.PerOccurrenceLimitConverted = PerOccurrenceLimitConverted;
	}
	...
	public void setAttorneysFees(int AttorneysFees) {
		this.AttorneysFees = AttorneysFees;
	}
