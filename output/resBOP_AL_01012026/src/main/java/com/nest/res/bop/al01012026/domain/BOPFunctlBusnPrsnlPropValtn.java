...
public class BOPFunctlBusnPrsnlPropValtn    extends Policy  {
	private int FeeIndicator;
	private String FormNumber;
	private double PolicyTermPremium;
	private double TotalNamedPerilsFunctlBusnPrsnlPropCovPremium;
	...
	private double totalNamedPerilsFunctlBusnPrsnlPropCovPremiumTemp_1;
	...
	private double totalFunctlBusnPrsnlPropValtnCovPremiumTemp_1;
	private double ChangePremium;
	private double TotalFunctlBusnPrsnlPropValtnCovPremium;
	...
	private List<BOPFunctlBusnPrsnlPropValtnDetail> BOPFunctlBusnPrsnlPropValtnDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPFunctlBusnPrsnlPropValtnDetail) {
			childs.addAll(BOPFunctlBusnPrsnlPropValtnDetail);
		}
		return childs;
	}
	...
	public double  getTotalNamedPerilsFunctlBusnPrsnlPropCovPremiumTemp_1() {
		return this.totalNamedPerilsFunctlBusnPrsnlPropCovPremiumTemp_1;
	}
	...
	public double  getTotalNamedPerilsFunctlBusnPrsnlPropCovPremium() {
		return this.TotalNamedPerilsFunctlBusnPrsnlPropCovPremium;
	}
	...
	public double  getTotalFunctlBusnPrsnlPropValtnCovPremium() {
		return this.TotalFunctlBusnPrsnlPropValtnCovPremium;
	}
	...
	public double  getTotalFunctlBusnPrsnlPropValtnCovPremiumTemp_1() {
		return this.totalFunctlBusnPrsnlPropValtnCovPremiumTemp_1;
	}
	...
	public List<BOPFunctlBusnPrsnlPropValtnDetail> getBOPFunctlBusnPrsnlPropValtnDetail() {
		return this.BOPFunctlBusnPrsnlPropValtnDetail;
	}
	...
	public void setTotalNamedPerilsFunctlBusnPrsnlPropCovPremiumTemp_1(double totalNamedPerilsFunctlBusnPrsnlPropCovPremiumTemp_1) {
		this.totalNamedPerilsFunctlBusnPrsnlPropCovPremiumTemp_1 = totalNamedPerilsFunctlBusnPrsnlPropCovPremiumTemp_1;
	}
	...
	public void setTotalNamedPerilsFunctlBusnPrsnlPropCovPremium(double TotalNamedPerilsFunctlBusnPrsnlPropCovPremium) {
		this.TotalNamedPerilsFunctlBusnPrsnlPropCovPremium = TotalNamedPerilsFunctlBusnPrsnlPropCovPremium;
	}
	...
	public void setBOPFunctlBusnPrsnlPropValtnDetail(List<BOPFunctlBusnPrsnlPropValtnDetail> BOPFunctlBusnPrsnlPropValtnDetail) {
		this.BOPFunctlBusnPrsnlPropValtnDetail = BOPFunctlBusnPrsnlPropValtnDetail;
	}
	public void setTotalFunctlBusnPrsnlPropValtnCovPremiumTemp_1(double totalFunctlBusnPrsnlPropValtnCovPremiumTemp_1) {
		this.totalFunctlBusnPrsnlPropValtnCovPremiumTemp_1 = totalFunctlBusnPrsnlPropValtnCovPremiumTemp_1;
	}
	...
	public void setTotalFunctlBusnPrsnlPropValtnCovPremium(double TotalFunctlBusnPrsnlPropValtnCovPremium) {
		this.TotalFunctlBusnPrsnlPropValtnCovPremium = TotalFunctlBusnPrsnlPropValtnCovPremium;
	}
}