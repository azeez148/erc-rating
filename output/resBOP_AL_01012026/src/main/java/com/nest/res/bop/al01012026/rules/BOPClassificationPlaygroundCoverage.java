...
public class BOPClassificationPlaygroundCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPClassificationPlaygroundCoverage BOPClassificationPlaygroundCoverage;
	
	
	
	public  BOPClassificationPlaygroundCoverage (com.nest.res.bop.al01012026.domain.BOPClassificationPlaygroundCoverage BOPClassificationPlaygroundCoverage)  {
	...
	public void CoverageOnPolicyIndicator ()  {
		...
		if(this.BOPClassificationPlaygroundCoverage.getPlayground().equals(MathHelper.getStringValue("None")) || this.BOPClassificationPlaygroundCoverage.getPlayground().equals(MathHelper.getStringValue(""))){
