...
public class BOPCondosCoOpsAssocsDirectorsAndOfficersLiab    extends Policy  {
	private int FeeIndicator;
	private int Deductible;
	private String FormNumber;
	private double PolicyTermPremium;
	private int SupplementalLimit;
	private Date ExpirationDt;
	private Date AddEffectiveDt;
	private double Premium;
	private Date EffectiveDt;
	private String NamedAssoc;
	...
	private double DedDiscountFactor;
	private Date Modified;
	private String SupplementalExtddRptgPeriod;
	private int DefenseExpenseLimitOfInsurance;
	private Date RateDt;
	...
	private Date PendingOrPriorLitigationDate;
	...
	private double ManualBaseRate;
	private String RetroDateSelect;
	private double LOIFactor;
	...
	public Date  getPendingOrPriorLitigationDate() {
		return this.PendingOrPriorLitigationDate;
	}
	...
	public String  getNamedAssoc() {
		return this.NamedAssoc;
	}
	public int  getEarnedInFullIndicator() {
		return this.EarnedInFullIndicator;
	}
	public String  getSupplementalExtddRptgPeriod() {
		return this.SupplementalExtddRptgPeriod;
	}
	...
	public double  getDedDiscountFactor() {
		return this.DedDiscountFactor;
	}
	public String  getFormName() {
		return this.FormName;
	}
	public double  getManualBaseRate() {
		return this.ManualBaseRate;
	}
	...
	public int  getDefenseExpenseLimitOfInsurance() {
		return this.DefenseExpenseLimitOfInsurance;
	}
	public double  getLOIFactor() {
		return this.LOIFactor;
	}
	...
	public int  getSupplementalLimit() {
		return this.SupplementalLimit;
	}
	...
	public void setPendingOrPriorLitigationDate(Date PendingOrPriorLitigationDate) {
		this.PendingOrPriorLitigationDate = PendingOrPriorLitigationDate;
	}
	...
	public void setNamedAssoc(String NamedAssoc) {
		this.NamedAssoc = NamedAssoc;
	}
	...
	public void setDefenseExpenseLimitOfInsurance(int DefenseExpenseLimitOfInsurance) {
		this.DefenseExpenseLimitOfInsurance = DefenseExpenseLimitOfInsurance;
	}
	...
	public void setSupplementalLimit(int SupplementalLimit) {
		this.SupplementalLimit = SupplementalLimit;
	}
	...
	public void setDedDiscountFactor(double DedDiscountFactor) {
		this.DedDiscountFactor = DedDiscountFactor;
	}
	...
	public void setLOIFactor(double LOIFactor) {
		this.LOIFactor = LOIFactor;
	}
	...
	public void setManualBaseRate(double ManualBaseRate) {
		this.ManualBaseRate = ManualBaseRate;
	}
	public void setSupplementalExtddRptgPeriod(String SupplementalExtddRptgPeriod) {
		this.SupplementalExtddRptgPeriod = SupplementalExtddRptgPeriod;
	}
