...
import com.nest.res.bop.al01012026.domain.BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage;
import com.nest.res.bop.al01012026.domain.BOPBusnIncomeChangesTimePeriodBldgCoverage;
...
public class BOPBusnIncomeChangesTimePeriod  {
	...
	private com.nest.res.bop.al01012026.domain.BOPBusnIncomeChangesTimePeriod BOPBusnIncomeChangesTimePeriod;
	...
	private com.nest.res.bop.al01012026.rules.BOPBusnIncomeChangesTimePeriodBldgCoverage BOPBusnIncomeChangesTimePeriodBldgCoverageRule;
	private com.nest.res.bop.al01012026.rules.BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverageRule;
	...
	if(null != BOPBusnIncomeChangesTimePeriodBldgCoverageList){
		for(BOPBusnIncomeChangesTimePeriodBldgCoverage BOPBusnIncomeChangesTimePeriodBldgCoverage:BOPBusnIncomeChangesTimePeriodBldgCoverageList){
			BOPBusnIncomeChangesTimePeriodBldgCoverageRule = new com.nest.res.bop.al01012026.rules.BOPBusnIncomeChangesTimePeriodBldgCoverage(BOPBusnIncomeChangesTimePeriodBldgCoverage);
	...
	if(null != BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverageList){
		for(BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage:BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverageList){
			BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverageRule = new com.nest.res.bop.al01012026.rules.BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage(BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage);
...
this.BOPBusnIncomeChangesTimePeriod.setPremium(MathHelper.getDoubleValue(this.BOPBusnIncomeChangesTimePeriod.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPBusnIncomeChangesTimePeriod,"BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage/Premium")))));
	...
	public  BOPBusnIncomeChangesTimePeriod (com.nest.res.bop.al01012026.domain.BOPBusnIncomeChangesTimePeriod BOPBusnIncomeChangesTimePeriod)  {
