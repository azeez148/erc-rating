...
public class BOPCannabisPropertyCoverage    extends Policy  {
	...
	public int  getOptionalDeductible() {
		return this.OptionalDeductible;
	}
	public int  getBusinessIncomeLimit() {
		return this.BusinessIncomeLimit;
	}
	...
	public int  getExtraExpenseLimit() {
	...
	public void setOptionalDeductible(int OptionalDeductible) {
	...
	public void setBusinessIncomeLimit(int BusinessIncomeLimit) {
		this.BusinessIncomeLimit = BusinessIncomeLimit;
	}
	public void setExtraExpenseLimit(int ExtraExpenseLimit) {
