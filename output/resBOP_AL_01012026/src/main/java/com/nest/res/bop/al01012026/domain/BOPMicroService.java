...
public class BOPMicroService    extends Policy  {
	...
	private String NameOfAdditionalInsuredPersonsOrOrganizations;
	...
	private List<BOPMicroServiceTheftCoverage> BOPMicroServiceTheftCoverage;
	private double ShortRatePenalty;
	private List<BOPMicroServiceRewardPaymentCoverage> BOPMicroServiceRewardPaymentCoverage;
	private double ChangePremium;
	private Date Effective;
	private int EarnedInFullIndicator;
	private List<BOPMicroServiceCoverage> BOPMicroServiceCoverage;
	private int ShortRateIndicator;
	private List<BOPMicroServiceKeyAndLockReplacementCoverage> BOPMicroServiceKeyAndLockReplacementCoverage;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPMicroServiceTheftCoverage) {
			childs.addAll(BOPMicroServiceTheftCoverage);
		}
		if(null != BOPMicroServiceRewardPaymentCoverage) {
			childs.addAll(BOPMicroServiceRewardPaymentCoverage);
		}
		if(null != BOPMicroServiceCoverage) {
			childs.addAll(BOPMicroServiceCoverage);
		}
		if(null != BOPMicroServiceKeyAndLockReplacementCoverage) {
			childs.addAll(BOPMicroServiceKeyAndLockReplacementCoverage);
		}
		return childs;
	}
	...
	public List<BOPMicroServiceTheftCoverage> getBOPMicroServiceTheftCoverage() {
		return this.BOPMicroServiceTheftCoverage;
	}
	...
	public String  getNameOfAdditionalInsuredPersonsOrOrganizations() {
		return this.NameOfAdditionalInsuredPersonsOrOrganizations;
	}
	...
	public List<BOPMicroServiceRewardPaymentCoverage> getBOPMicroServiceRewardPaymentCoverage() {
		return this.BOPMicroServiceRewardPaymentCoverage;
	}
	...
	public List<BOPMicroServiceCoverage> getBOPMicroServiceCoverage() {
		return this.BOPMicroServiceCoverage;
	}
	public List<BOPMicroServiceKeyAndLockReplacementCoverage> getBOPMicroServiceKeyAndLockReplacementCoverage() {
		return this.BOPMicroServiceKeyAndLockReplacementCoverage;
	}
	...
	public void setNameOfAdditionalInsuredPersonsOrOrganizations(String NameOfAdditionalInsuredPersonsOrOrganizations) {
		this.NameOfAdditionalInsuredPersonsOrOrganizations = NameOfAdditionalInsuredPersonsOrOrganizations;
	}
	...
	public void setBOPMicroServiceTheftCoverage(List<BOPMicroServiceTheftCoverage> BOPMicroServiceTheftCoverage) {
	...
	public void setBOPMicroServiceCoverage(List<BOPMicroServiceCoverage> BOPMicroServiceCoverage) {
	...
	public void setBOPMicroServiceKeyAndLockReplacementCoverage(List<BOPMicroServiceKeyAndLockReplacementCoverage> BOPMicroServiceKeyAndLockReplacementCoverage) {
		this.BOPMicroServiceKeyAndLockReplacementCoverage = BOPMicroServiceKeyAndLockReplacementCoverage;
	}
	...
	public void setBOPMicroServiceRewardPaymentCoverage(List<BOPMicroServiceRewardPaymentCoverage> BOPMicroServiceRewardPaymentCoverage) {
		this.BOPMicroServiceRewardPaymentCoverage = BOPMicroServiceRewardPaymentCoverage;
	}
