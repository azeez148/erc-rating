...
public class BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasis    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private Date Modified;
	private double PolicyTermPremium;
	private List<BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail> BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail) {
			childs.addAll(BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail);
		}
		return childs;
	}
	...
	public List<BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail> getBOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail() {
		return this.BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail;
	}
	...
	public void setBOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail(List<BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail> BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail) {
		this.BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail = BOPMicroLimitationOfCoverageForTerrorismSublimitOnAnnualAggregateBasisDetail;
	}
