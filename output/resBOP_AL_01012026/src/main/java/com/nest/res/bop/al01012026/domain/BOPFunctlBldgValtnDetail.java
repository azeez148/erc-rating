...
public class BOPFunctlBldgValtnDetail    extends Policy  {
	...
	private List<BOPFunctlBldgValtnCoverage> BOPFunctlBldgValtnCoverage;
	private String PostLossOrdinanceOrLawBIAndEE;
	private Date RateDt;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPFunctlBldgValtnCoverage) {
			childs.addAll(BOPFunctlBldgValtnCoverage);
		}
		return childs;
	}
	...
	public String  getPostLossOrdinanceOrLawDirectPD() {
		return this.PostLossOrdinanceOrLawDirectPD;
	}
	public int  getLimitOfInsurance() {
	...
	public List<BOPFunctlBldgValtnCoverage> getBOPFunctlBldgValtnCoverage() {
		return this.BOPFunctlBldgValtnCoverage;
	}
	...
	public String  getPostLossOrdinanceOrLawBIAndEE() {
		return this.PostLossOrdinanceOrLawBIAndEE;
	}
	...
	public String  getBusinessIncomeExtraExpense() {
		return this.BusinessIncomeExtraExpense;
	}
	...
	public void setPostLossOrdinanceOrLawDirectPD(String PostLossOrdinanceOrLawDirectPD) {
		this.PostLossOrdinanceOrLawDirectPD = PostLossOrdinanceOrLawDirectPD;
	}
	public void setPostLossOrdinanceOrLawBIAndEE(String PostLossOrdinanceOrLawBIAndEE) {
		this.PostLossOrdinanceOrLawBIAndEE = PostLossOrdinanceOrLawBIAndEE;
	}
	public void setLimitOfInsurance(int LimitOfInsurance) {
	...
	public void setBusinessIncomeExtraExpense(String BusinessIncomeExtraExpense) {
		this.BusinessIncomeExtraExpense = BusinessIncomeExtraExpense;
	}
	...
	public void setBOPFunctlBldgValtnCoverage(List<BOPFunctlBldgValtnCoverage> BOPFunctlBldgValtnCoverage) {
