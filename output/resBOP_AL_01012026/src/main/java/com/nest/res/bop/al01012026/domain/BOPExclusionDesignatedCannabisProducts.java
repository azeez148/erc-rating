...
public class BOPExclusionDesignatedCannabisProducts    extends Policy  {
	...
	private List<BOPExclusionDesignatedCannabisProductsDetail> BOPExclusionDesignatedCannabisProductsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPExclusionDesignatedCannabisProductsDetail) {
			childs.addAll(BOPExclusionDesignatedCannabisProductsDetail);
		}
		return childs;
	}
	...
	public List<BOPExclusionDesignatedCannabisProductsDetail> getBOPExclusionDesignatedCannabisProductsDetail() {
		return this.BOPExclusionDesignatedCannabisProductsDetail;
	}
	...
	public void setBOPExclusionDesignatedCannabisProductsDetail(List<BOPExclusionDesignatedCannabisProductsDetail> BOPExclusionDesignatedCannabisProductsDetail) {
		this.BOPExclusionDesignatedCannabisProductsDetail = BOPExclusionDesignatedCannabisProductsDetail;
	}
}