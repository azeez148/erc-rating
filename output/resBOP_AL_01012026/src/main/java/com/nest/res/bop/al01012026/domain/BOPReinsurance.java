...
public class BOPReinsurance    extends Policy  {
	...
	private String SharedCertificate;
	...
	private String SharedCertificateWithPolicy;
	...
	private int OtherInsurerIndicator;
	...
	public double  getReinsurancePremium() {
		return this.ReinsurancePremium;
	}
	...
	public int  getOtherInsurerCode() {
		return this.OtherInsurerCode;
	}
	...
	public String  getSharedCertificate() {
	...
	public int  getOtherInsurerIndicator() {
		return this.OtherInsurerIndicator;
	}
	...
	public String  getSharedCertificateWithPolicy() {
		return this.SharedCertificateWithPolicy;
	}
	...
	public void setOtherInsurerIndicator(int OtherInsurerIndicator) {
		this.OtherInsurerIndicator = OtherInsurerIndicator;
	}
	...
	public void setSharedCertificateWithPolicy(String SharedCertificateWithPolicy) {
		this.SharedCertificateWithPolicy = SharedCertificateWithPolicy;
	}
	...
	public void setInsurerCode(int InsurerCode) {
	...
	public void setOtherInsurerCode(int OtherInsurerCode) {
		this.OtherInsurerCode = OtherInsurerCode;
	}
	...
	public void setSharedCertificate(String SharedCertificate) {
