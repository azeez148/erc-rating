...
public class BOPInterruptionComputerOpsCoverage    extends Policy  {
	...
	private double InterruptionComputerOpsRatingLimit;
	...
	public double  getAddlLocPremium() {
		return this.AddlLocPremium;
	}
	...
	public double  getInterruptionComputerOpsRatingLimit() {
		return this.InterruptionComputerOpsRatingLimit;
	}
	...
	public void setAddlLocPremium(double AddlLocPremium) {
		this.AddlLocPremium = AddlLocPremium;
	}
	...
	public void setInterruptionComputerOpsRatingLimit(double InterruptionComputerOpsRatingLimit) {
		this.InterruptionComputerOpsRatingLimit = InterruptionComputerOpsRatingLimit;
	}
