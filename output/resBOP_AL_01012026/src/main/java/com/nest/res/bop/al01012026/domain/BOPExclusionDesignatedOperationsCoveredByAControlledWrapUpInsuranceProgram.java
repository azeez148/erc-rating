...
public class BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgram    extends Policy  {
	...
	private List<BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail> BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail) {
			childs.addAll(BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail);
		}
		return childs;
	}
	...
	public List<BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail> getBOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail() {
		return this.BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail;
	}
	...
	public void setBOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail(List<BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail> BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail) {
		this.BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail = BOPExclusionDesignatedOperationsCoveredByAControlledWrapUpInsuranceProgramDetail;
	}
