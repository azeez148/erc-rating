...
public class BOPStateChangesResidentialCondoCommlUnitOwnersCov    extends Policy  {
	...
	private String AdditionalImprovementsAndAdditions;
	...
	public String  getAdditionalImprovementsAndAdditions() {
		return this.AdditionalImprovementsAndAdditions;
	}
	public String  getId() {
		return this.Id;
	}
	...
	public void setAdditionalImprovementsAndAdditions(String AdditionalImprovementsAndAdditions) {
		this.AdditionalImprovementsAndAdditions = AdditionalImprovementsAndAdditions;
	}
