...
public class BOPMicroChanges    extends Policy  {
	...
	private int DefenseExpensesLimitOfLiability;
	...
	public int  getDefenseExpensesLimitOfLiability() {
		return this.DefenseExpensesLimitOfLiability;
	}
	...
	public void setDefenseExpensesLimitOfLiability(int DefenseExpensesLimitOfLiability) {
		this.DefenseExpensesLimitOfLiability = DefenseExpensesLimitOfLiability;
	}
