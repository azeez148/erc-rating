...
public class BOPComputerFraudFundsTransferFraudCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPComputerFraudFundsTransferFraudCoverage BOPComputerFraudFundsTransferFraudCoverage;
	
	
	
	public void numEmployeesTemp_1 ()  {
	  this.BOPComputerFraudFundsTransferFraudCoverage.setNumEmployeesTemp_1(MathHelper.getIntegerValue(0.0));
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(policy,"ComputerFraudApply"))).equals(MathHelper.getStringValue("Yes"))){
			this.BOPComputerFraudFundsTransferFraudCoverage.setNumEmployeesTemp_1(MathHelper.getIntegerValue(MathHelper.getIntegerValue(this.BOPComputerFraudFundsTransferFraudCoverage.getNumEmployeesTemp_1() + (MathHelper.getIntegerValue(XpathNode.selectNodeValue(policy,"ComputerFraudNumEmployees"))))));
		}		}
	...
	public void CoverageOnPolicyIndicator ()  {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPComputerFraudFundsTransferFraudCoverage,"../MicroBOP"))).equals(MathHelper.getStringValue("No"))){
	...
	public  BOPComputerFraudFundsTransferFraudCoverage (com.nest.res.bop.al01012026.domain.BOPComputerFraudFundsTransferFraudCoverage BOPComputerFraudFundsTransferFraudCoverage)  {
	...
	public void NumEmployees ()  {
	  this.BOPComputerFraudFundsTransferFraudCoverage.setDsNumEmployees(this.BOPComputerFraudFundsTransferFraudCoverage.getNumEmployeesTemp_1());
