...
public class BOPClassificationAmusementAreaCoverage  {
	...
	private com.nest.res.bop.al01012026.domain.BOPClassificationAmusementAreaCoverage BOPClassificationAmusementAreaCoverage;
	
	
	
	public  BOPClassificationAmusementAreaCoverage (com.nest.res.bop.al01012026.domain.BOPClassificationAmusementAreaCoverage BOPClassificationAmusementAreaCoverage)  {
