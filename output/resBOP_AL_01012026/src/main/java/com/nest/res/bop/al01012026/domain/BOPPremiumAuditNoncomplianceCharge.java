...
public class BOPPremiumAuditNoncomplianceCharge    extends Policy  {
	...
	private double TotalAdvancePremium;
	...
	private int NumberOfWrittenAttempts;
	private double ChangePremium;
	private Date Effective;
	private double ReassessmentCharge;
	private int EarnedInFullIndicator;
	private double AuditNoncomplianceChargeFactor;
	...
	public int  getNumberOfWrittenAttempts() {
		return this.NumberOfWrittenAttempts;
	}
	public double  getReassessmentCharge() {
		return this.ReassessmentCharge;
	}
	...
	public double  getTotalAdvancePremium() {
		return this.TotalAdvancePremium;
	}
	...
	public double  getAuditNoncomplianceChargeFactor() {
		return this.AuditNoncomplianceChargeFactor;
	}
	...
	public void setTotalAdvancePremium(double TotalAdvancePremium) {
		this.TotalAdvancePremium = TotalAdvancePremium;
	}
	...
	public void setAuditNoncomplianceChargeFactor(double AuditNoncomplianceChargeFactor) {
		this.AuditNoncomplianceChargeFactor = AuditNoncomplianceChargeFactor;
	}
	...
	public void setReassessmentCharge(double ReassessmentCharge) {
		this.ReassessmentCharge = ReassessmentCharge;
	}
