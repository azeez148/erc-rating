...
public class BOPMicroRetailStockCoverage    extends Policy  {
	...
	public double  getStockPremium() {
		return this.StockPremium;
	}
	...
	public void setStockPremium(double StockPremium) {
