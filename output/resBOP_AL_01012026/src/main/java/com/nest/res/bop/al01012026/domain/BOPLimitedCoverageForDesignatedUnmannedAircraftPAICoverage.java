...
public class BOPLimitedCoverageForDesignatedUnmannedAircraftPAICoverage    extends Policy  {
	...
	private double UACPersonalAdvertisingInjuryRate;
	...
	public double  getUACPersonalAdvertisingInjuryRate() {
		return this.UACPersonalAdvertisingInjuryRate;
	}
	...
	public double  getPremiumPAI() {
		return this.PremiumPAI;
	}
	...
	public void setPremiumPAI(double PremiumPAI) {
		this.PremiumPAI = PremiumPAI;
	}
	...
	public void setUACPersonalAdvertisingInjuryRate(double UACPersonalAdvertisingInjuryRate) {
		this.UACPersonalAdvertisingInjuryRate = UACPersonalAdvertisingInjuryRate;
	}
