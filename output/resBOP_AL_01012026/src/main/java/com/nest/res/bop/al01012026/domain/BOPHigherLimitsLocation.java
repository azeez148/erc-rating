...
public class BOPHigherLimitsLocation    extends Policy  {
	...
	private List<BOPHigherLimitsLocationDetail> BOPHigherLimitsLocationDetail;
	private Date Created;
	private double OverridePremium;
	private String LocationFireDeptServiceCoverage;
	...
	private double LocationFireDeptServiceCoverageGeneratedPremium;
	...
	private int LocationFireDeptServiceCoverageLimit;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPHigherLimitsLocationDetail) {
			childs.addAll(BOPHigherLimitsLocationDetail);
		}
		return childs;
	}
	...
	public String  getLocationFireDeptServiceCoverage() {
		return this.LocationFireDeptServiceCoverage;
	}
	public int  getLocationFireDeptServiceCoverageLimit() {
		return this.LocationFireDeptServiceCoverageLimit;
	}
	...
	public List<BOPHigherLimitsLocationDetail> getBOPHigherLimitsLocationDetail() {
		return this.BOPHigherLimitsLocationDetail;
	}
	...
	public double  getLocationFireDeptServiceCoverageGeneratedPremium() {
		return this.LocationFireDeptServiceCoverageGeneratedPremium;
	}
	...
	public void setLocationFireDeptServiceCoverageLimit(int LocationFireDeptServiceCoverageLimit) {
		this.LocationFireDeptServiceCoverageLimit = LocationFireDeptServiceCoverageLimit;
	}
	...
	public void setLocationFireDeptServiceCoverageGeneratedPremium(double LocationFireDeptServiceCoverageGeneratedPremium) {
		this.LocationFireDeptServiceCoverageGeneratedPremium = LocationFireDeptServiceCoverageGeneratedPremium;
	}
	...
	public void setBOPHigherLimitsLocationDetail(List<BOPHigherLimitsLocationDetail> BOPHigherLimitsLocationDetail) {
	...
	public void setLocationFireDeptServiceCoverage(String LocationFireDeptServiceCoverage) {
		this.LocationFireDeptServiceCoverage = LocationFireDeptServiceCoverage;
	}
