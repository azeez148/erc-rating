...
public class BOPFunctlBldgValtn    extends Policy  {
	...
	private String LimitOfInsurance;
	...
	private List<BOPFunctlBldgValtnDetail> BOPFunctlBldgValtnDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPFunctlBldgValtnDetail) {
			childs.addAll(BOPFunctlBldgValtnDetail);
		}
		return childs;
	}
	...
	public List<BOPFunctlBldgValtnDetail> getBOPFunctlBldgValtnDetail() {
		return this.BOPFunctlBldgValtnDetail;
	}
	...
	public void setBOPFunctlBldgValtnDetail(List<BOPFunctlBldgValtnDetail> BOPFunctlBldgValtnDetail) {
