...
public class BOPCannabisActivityLiabilityCoverageAggregateLimit    extends Policy  {
	...
	private int CannabisActivityAggregateLimit;
	...
	public int  getCannabisActivityAggregateLimit() {
		return this.CannabisActivityAggregateLimit;
	}
	...
	public void setCannabisActivityAggregateLimit(int CannabisActivityAggregateLimit) {
		this.CannabisActivityAggregateLimit = CannabisActivityAggregateLimit;
	}
