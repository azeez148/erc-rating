...
public class Mark
{
    protected final com.nest.erc.yaml.formatter.snakeyaml.error.Mark _source;

    protected Mark(com.nest.erc.yaml.formatter.snakeyaml.error.Mark src) {
        _source = src;
    }
    
    public static Mark from(com.nest.erc.yaml.formatter.snakeyaml.error.Mark src) {
