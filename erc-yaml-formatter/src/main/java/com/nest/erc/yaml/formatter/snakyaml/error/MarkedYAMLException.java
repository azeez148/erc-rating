...
public class MarkedYAMLException extends YAMLException
{
    ...
    protected final com.nest.erc.yaml.formatter.snakeyaml.error.MarkedYAMLException _source;

    protected MarkedYAMLException(JsonParser p,
            com.nest.erc.yaml.formatter.snakeyaml.error.MarkedYAMLException src) {
        super(p, src);
        _source = src;
    }
