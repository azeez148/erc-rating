...
import com.nest.erc.yaml.formatter.snakeyaml.parser.ParserImpl;
...
//    @Override public CsvSchema getSchema() 
    ...
    public JsonToken nextToken() throws IOException
    {
        ...
        while (true) {
            ...
            } catch (com.nest.erc.yaml.formatter.snakeyaml.error.YAMLException e) {
                if (e instanceof com.nest.erc.yaml.formatter.snakeyaml.error.MarkedYAMLException) {
                    throw com.nest.erc.yaml.formatter.snakyaml.error.MarkedYAMLException.from
                        (this, (com.nest.erc.yaml.formatter.snakeyaml.error.MarkedYAMLException) e);
                }
