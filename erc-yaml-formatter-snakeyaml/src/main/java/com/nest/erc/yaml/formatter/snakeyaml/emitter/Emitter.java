...
import com.nest.erc.yaml.formatter.snakeyaml.events.CollectionEndEvent;
import com.nest.erc.yaml.formatter.snakeyaml.events.CollectionStartEvent;
...
import com.nest.erc.yaml.formatter.snakeyaml.events.NodeEvent;
...
import com.nest.erc.yaml.formatter.snakeyaml.scanner.Constant;
...
public final class Emitter implements Emitable {
	...
	private ScalarAnalysis analyzeScalar(String scalar) {
		...
		//if(scalar.contains("Accept Certified Acts Terrorism Coverage Provided With Specific Limitations:")) {
			//System.out.println("Accept Certified Acts Terrorism Coverage Provided With Specific Limitations:");
		//}
