...
public class BOPHiredNonOwnedAutoNonOwnedCoverage    extends Policy  {
	...
	private String LiabilityDeliveryCoverage;
	...
	public String  getLiabilityDeliveryCoverage() {
		return this.LiabilityDeliveryCoverage;
	}
	...
	public void setLiabilityDeliveryCoverage(String LiabilityDeliveryCoverage) {
		this.LiabilityDeliveryCoverage = LiabilityDeliveryCoverage;
	}
