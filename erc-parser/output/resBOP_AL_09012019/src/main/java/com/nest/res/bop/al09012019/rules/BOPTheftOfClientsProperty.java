...
import com.nest.res.bop.al09012019.domain.BOPTheftOfClientsPropertyDetail;
...
public class BOPTheftOfClientsProperty  {
	...
	private com.nest.res.bop.al09012019.domain.BOPTheftOfClientsProperty BOPTheftOfClientsProperty;
	private List<BOPTheftOfClientsPropertyDetail> BOPTheftOfClientsPropertyDetailList;
	
	
	
	public  BOPTheftOfClientsProperty (com.nest.res.bop.al09012019.domain.BOPTheftOfClientsProperty BOPTheftOfClientsProperty)  {
