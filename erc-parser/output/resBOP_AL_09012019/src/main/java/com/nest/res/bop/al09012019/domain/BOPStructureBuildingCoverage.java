...
public class BOPStructureBuildingCoverage    extends Policy  {
	...
	public String  getWindstormFlatDedStatCode() {
		return this.WindstormFlatDedStatCode;
	}
	...
	public double  getSpecialIncrement() {
		return this.SpecialIncrement;
	}
	...
	public void setWindstormFlatDedStatCode(String WindstormFlatDedStatCode) {
		this.WindstormFlatDedStatCode = WindstormFlatDedStatCode;
	}
	...
	public void setSpecialIncrement(double SpecialIncrement) {
