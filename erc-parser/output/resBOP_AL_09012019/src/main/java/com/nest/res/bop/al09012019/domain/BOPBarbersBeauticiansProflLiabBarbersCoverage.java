...
public class BOPBarbersBeauticiansProflLiabBarbersCoverage    extends Policy  {
	...
	private int NumPartTimeBarbers;
	...
	private Date RateDt;
	private int NumFullTimeBarbers;
	private int NumBarbers;
	...
	public int  getNumBarbers() {
		return this.NumBarbers;
	}
	...
	public int  getNumPartTimeBarbers() {
		return this.NumPartTimeBarbers;
	}
	...
	public int  getNumFullTimeBarbers() {
		return this.NumFullTimeBarbers;
	}
	public Date  getCreated() {
		return this.Created;
	}
	public String  getBarbersHeader() {
		return this.BarbersHeader;
	}
	...
	public void setNumBarbers(int NumBarbers) {
		this.NumBarbers = NumBarbers;
	}
	public void setNumPartTimeBarbers(int NumPartTimeBarbers) {
		this.NumPartTimeBarbers = NumPartTimeBarbers;
	}
	...
	public void setBarbersHeader(String BarbersHeader) {
		this.BarbersHeader = BarbersHeader;
	}
	...
	public void setNumFullTimeBarbers(int NumFullTimeBarbers) {
		this.NumFullTimeBarbers = NumFullTimeBarbers;
	}
