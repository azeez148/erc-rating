...
public class BOPAddlInsdLessorsLeasedEquipmt    extends Policy  {
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdLessorsLeasedEquipmtDetail) {
			childs.addAll(BOPAddlInsdLessorsLeasedEquipmtDetail);
		}
		return childs;
	}


	public List<BOPAddlInsdLessorsLeasedEquipmtDetail> getBOPAddlInsdLessorsLeasedEquipmtDetail() {
		return this.BOPAddlInsdLessorsLeasedEquipmtDetail;
	}
	...
	public String  getCGLClassCode() {
		return this.CGLClassCode;
	}
	...
	public double  getAddlInsdRate() {
		return this.AddlInsdRate;
	}
	...
	public void setCGLClassCode(String CGLClassCode) {
		this.CGLClassCode = CGLClassCode;
	}
	...
	public void setBOPAddlInsdLessorsLeasedEquipmtDetail(List<BOPAddlInsdLessorsLeasedEquipmtDetail> BOPAddlInsdLessorsLeasedEquipmtDetail) {
	...
	public void setAddlInsdRate(double AddlInsdRate) {
		this.AddlInsdRate = AddlInsdRate;
	}
