...
import com.nest.res.bop.al09012019.domain.BOPAddlInsdDesignatedPersonOrgDetail;
...
public class BOPAddlInsdDesignatedPersonOrg  {
	...
	private com.nest.res.bop.al09012019.domain.BOPAddlInsdDesignatedPersonOrg BOPAddlInsdDesignatedPersonOrg;
	private com.nest.res.bop.al09012019.rules.BOPAddlInsdDesignatedPersonOrgDetail BOPAddlInsdDesignatedPersonOrgDetailRule;
	...
	if(null != BOPAddlInsdDesignatedPersonOrgDetailList){
		for(BOPAddlInsdDesignatedPersonOrgDetail BOPAddlInsdDesignatedPersonOrgDetail:BOPAddlInsdDesignatedPersonOrgDetailList){
			BOPAddlInsdDesignatedPersonOrgDetailRule = new com.nest.res.bop.al09012019.rules.BOPAddlInsdDesignatedPersonOrgDetail(BOPAddlInsdDesignatedPersonOrgDetail);
	...
	public  BOPAddlInsdDesignatedPersonOrg (com.nest.res.bop.al09012019.domain.BOPAddlInsdDesignatedPersonOrg BOPAddlInsdDesignatedPersonOrg)  {
