...
import com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCovDetail;
import com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverage;
import com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverage;
import com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverage;
import com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverage;
import com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage;
...
public class BOPContrctrsInstalltnToolsAndEquipmtCov  {
	...
	private com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverage BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverageRule;
	...
	private com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverage BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverageRule;
	private com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverage BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverageRule;
	...
	private com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverage BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverageRule;
	...
	private com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtCov BOPContrctrsInstalltnToolsAndEquipmtCov;
	private com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverageRule;
...
this.BOPContrctrsInstalltnToolsAndEquipmtCov.setPremium(MathHelper.getDoubleValue(this.BOPContrctrsInstalltnToolsAndEquipmtCov.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPContrctrsInstalltnToolsAndEquipmtCov,"BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage/Premium")))));
	...
	if(null != BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverageList){
		for(BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverage BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverage:BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverageList){
			BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverageRule = new com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverage(BOPContrctrsInstalltnToolsAndEquipmtBlanketToolsCoverage);
	...
	if(null != BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverageList){
		for(BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverage BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverage:BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverageList){
			BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverageRule = new com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverage(BOPContrctrsInstalltnToolsAndEquipmtEmployeeToolsCoverage);
	...
	if(null != BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverageList){
		for(BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverage BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverage:BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverageList){
			BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverageRule = new com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverage(BOPContrctrsInstalltnToolsAndEquipmtInstalltnCoverage);
	...
	if(null != BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverageList){
		for(BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverage BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverage:BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverageList){
			BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverageRule = new com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverage(BOPContrctrsInstalltnToolsAndEquipmtNonOwnedToolsCoverage);
	...
	if(null != BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverageList){
		for(BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage:BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverageList){
			BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverageRule = new com.nest.res.bop.al09012019.rules.BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage(BOPContrctrsInstalltnToolsAndEquipmtScheduledPropCoverage);
	...
	public  BOPContrctrsInstalltnToolsAndEquipmtCov (com.nest.res.bop.al09012019.domain.BOPContrctrsInstalltnToolsAndEquipmtCov BOPContrctrsInstalltnToolsAndEquipmtCov)  {
