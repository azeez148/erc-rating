...
public class BOPRestaurantFoodContaminationCoverage  {
	...
	private com.nest.res.bop.al09012019.domain.BOPRestaurantFoodContaminationCoverage BOPRestaurantFoodContaminationCoverage;
	
	
	
	public  BOPRestaurantFoodContaminationCoverage (com.nest.res.bop.al09012019.domain.BOPRestaurantFoodContaminationCoverage BOPRestaurantFoodContaminationCoverage)  {
