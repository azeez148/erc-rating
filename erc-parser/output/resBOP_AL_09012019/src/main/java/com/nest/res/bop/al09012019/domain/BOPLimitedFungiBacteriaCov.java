...
public class BOPLimitedFungiBacteriaCov    extends Policy  {
	...
	private String SeparateLimitsForEachPremisesOrLocations;
	private List<BOPLimitedFungiBacteriaCovExcessCoverage> BOPLimitedFungiBacteriaCovExcessCoverage;
	...
	private String DescriptionOfSeparatePremisesLocations;
	private int ShortRateIndicator;
	private String PropertyDamageHeader;
	private List<BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage> BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage;
	...
	private int RevisedLimit;
	private Date Modified;
	private String SeparatePremisesLocationsOption;
	private Date RateDt;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPLimitedFungiBacteriaCovExcessCoverage) {
			childs.addAll(BOPLimitedFungiBacteriaCovExcessCoverage);
		}
		if(null != BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage) {
			childs.addAll(BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage);
		}
		return childs;
	}
	...
	public String  getDescriptionOfSeparatePremisesLocations() {
		return this.DescriptionOfSeparatePremisesLocations;
	}
	...
	public List<BOPLimitedFungiBacteriaCovExcessCoverage> getBOPLimitedFungiBacteriaCovExcessCoverage() {
		return this.BOPLimitedFungiBacteriaCovExcessCoverage;
	}
	...
	public String  getPropertyDamageHeader() {
		return this.PropertyDamageHeader;
	}
	...
	public List<BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage> getBOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage() {
		return this.BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage;
	}
	public int  getRevisedLimit() {
		return this.RevisedLimit;
	}
	...
	public String  getSeparateLimitsForEachPremisesOrLocations() {
		return this.SeparateLimitsForEachPremisesOrLocations;
	}
	...
	public String  getSeparatePremisesLocationsOption() {
		return this.SeparatePremisesLocationsOption;
	}
	...
	public void setBOPLimitedFungiBacteriaCovExcessCoverage(List<BOPLimitedFungiBacteriaCovExcessCoverage> BOPLimitedFungiBacteriaCovExcessCoverage) {
	...
	public void setPropertyDamageHeader(String PropertyDamageHeader) {
		this.PropertyDamageHeader = PropertyDamageHeader;
	}
	public void setPolicyTermPremium(double PolicyTermPremium) {
		this.PolicyTermPremium = PolicyTermPremium;
	}
	public void setSeparatePremisesLocationsOption(String SeparatePremisesLocationsOption) {
		this.SeparatePremisesLocationsOption = SeparatePremisesLocationsOption;
	}
	...
	public void setRevisedLimit(int RevisedLimit) {
		this.RevisedLimit = RevisedLimit;
	}
	public void setBOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage(List<BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage> BOPLimitedFungiBacteriaCovBusnIncomeExtraExpenseCoverage) {
	...
	public void setDescriptionOfSeparatePremisesLocations(String DescriptionOfSeparatePremisesLocations) {
		this.DescriptionOfSeparatePremisesLocations = DescriptionOfSeparatePremisesLocations;
	}
	...
	public void setSeparateLimitsForEachPremisesOrLocations(String SeparateLimitsForEachPremisesOrLocations) {
		this.SeparateLimitsForEachPremisesOrLocations = SeparateLimitsForEachPremisesOrLocations;
	}
