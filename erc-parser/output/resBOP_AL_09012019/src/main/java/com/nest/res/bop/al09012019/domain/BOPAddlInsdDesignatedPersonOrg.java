...
public class BOPAddlInsdDesignatedPersonOrg    extends Policy  {
	...
	private List<BOPAddlInsdDesignatedPersonOrgDetail> BOPAddlInsdDesignatedPersonOrgDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdDesignatedPersonOrgDetail) {
			childs.addAll(BOPAddlInsdDesignatedPersonOrgDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdDesignatedPersonOrgDetail> getBOPAddlInsdDesignatedPersonOrgDetail() {
		return this.BOPAddlInsdDesignatedPersonOrgDetail;
	}
	...
	public void setBOPAddlInsdDesignatedPersonOrgDetail(List<BOPAddlInsdDesignatedPersonOrgDetail> BOPAddlInsdDesignatedPersonOrgDetail) {
