...
public class PolicyCommon    extends Policy  {
	private List<com.nest.res.bop.al09012019.domain.BOP> BOP;
	...
	public List<com.nest.res.bop.al09012019.domain.BOP> getBOP() {
		return this.BOP;
	}
	...
	public void setBOP(List<com.nest.res.bop.al09012019.domain.BOP> BOP) {
		this.BOP = BOP;
	}
