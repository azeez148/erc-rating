...
public class BOPFuneralDirectorsProflLiab  {
	...
	private com.nest.res.bop.al09012019.domain.BOPFuneralDirectorsProflLiab BOPFuneralDirectorsProflLiab;
	
	
	
	public  BOPFuneralDirectorsProflLiab (com.nest.res.bop.al09012019.domain.BOPFuneralDirectorsProflLiab BOPFuneralDirectorsProflLiab)  {
