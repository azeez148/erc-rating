...
public class BOPMAChangesSupplementalCoverageForLeadPoisoningEndorsement    extends Policy  {
	private int FeeIndicator;
	private String FormNumber;
	private double PolicyTermPremium;
	private int EachOccurrenceLimit;
	...
	public int  getEachOccurrenceLimit() {
		return this.EachOccurrenceLimit;
	}
	...
	public void setEachOccurrenceLimit(int EachOccurrenceLimit) {
		this.EachOccurrenceLimit = EachOccurrenceLimit;
	}
