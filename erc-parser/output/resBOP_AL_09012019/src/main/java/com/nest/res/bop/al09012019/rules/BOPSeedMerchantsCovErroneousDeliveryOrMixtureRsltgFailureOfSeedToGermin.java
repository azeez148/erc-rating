...
public class BOPSeedMerchantsCovErroneousDeliveryOrMixtureRsltgFailureOfSeedToGermin  {
	...
	private com.nest.res.bop.al09012019.domain.BOPSeedMerchantsCovErroneousDeliveryOrMixtureRsltgFailureOfSeedToGermin BOPSeedMerchantsCovErroneousDeliveryOrMixtureRsltgFailureOfSeedToGermin;
	
	
	
	public  BOPSeedMerchantsCovErroneousDeliveryOrMixtureRsltgFailureOfSeedToGermin (com.nest.res.bop.al09012019.domain.BOPSeedMerchantsCovErroneousDeliveryOrMixtureRsltgFailureOfSeedToGermin BOPSeedMerchantsCovErroneousDeliveryOrMixtureRsltgFailureOfSeedToGermin)  {
