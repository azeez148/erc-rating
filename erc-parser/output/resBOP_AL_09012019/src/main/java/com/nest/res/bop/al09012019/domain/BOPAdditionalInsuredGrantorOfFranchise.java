...
public class BOPAdditionalInsuredGrantorOfFranchise    extends Policy  {
	...
	private String ZipCodeStatCode;
	...
	public String  getZipCodeStatCode() {
		return this.ZipCodeStatCode;
	}
	...
	public void setZipCodeStatCode(String ZipCodeStatCode) {
		this.ZipCodeStatCode = ZipCodeStatCode;
	}
