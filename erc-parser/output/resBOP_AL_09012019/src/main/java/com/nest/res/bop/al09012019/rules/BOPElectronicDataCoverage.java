...
public class BOPElectronicDataCoverage  {
	...
	private com.nest.res.bop.al09012019.domain.BOPElectronicDataCoverage BOPElectronicDataCoverage;
	
	
	
	public  BOPElectronicDataCoverage (com.nest.res.bop.al09012019.domain.BOPElectronicDataCoverage BOPElectronicDataCoverage)  {
