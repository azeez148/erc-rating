...
public class BOPProtectiveSafeguards    extends Policy  {
	...
	private List<BOPProtectiveSafeguardsDetail> BOPProtectiveSafeguardsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPProtectiveSafeguardsDetail) {
			childs.addAll(BOPProtectiveSafeguardsDetail);
		}
		return childs;
	}
	...
	public List<BOPProtectiveSafeguardsDetail> getBOPProtectiveSafeguardsDetail() {
		return this.BOPProtectiveSafeguardsDetail;
	}
	...
	public void setBOPProtectiveSafeguardsDetail(List<BOPProtectiveSafeguardsDetail> BOPProtectiveSafeguardsDetail) {
		this.BOPProtectiveSafeguardsDetail = BOPProtectiveSafeguardsDetail;
	}
