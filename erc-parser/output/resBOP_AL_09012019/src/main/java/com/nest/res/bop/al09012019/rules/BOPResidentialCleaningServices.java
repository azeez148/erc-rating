...
public class BOPResidentialCleaningServices  {
	...
	private com.nest.res.bop.al09012019.domain.BOPResidentialCleaningServices BOPResidentialCleaningServices;
	
	
	
	public  BOPResidentialCleaningServices (com.nest.res.bop.al09012019.domain.BOPResidentialCleaningServices BOPResidentialCleaningServices)  {
