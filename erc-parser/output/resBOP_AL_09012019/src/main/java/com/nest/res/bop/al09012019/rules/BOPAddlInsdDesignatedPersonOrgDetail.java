...
public class BOPAddlInsdDesignatedPersonOrgDetail  {
	...
	private com.nest.res.bop.al09012019.domain.BOPAddlInsdDesignatedPersonOrgDetail BOPAddlInsdDesignatedPersonOrgDetail;
	
	
	
	public  BOPAddlInsdDesignatedPersonOrgDetail (com.nest.res.bop.al09012019.domain.BOPAddlInsdDesignatedPersonOrgDetail BOPAddlInsdDesignatedPersonOrgDetail)  {
