...
public class BOPBusnIncomeOrdinaryPayrollExemption    extends Policy  {
	...
	private List<BOPBusnIncomeOrdinaryPayrollExemptionDetail> BOPBusnIncomeOrdinaryPayrollExemptionDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPBusnIncomeOrdinaryPayrollExemptionDetail) {
			childs.addAll(BOPBusnIncomeOrdinaryPayrollExemptionDetail);
		}
		return childs;
	}
	...
	public List<BOPBusnIncomeOrdinaryPayrollExemptionDetail> getBOPBusnIncomeOrdinaryPayrollExemptionDetail() {
		return this.BOPBusnIncomeOrdinaryPayrollExemptionDetail;
	}
	...
	public void setBOPBusnIncomeOrdinaryPayrollExemptionDetail(List<BOPBusnIncomeOrdinaryPayrollExemptionDetail> BOPBusnIncomeOrdinaryPayrollExemptionDetail) {
		this.BOPBusnIncomeOrdinaryPayrollExemptionDetail = BOPBusnIncomeOrdinaryPayrollExemptionDetail;
	}
