...
public class BOPAddlInsdVendors    extends Policy  {
	...
	private List<BOPAddlInsdVendorsDetail> BOPAddlInsdVendorsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdVendorsDetail) {
			childs.addAll(BOPAddlInsdVendorsDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdVendorsDetail> getBOPAddlInsdVendorsDetail() {
		return this.BOPAddlInsdVendorsDetail;
	}
	...
	public void setBOPAddlInsdVendorsDetail(List<BOPAddlInsdVendorsDetail> BOPAddlInsdVendorsDetail) {
