...
public class BOPVeterinariansProflLiab    extends Policy  {
	...
	public int  getNumVeterinarians() {
		return this.NumVeterinarians;
	}
	...
	public void setNumVeterinarians(int NumVeterinarians) {
		this.NumVeterinarians = NumVeterinarians;
	}
