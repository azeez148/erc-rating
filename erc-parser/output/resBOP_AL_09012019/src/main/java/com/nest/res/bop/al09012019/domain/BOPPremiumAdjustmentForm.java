...
public class BOPPremiumAdjustmentForm    extends Policy  {
	...
	public String  getPremiumEnter() {
		return this.PremiumEnter;
	}
	...
	public void setPremiumEnter(String PremiumEnter) {
		this.PremiumEnter = PremiumEnter;
	}
