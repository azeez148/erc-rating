...
public class BOPStructureInteriorGlassCoverage    extends Policy  {
	...
	private int SqFootAboveFloor2;
	private String CoveredGlass;
	...
	public int  getSqFootAboveFloor2() {
		return this.SqFootAboveFloor2;
	}
	...
	public int  getSqFootNotAboveFloor2() {
		return this.SqFootNotAboveFloor2;
	}
	public int  getCoverageOnPolicyIndicator() {
		return this.CoverageOnPolicyIndicator;
	}
	public double  getAboveSecondFloorFactor() {
		return this.AboveSecondFloorFactor;
	}
	...
	public int  getIrregularGlassValue() {
		return this.IrregularGlassValue;
	}
	public double  getIrregularGlassFactor() {
		return this.IrregularGlassFactor;
	}
	...
	public String  getCoveredGlass() {
		return this.CoveredGlass;
	}
	...
	public void setSqFootAboveFloor2(int SqFootAboveFloor2) {
		this.SqFootAboveFloor2 = SqFootAboveFloor2;
	}
	public void setCreatedBy(String CreatedBy) {
		this.CreatedBy = CreatedBy;
	}
	public void setIrregularGlassFactor(double IrregularGlassFactor) {
		this.IrregularGlassFactor = IrregularGlassFactor;
	}
	public void setAddEffectiveDt(Date AddEffectiveDt) {
		this.AddEffectiveDt = AddEffectiveDt;
	}
	public void setSqFootNotAboveFloor2(int SqFootNotAboveFloor2) {
		this.SqFootNotAboveFloor2 = SqFootNotAboveFloor2;
	}
	...
	public void setIrregularGlassValue(int IrregularGlassValue) {
		this.IrregularGlassValue = IrregularGlassValue;
	}
	...
	public void setCoveredGlass(String CoveredGlass) {
		this.CoveredGlass = CoveredGlass;
	}
	...
	public void setAboveSecondFloorFactor(double AboveSecondFloorFactor) {
		this.AboveSecondFloorFactor = AboveSecondFloorFactor;
	}
