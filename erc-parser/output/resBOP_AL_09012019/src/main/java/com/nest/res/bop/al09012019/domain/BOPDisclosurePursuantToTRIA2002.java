...
public class BOPDisclosurePursuantToTRIA2002    extends Policy  {
	private int FeeIndicator;
	private String FormNumber;
	private double PolicyTermPremium;
	private Date ExpirationDt;
	private Date AddEffectiveDt;
	private double PolicyPremiumPriorToTerrorism;
	private double Premium;
	private Date EffectiveDt;
	private int FederalShareOfTerrorismLossesPctg;
	private String SchedulePart1Header;
	private int YearB;
	private int YearA;
	private String PriorId;
	private int FederalShareOfTerrorismLossesPctg2;
	...
	private String FederalShareOfTerrorismLossesYear;
	...
	private double EvaluatedFirePremium;
	private double TotalTerrorismPremium;
	private Date RateDt;
	private double ProRatedPremium;
	private Date Created;
	private double OverridePremium;
	private String SchedulePart2Header;
	private double MinFirePremium;
	private Date ChangeEffectiveDt;
	private String VersionedId;
	private int ProRateIndicator;
	private String FederalShareOfTerrorismLossesYear2;
	...
	private int FedShareTerrorismLossesA;
	private double ShortRatePenalty;
	private int FedShareTerrorismLossesB;
	...
	public int  getFederalShareOfTerrorismLossesPctg2() {
		return this.FederalShareOfTerrorismLossesPctg2;
	}
	...
	public double  getEvaluatedFirePremium() {
		return this.EvaluatedFirePremium;
	}
	...
	public int  getFedShareTerrorismLossesB() {
		return this.FedShareTerrorismLossesB;
	}
	public String  getSchedulePart2Header() {
		return this.SchedulePart2Header;
	}
	...
	public double  getMinFirePremium() {
		return this.MinFirePremium;
	}
	...
	public double  getTotalTerrorismPremium() {
		return this.TotalTerrorismPremium;
	}
	...
	public double  getPolicyPremiumPriorToTerrorism() {
		return this.PolicyPremiumPriorToTerrorism;
	}
	...
	public int  getFederalShareOfTerrorismLossesPctg() {
		return this.FederalShareOfTerrorismLossesPctg;
	}
	public int  getMinPremium() {
		return this.MinPremium;
	}
	public String  getFederalShareOfTerrorismLossesYear2() {
		return this.FederalShareOfTerrorismLossesYear2;
	}
	...
	public String  getSchedulePart1Header() {
		return this.SchedulePart1Header;
	}
	public String  getFederalShareOfTerrorismLossesYear() {
		return this.FederalShareOfTerrorismLossesYear;
	}
	public int  getPremiumIndicator() {
		return this.PremiumIndicator;
	}
	public int  getFedShareTerrorismLossesA() {
		return this.FedShareTerrorismLossesA;
	}
	...
	public void setEvaluatedFirePremium(double EvaluatedFirePremium) {
		this.EvaluatedFirePremium = EvaluatedFirePremium;
	}
	public void setSchedulePart1Header(String SchedulePart1Header) {
		this.SchedulePart1Header = SchedulePart1Header;
	}
	...
	public void setMinFirePremium(double MinFirePremium) {
		this.MinFirePremium = MinFirePremium;
	}
	public void setFederalShareOfTerrorismLossesYear2(String FederalShareOfTerrorismLossesYear2) {
		this.FederalShareOfTerrorismLossesYear2 = FederalShareOfTerrorismLossesYear2;
	}
	...
	public void setFederalShareOfTerrorismLossesYear(String FederalShareOfTerrorismLossesYear) {
		this.FederalShareOfTerrorismLossesYear = FederalShareOfTerrorismLossesYear;
	}
	...
	public void setFedShareTerrorismLossesB(int FedShareTerrorismLossesB) {
		this.FedShareTerrorismLossesB = FedShareTerrorismLossesB;
	}
	public void setFederalShareOfTerrorismLossesPctg2(int FederalShareOfTerrorismLossesPctg2) {
		this.FederalShareOfTerrorismLossesPctg2 = FederalShareOfTerrorismLossesPctg2;
	}
	...
	public void setPolicyPremiumPriorToTerrorism(double PolicyPremiumPriorToTerrorism) {
		this.PolicyPremiumPriorToTerrorism = PolicyPremiumPriorToTerrorism;
	}
	...
	public void setFederalShareOfTerrorismLossesPctg(int FederalShareOfTerrorismLossesPctg) {
		this.FederalShareOfTerrorismLossesPctg = FederalShareOfTerrorismLossesPctg;
	}
	...
	public void setSchedulePart2Header(String SchedulePart2Header) {
		this.SchedulePart2Header = SchedulePart2Header;
	}
	...
	public void setFedShareTerrorismLossesA(int FedShareTerrorismLossesA) {
		this.FedShareTerrorismLossesA = FedShareTerrorismLossesA;
	}
	public void setTotalTerrorismPremium(double TotalTerrorismPremium) {
		this.TotalTerrorismPremium = TotalTerrorismPremium;
	}
