...
public class BOPStateAddlInsdVendorsDetail    extends Policy  {
	...
	public double  getAddlInsdCharge() {
		return this.AddlInsdCharge;
	}
	...
	public void setAddlInsdCharge(double AddlInsdCharge) {
		this.AddlInsdCharge = AddlInsdCharge;
	}
