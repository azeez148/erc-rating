...
public class BOPMiscBaileeProcessorFloaterCovDetail    extends Policy  {
	...
	private double SpecialPerilsLoadRate;
	...
	public double  getSpecialPerilsLoadRate() {
		return this.SpecialPerilsLoadRate;
	}
	...
	public void setSpecialPerilsLoadRate(double SpecialPerilsLoadRate) {
		this.SpecialPerilsLoadRate = SpecialPerilsLoadRate;
	}
