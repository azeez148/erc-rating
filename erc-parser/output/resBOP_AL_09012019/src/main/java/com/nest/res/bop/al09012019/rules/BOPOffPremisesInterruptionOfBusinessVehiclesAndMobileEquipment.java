...
import com.nest.res.bop.al09012019.domain.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetail;
...
public class BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipment  {
	...
	private com.nest.res.bop.al09012019.rules.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetail BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetailRule;
	private com.nest.res.bop.al09012019.domain.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipment BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipment;
	...
	if(null != BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetailList){
		for(BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetail BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetail:BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetailList){
			BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetailRule = new com.nest.res.bop.al09012019.rules.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetail(BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipmentDetail);
	...
	public  BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipment (com.nest.res.bop.al09012019.domain.BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipment BOPOffPremisesInterruptionOfBusinessVehiclesAndMobileEquipment)  {
