...
public class BOPLocationFireDeptServiceCoverage    extends Policy  {
	private String ASLOBStatCode;
	private int FeeIndicator;
	private int VolunteerInclddLimit;
	private double AnnualPremium;
	private String FormNumber;
	private int InclddLimit;
	private double VolunteerCharge;
	...
	public int  getVolunteerInclddLimit() {
		return this.VolunteerInclddLimit;
	}
	...
	public double  getVolunteerCharge() {
		return this.VolunteerCharge;
	}
	...
	public void setVolunteerInclddLimit(int VolunteerInclddLimit) {
		this.VolunteerInclddLimit = VolunteerInclddLimit;
	}
	public void setVolunteerCharge(double VolunteerCharge) {
		this.VolunteerCharge = VolunteerCharge;
	}
