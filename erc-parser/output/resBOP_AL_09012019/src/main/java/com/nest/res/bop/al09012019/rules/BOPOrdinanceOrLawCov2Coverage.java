...
public class BOPOrdinanceOrLawCov2Coverage  {
	...
	private com.nest.res.bop.al09012019.domain.BOPOrdinanceOrLawCov2Coverage BOPOrdinanceOrLawCov2Coverage;
	
	
	
	public  BOPOrdinanceOrLawCov2Coverage (com.nest.res.bop.al09012019.domain.BOPOrdinanceOrLawCov2Coverage BOPOrdinanceOrLawCov2Coverage)  {
	...
	public void Premium ()  {
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPOrdinanceOrLawCov2Coverage,"../Coverage"))).equals(MathHelper.getStringValue("Coverages 1, 2 and 3")) || (MathHelper.getStringValue(XpathNode.selectNodeValue(this.BOPOrdinanceOrLawCov2Coverage,"../Coverage"))).equals(MathHelper.getStringValue("Coverages 1 and 2"))){
			this.BOPOrdinanceOrLawCov2Coverage.setPremium(MathHelper.getDoubleValue(MathHelper.roundUpDoller(MathHelper.roundUpDoller((MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOrdinanceOrLawCov2Coverage,"../../FinalBuildingRate"))) * (MathHelper.getDoubleValue(this.BOPOrdinanceOrLawCov2Coverage.getDsLimit()) / MathHelper.getDoubleValue(100.0))) * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPOrdinanceOrLawCov2Coverage,"../../../../IRPMFactor"))))));
		}
		else{
