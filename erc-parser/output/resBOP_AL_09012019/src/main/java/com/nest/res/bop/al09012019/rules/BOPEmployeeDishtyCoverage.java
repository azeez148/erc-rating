...
public class BOPEmployeeDishtyCoverage  {
	...
	private com.nest.res.bop.al09012019.domain.BOPEmployeeDishtyCoverage BOPEmployeeDishtyCoverage;
	...
	public void NumLocations ()  {
	  this.BOPEmployeeDishtyCoverage.setNumLocations(MathHelper.getIntegerValue(0.0));

		for( Policy policy : XpathNode.selectNodes(BOPEmployeeDishtyCoverage,"../BOPLocation") ){

		if((MathHelper.getStringValue(XpathNode.selectNodeValue(policy,"EmployeeDishtyApply"))).equals(MathHelper.getStringValue("Yes"))){
			this.BOPEmployeeDishtyCoverage.setNumLocations(MathHelper.getIntegerValue(MathHelper.getIntegerValue(this.BOPEmployeeDishtyCoverage.getNumLocations() + MathHelper.getIntegerValue(1.0))));
		}		}
	...
	public void NumEmployees ()  {
	  this.BOPEmployeeDishtyCoverage.setDsNumEmployees(MathHelper.getIntegerValue(0.0));

		for( Policy policy : XpathNode.selectNodes(BOPEmployeeDishtyCoverage,"../BOPLocation") ){

		if((MathHelper.getStringValue(XpathNode.selectNodeValue(policy,"EmployeeDishtyApply"))).equals(MathHelper.getStringValue("Yes"))){
			this.BOPEmployeeDishtyCoverage.setDsNumEmployees(MathHelper.getIntegerValue(MathHelper.getIntegerValue(this.BOPEmployeeDishtyCoverage.getDsNumEmployees() + (MathHelper.getIntegerValue(XpathNode.selectNodeValue(policy,"dsNumEmployees"))))));
		}		}
	...
	public  BOPEmployeeDishtyCoverage (com.nest.res.bop.al09012019.domain.BOPEmployeeDishtyCoverage BOPEmployeeDishtyCoverage)  {
	...
	public void noChargeLocCount ()  {
	  this.BOPEmployeeDishtyCoverage.setNoChargeLocCount(MathHelper.getIntegerValue(0.0));
		...
		if((MathHelper.getStringValue(XpathNode.selectNodeValue(policy,"EmployeeDishtyNoChargeLocation"))).equals(MathHelper.getStringValue("Yes"))){
			this.BOPEmployeeDishtyCoverage.setNoChargeLocCount(MathHelper.getIntegerValue(MathHelper.getIntegerValue(this.BOPEmployeeDishtyCoverage.getNoChargeLocCount() + MathHelper.getIntegerValue(1.0))));
		}		}
