...
public class BOPElectronicDataCoverage    extends Policy  {
	...
	private int ElectronicDataRatingLimit;
	...
	public int  getElectronicDataRatingLimit() {
		return this.ElectronicDataRatingLimit;
	}
	...
	public void setElectronicDataRatingLimit(int ElectronicDataRatingLimit) {
		this.ElectronicDataRatingLimit = ElectronicDataRatingLimit;
	}
