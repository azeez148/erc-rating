...
import com.nest.res.bop.al09012019.domain.BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail;
...
public class BOPY2KComputerRelatedProblemsExclSpecifiedCov  {
	...
	private com.nest.res.bop.al09012019.domain.BOPY2KComputerRelatedProblemsExclSpecifiedCov BOPY2KComputerRelatedProblemsExclSpecifiedCov;
	private List<BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail> BOPY2KComputerRelatedProblemsExclSpecifiedCovDetailList;
	private com.nest.res.bop.al09012019.rules.BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail BOPY2KComputerRelatedProblemsExclSpecifiedCovDetailRule;
	...
	public  BOPY2KComputerRelatedProblemsExclSpecifiedCov (com.nest.res.bop.al09012019.domain.BOPY2KComputerRelatedProblemsExclSpecifiedCov BOPY2KComputerRelatedProblemsExclSpecifiedCov)  {
...
this.BOPY2KComputerRelatedProblemsExclSpecifiedCovDetailList = BOPY2KComputerRelatedProblemsExclSpecifiedCov.getBOPY2KComputerRelatedProblemsExclSpecifiedCovDetail();
	...
	if(null != BOPY2KComputerRelatedProblemsExclSpecifiedCovDetailList){
		for(BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail:BOPY2KComputerRelatedProblemsExclSpecifiedCovDetailList){
			BOPY2KComputerRelatedProblemsExclSpecifiedCovDetailRule = new com.nest.res.bop.al09012019.rules.BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail(BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail);
