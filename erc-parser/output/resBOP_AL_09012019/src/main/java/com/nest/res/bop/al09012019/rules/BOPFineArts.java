...
import com.nest.res.bop.al09012019.domain.BOPFineArtsApartmentCoverage;
import com.nest.res.bop.al09012019.domain.BOPFineArtsRestaurantCoverage;
...
public class BOPFineArts  {
	...
	private com.nest.res.bop.al09012019.rules.BOPFineArtsApartmentCoverage BOPFineArtsApartmentCoverageRule;
	private com.nest.res.bop.al09012019.rules.BOPFineArtsRestaurantCoverage BOPFineArtsRestaurantCoverageRule;
	private com.nest.res.bop.al09012019.domain.BOPFineArts BOPFineArts;
...
this.BOPFineArts.setPremium(MathHelper.getDoubleValue(this.BOPFineArts.getPremium() + (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPFineArts,"BOPFineArtsRestaurantCoverage/Premium")))));
	...
	public  BOPFineArts (com.nest.res.bop.al09012019.domain.BOPFineArts BOPFineArts)  {
...
this.BOPFineArtsRestaurantCoverageList = BOPFineArts.getBOPFineArtsRestaurantCoverage();
	...
	if(null != BOPFineArtsApartmentCoverageList){
		for(BOPFineArtsApartmentCoverage BOPFineArtsApartmentCoverage:BOPFineArtsApartmentCoverageList){
			BOPFineArtsApartmentCoverageRule = new com.nest.res.bop.al09012019.rules.BOPFineArtsApartmentCoverage(BOPFineArtsApartmentCoverage);
	...
	if(null != BOPFineArtsRestaurantCoverageList){
		for(BOPFineArtsRestaurantCoverage BOPFineArtsRestaurantCoverage:BOPFineArtsRestaurantCoverageList){
			BOPFineArtsRestaurantCoverageRule = new com.nest.res.bop.al09012019.rules.BOPFineArtsRestaurantCoverage(BOPFineArtsRestaurantCoverage);
