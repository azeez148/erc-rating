...
public class BOPSpecialFormComputerCov    extends Policy  {
	...
	private double SpclPremiumIncrement;
	...
	private int PreviousEquipmentLimit;
	...
	public int  getPreviousEquipmentLimit() {
		return this.PreviousEquipmentLimit;
	}
	...
	public double  getSpclPremiumIncrement() {
		return this.SpclPremiumIncrement;
	}
	...
	public void setPreviousEquipmentLimit(int PreviousEquipmentLimit) {
		this.PreviousEquipmentLimit = PreviousEquipmentLimit;
	}
	...
	public void setEquipmentLimit(int EquipmentLimit) {
	...
	public void setSpclPremiumIncrement(double SpclPremiumIncrement) {
		this.SpclPremiumIncrement = SpclPremiumIncrement;
	}
