...
public class BOPExclExtrInsulationAndFinishingSys  {
	...
	private com.nest.res.bop.al09012019.domain.BOPExclExtrInsulationAndFinishingSys BOPExclExtrInsulationAndFinishingSys;
	
	
	
	public  BOPExclExtrInsulationAndFinishingSys (com.nest.res.bop.al09012019.domain.BOPExclExtrInsulationAndFinishingSys BOPExclExtrInsulationAndFinishingSys)  {
