...
public class BOPLocationAutomaticIncreaseCoverage    extends Policy  {
	...
	private double BoeckhValuationFactor;
	...
	private double TotEQBldgPremium;
	private Date Effective;
	private int EarnedInFullIndicator;
	private double BoeckhPercent;
	private double BoeckhPct;
	private double TotSprinklerLeakageEQBldgPremium;
	...
	public double  getBoeckhValuationFactor() {
		return this.BoeckhValuationFactor;
	}
	public int  getAnnualPct() {
		return this.AnnualPct;
	}
	public double  getTotEQBldgPremium() {
		return this.TotEQBldgPremium;
	}
	...
	public double  getBoeckhPercent() {
		return this.BoeckhPercent;
	}
	public String  getId() {
		return this.Id;
	}
	...
	public double  getTotSprinklerLeakageEQBldgPremium() {
		return this.TotSprinklerLeakageEQBldgPremium;
	}
	public int  getCoverageOnPolicyIndicator() {
		return this.CoverageOnPolicyIndicator;
	}
	public double  getAnnualFactor() {
		return this.AnnualFactor;
	}
	...
	public double  getBoeckhPct() {
		return this.BoeckhPct;
	}
	...
	public void setTotSprinklerLeakageEQBldgPremium(double TotSprinklerLeakageEQBldgPremium) {
		this.TotSprinklerLeakageEQBldgPremium = TotSprinklerLeakageEQBldgPremium;
	}
	...
	public void setTotEQBldgPremium(double TotEQBldgPremium) {
		this.TotEQBldgPremium = TotEQBldgPremium;
	}
	...
	public void setBoeckhPercent(double BoeckhPercent) {
		this.BoeckhPercent = BoeckhPercent;
	}
	...
	public void setAnnualPct(int AnnualPct) {
		this.AnnualPct = AnnualPct;
	}
	...
	public void setBoeckhValuationFactor(double BoeckhValuationFactor) {
		this.BoeckhValuationFactor = BoeckhValuationFactor;
	}
	...
	public void setBoeckhPct(double BoeckhPct) {
		this.BoeckhPct = BoeckhPct;
	}
