...
public class BOPSelfStorageFacilities  {
	...
	private com.nest.res.bop.al09012019.domain.BOPSelfStorageFacilities BOPSelfStorageFacilities;
	
	
	
	public  BOPSelfStorageFacilities (com.nest.res.bop.al09012019.domain.BOPSelfStorageFacilities BOPSelfStorageFacilities)  {
