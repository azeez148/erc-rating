...
public class BOPOwnersCargoCovDetail    extends Policy  {
	...
	private String CommodityRating;
	...
	public int  getNumPowerUnits() {
		return this.NumPowerUnits;
	}
	...
	public void setNumPowerUnits(int NumPowerUnits) {
		this.NumPowerUnits = NumPowerUnits;
	}
