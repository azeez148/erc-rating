...
public class BOPMotels    extends Policy  {
	...
	private int PerGuestInclddLimit;
	private double Premium;
	private Date RateDt;
	private Date EffectiveDt;
	private int GuestsPropLimit;
	...
	public int  getGuestsPropLimit() {
		return this.GuestsPropLimit;
	}
	...
	public int  getLockReplacementLimit() {
		return this.LockReplacementLimit;
	}
	...
	public int  getPerGuestLimit() {
		return this.PerGuestLimit;
	}
	...
	public int  getPerGuestInclddLimit() {
		return this.PerGuestInclddLimit;
	}
	...
	public int  getGuestsPropInclddLimit() {
		return this.GuestsPropInclddLimit;
	}
	...
	public void setPerGuestInclddLimit(int PerGuestInclddLimit) {
		this.PerGuestInclddLimit = PerGuestInclddLimit;
	}
	...
	public void setGuestsPropLimit(int GuestsPropLimit) {
		this.GuestsPropLimit = GuestsPropLimit;
	}
	...
	public void setGuestsPropInclddLimit(int GuestsPropInclddLimit) {
		this.GuestsPropInclddLimit = GuestsPropInclddLimit;
	}
	...
	public void setPerGuestLimit(int PerGuestLimit) {
		this.PerGuestLimit = PerGuestLimit;
	}
	public void setLockReplacementLimit(int LockReplacementLimit) {
		this.LockReplacementLimit = LockReplacementLimit;
	}
