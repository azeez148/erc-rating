...
public class BOPSelfStorageFacilities    extends Policy  {
	private String ASLOBStatCode;
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private double LiabilityAndMedicalExpensesBusinessPersonalPropertyCoveragePremium;
	...
	private double LiabilityAndMedicalExpensesBuildingCoveragePremium;
	...
	private int SalesDisposalLiabLimit;
	...
	private int CustomerGoodsInclddLimit;
	...
	private int CustomerGoodsLimit;
	...
	public int  getSalesDisposalLiabLimit() {
		return this.SalesDisposalLiabLimit;
	}
	...
	public double  getLiabilityAndMedicalExpensesBuildingCoveragePremium() {
		return this.LiabilityAndMedicalExpensesBuildingCoveragePremium;
	}
	public double  getTotalProRatedChangePremium() {
		return this.TotalProRatedChangePremium;
	}
	public int  getCustomerGoodsLimit() {
		return this.CustomerGoodsLimit;
	}
	...
	public int  getCustomerGoodsInclddLimit() {
		return this.CustomerGoodsInclddLimit;
	}
	public double  getLiabilityAndMedicalExpensesBusinessPersonalPropertyCoveragePremium() {
		return this.LiabilityAndMedicalExpensesBusinessPersonalPropertyCoveragePremium;
	}
	...
	public void setCustomerGoodsLimit(int CustomerGoodsLimit) {
		this.CustomerGoodsLimit = CustomerGoodsLimit;
	}
	...
	public void setSalesDisposalLiabLimit(int SalesDisposalLiabLimit) {
		this.SalesDisposalLiabLimit = SalesDisposalLiabLimit;
	}
	...
	public void setLiabilityAndMedicalExpensesBusinessPersonalPropertyCoveragePremium(double LiabilityAndMedicalExpensesBusinessPersonalPropertyCoveragePremium) {
		this.LiabilityAndMedicalExpensesBusinessPersonalPropertyCoveragePremium = LiabilityAndMedicalExpensesBusinessPersonalPropertyCoveragePremium;
	}
	...
	public void setLiabilityAndMedicalExpensesBuildingCoveragePremium(double LiabilityAndMedicalExpensesBuildingCoveragePremium) {
		this.LiabilityAndMedicalExpensesBuildingCoveragePremium = LiabilityAndMedicalExpensesBuildingCoveragePremium;
	}
	...
	public void setCustomerGoodsInclddLimit(int CustomerGoodsInclddLimit) {
		this.CustomerGoodsInclddLimit = CustomerGoodsInclddLimit;
	}
