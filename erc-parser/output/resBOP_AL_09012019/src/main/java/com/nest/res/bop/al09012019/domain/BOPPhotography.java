...
public class BOPPhotography    extends Policy  {
	private int FeeIndicator;
	private String FormNumber;
	private double PolicyTermPremium;
	private Date ExpirationDt;
	private Date AddEffectiveDt;
	private double PhotographyWorldwideCoverageCharge;
	private double Premium;
	private Date EffectiveDt;
	private String PriorId;
	private String ScheduledItems;
	...
	private double PhotographyScheduledPhotographicEquipmentCharge;
	private List<BOPPhotographyDetail> BOPPhotographyDetail;
	...
	private int TotalLimitOfInsurance;
	private double PhotographyWorldwideCoverageFactor;
	private Date ChangeEffectiveDt;
	private String VersionedId;
	private int ProRateIndicator;
	private int totalLimit_1;
	...
	private double PhotographyCharge;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPPhotographyDetail) {
			childs.addAll(BOPPhotographyDetail);
		}
		return childs;
	}
	...
	public List<BOPPhotographyDetail> getBOPPhotographyDetail() {
		return this.BOPPhotographyDetail;
	}
	public String  getVersionedId() {
		return this.VersionedId;
	}
	public double  getPhotographyWorldwideCoverageCharge() {
		return this.PhotographyWorldwideCoverageCharge;
	}
	public double  getPhotographyScheduledPhotographicEquipmentCharge() {
		return this.PhotographyScheduledPhotographicEquipmentCharge;
	}
	...
	public double  getPhotographyWorldwideCoverageFactor() {
		return this.PhotographyWorldwideCoverageFactor;
	}
	...
	public int  getTotalLimitOfInsurance() {
		return this.TotalLimitOfInsurance;
	}
	...
	public double  getPhotographyCharge() {
		return this.PhotographyCharge;
	}
	...
	public int  getTotalLimit_1() {
		return this.totalLimit_1;
	}
	...
	public void setPhotographyWorldwideCoverageFactor(double PhotographyWorldwideCoverageFactor) {
		this.PhotographyWorldwideCoverageFactor = PhotographyWorldwideCoverageFactor;
	}
	...
	public void setTotalLimit_1(int totalLimit_1) {
		this.totalLimit_1 = totalLimit_1;
	}
	...
	public void setTotalLimitOfInsurance(int TotalLimitOfInsurance) {
		this.TotalLimitOfInsurance = TotalLimitOfInsurance;
	}
	public void setPolicyTermPremium(double PolicyTermPremium) {
		this.PolicyTermPremium = PolicyTermPremium;
	}
	public void setPhotographyWorldwideCoverageCharge(double PhotographyWorldwideCoverageCharge) {
		this.PhotographyWorldwideCoverageCharge = PhotographyWorldwideCoverageCharge;
	}
	...
	public void setPhotographyScheduledPhotographicEquipmentCharge(double PhotographyScheduledPhotographicEquipmentCharge) {
		this.PhotographyScheduledPhotographicEquipmentCharge = PhotographyScheduledPhotographicEquipmentCharge;
	}
	...
	public void setScheduledItems(String ScheduledItems) {
	...
	public void setBOPPhotographyDetail(List<BOPPhotographyDetail> BOPPhotographyDetail) {
		this.BOPPhotographyDetail = BOPPhotographyDetail;
	}
	...
	public void setPhotographyCharge(double PhotographyCharge) {
		this.PhotographyCharge = PhotographyCharge;
	}
