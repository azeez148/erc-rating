...
public class BOPIDFraudExpenseCov  {
	...
	private com.nest.res.bop.al09012019.domain.BOPIDFraudExpenseCov BOPIDFraudExpenseCov;
	...
	public void setTotalPremiumForCoverage ()  {
		...
		if(this.BOPIDFraudExpenseCov.getAggregateLimit() > MathHelper.getIntegerValue(25000.0)){
			this.BOPIDFraudExpenseCov.setPremium(MathHelper.getDoubleValue(MathHelper.getDoubleValue(MathHelper.roundUpDoller(this.BOPIDFraudExpenseCov.getRate() * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPIDFraudExpenseCov,"../LCM")))) + MathHelper.roundUpDoller((MathHelper.getDoubleValue(this.BOPIDFraudExpenseCov.getAggregateLimit()) - MathHelper.getDoubleValue(25000.0)) / MathHelper.getDoubleValue(100.0) * this.BOPIDFraudExpenseCov.getOptnlHigherLmtsRate() * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPIDFraudExpenseCov,"../IRPMFactor")))))));
		}
		else{
			this.BOPIDFraudExpenseCov.setPremium(MathHelper.getDoubleValue(MathHelper.roundUpDoller(this.BOPIDFraudExpenseCov.getRate() * (MathHelper.getDoubleValue(XpathNode.selectNodeValue(this.BOPIDFraudExpenseCov,"../LCM"))))));
		}
	...
	public  BOPIDFraudExpenseCov (com.nest.res.bop.al09012019.domain.BOPIDFraudExpenseCov BOPIDFraudExpenseCov)  {
