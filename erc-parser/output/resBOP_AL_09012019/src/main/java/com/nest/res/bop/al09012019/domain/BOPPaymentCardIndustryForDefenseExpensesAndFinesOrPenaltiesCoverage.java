...
public class BOPPaymentCardIndustryForDefenseExpensesAndFinesOrPenaltiesCoverage    extends Policy  {
	...
	private String TypeOfLossStatCode;
	private String Id;
	...
	public String  getTypeOfLossStatCode() {
		return this.TypeOfLossStatCode;
	}
	...
	public void setTypeOfLossStatCode(String TypeOfLossStatCode) {
		this.TypeOfLossStatCode = TypeOfLossStatCode;
	}
