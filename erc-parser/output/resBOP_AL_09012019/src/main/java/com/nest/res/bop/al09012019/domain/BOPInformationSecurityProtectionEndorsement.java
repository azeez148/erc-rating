...
public class BOPInformationSecurityProtectionEndorsement    extends Policy  {
	...
	private List<BOPInformationSecurityProtectionEndorsementDetail> BOPInformationSecurityProtectionEndorsementDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPInformationSecurityProtectionEndorsementDetail) {
			childs.addAll(BOPInformationSecurityProtectionEndorsementDetail);
		}
		return childs;
	}
	...
	public List<BOPInformationSecurityProtectionEndorsementDetail> getBOPInformationSecurityProtectionEndorsementDetail() {
		return this.BOPInformationSecurityProtectionEndorsementDetail;
	}
	...
	public void setBOPInformationSecurityProtectionEndorsementDetail(List<BOPInformationSecurityProtectionEndorsementDetail> BOPInformationSecurityProtectionEndorsementDetail) {
