...
public class BOPLimitedPolltnLiabExt    extends Policy  {
	...
	private int CostsAggregateLimit;
	...
	public int  getCostsAggregateLimit() {
		return this.CostsAggregateLimit;
	}
	...
	public void setCostsAggregateLimit(int CostsAggregateLimit) {
		this.CostsAggregateLimit = CostsAggregateLimit;
	}
}