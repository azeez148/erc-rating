...
public class BOPExhibitionFloaterCovDetail    extends Policy  {
	...
	private double EachAddlDayRate;
	...
	public double  getEachAddlDayRate() {
		return this.EachAddlDayRate;
	}
	...
	public double  getBasicLoadRate() {
		return this.BasicLoadRate;
	}
	...
	public void setBasicLoadRate(double BasicLoadRate) {
		this.BasicLoadRate = BasicLoadRate;
	}
	...
	public void setEachAddlDayRate(double EachAddlDayRate) {
		this.EachAddlDayRate = EachAddlDayRate;
	}
