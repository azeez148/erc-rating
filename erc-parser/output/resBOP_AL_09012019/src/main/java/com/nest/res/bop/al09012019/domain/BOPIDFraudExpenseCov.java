...
public class BOPIDFraudExpenseCov    extends Policy  {
	...
	private double OptnlHigherLmtsRate;
	...
	public double  getOptnlHigherLmtsRate() {
		return this.OptnlHigherLmtsRate;
	}
	...
	public void setOptnlHigherLmtsRate(double OptnlHigherLmtsRate) {
		this.OptnlHigherLmtsRate = OptnlHigherLmtsRate;
	}
