...
public class BOPCoverageInjuryLeasedWorkers  {
	...
	private com.nest.res.bop.al09012019.domain.BOPCoverageInjuryLeasedWorkers BOPCoverageInjuryLeasedWorkers;
	
	
	
	public  BOPCoverageInjuryLeasedWorkers (com.nest.res.bop.al09012019.domain.BOPCoverageInjuryLeasedWorkers BOPCoverageInjuryLeasedWorkers)  {
