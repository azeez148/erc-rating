...
public class BOPAddlInsdGrantorOfFranchiseEndorsement    extends Policy  {
	...
	private String NameOfPersonsOrOrgs;
	...
	public String  getNameOfPersonsOrOrgs() {
		return this.NameOfPersonsOrOrgs;
	}
	...
	public void setNameOfPersonsOrOrgs(String NameOfPersonsOrOrgs) {
		this.NameOfPersonsOrOrgs = NameOfPersonsOrOrgs;
	}
