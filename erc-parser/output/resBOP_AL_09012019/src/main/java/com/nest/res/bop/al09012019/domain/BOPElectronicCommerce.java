...
public class BOPElectronicCommerce    extends Policy  {
	...
	private String AntiVirusWaiver;
	...
	public String  getLocBusn() {
		return this.LocBusn;
	}
	public String  getParentId() {
		return this.ParentId;
	}
	public String  getDescBusn() {
		return this.DescBusn;
	}
	...
	public String  getAntiVirusWaiver() {
		return this.AntiVirusWaiver;
	}
	...
	public void setLocBusn(String LocBusn) {
		this.LocBusn = LocBusn;
	}
	...
	public void setDescBusn(String DescBusn) {
		this.DescBusn = DescBusn;
	}
	...
	public void setAntiVirusWaiver(String AntiVirusWaiver) {
		this.AntiVirusWaiver = AntiVirusWaiver;
	}
