...
public class BOPAutomaticIncreaseCoverage    extends Policy  {
	...
	private double TotEQSubLimitBldgPremium;
	...
	public double  getTotEQSubLimitBldgPremium() {
		return this.TotEQSubLimitBldgPremium;
	}
	...
	public void setTotEQSubLimitBldgPremium(double TotEQSubLimitBldgPremium) {
		this.TotEQSubLimitBldgPremium = TotEQSubLimitBldgPremium;
	}
