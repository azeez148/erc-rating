...
public class BOPStructureMechanicalBreakdownCoverage    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private double PolicyTermPremium;
	private Date Modified;
	private String CoveredExposures;
	...
	private double AirConditioningAddlCharge;
	...
	private double AirConditioningCharge;
	...
	public String  getCoveredExposures() {
		return this.CoveredExposures;
	}
	...
	public double  getAirConditioningAddlCharge() {
		return this.AirConditioningAddlCharge;
	}
	...
	public double  getAirConditioningCharge() {
		return this.AirConditioningCharge;
	}
	...
	public void setCoveredExposures(String CoveredExposures) {
		this.CoveredExposures = CoveredExposures;
	}
	...
	public void setAirConditioningAddlCharge(double AirConditioningAddlCharge) {
		this.AirConditioningAddlCharge = AirConditioningAddlCharge;
	}
	...
	public void setAirConditioningCharge(double AirConditioningCharge) {
		this.AirConditioningCharge = AirConditioningCharge;
	}
}