...
public class BOPPaymentCardIndustryForDefenseExpensesAndFinesOrPenaltiesCoverage  {
	...
	private com.nest.res.bop.al09012019.domain.BOPPaymentCardIndustryForDefenseExpensesAndFinesOrPenaltiesCoverage BOPPaymentCardIndustryForDefenseExpensesAndFinesOrPenaltiesCoverage;
	
	
	
	public  BOPPaymentCardIndustryForDefenseExpensesAndFinesOrPenaltiesCoverage (com.nest.res.bop.al09012019.domain.BOPPaymentCardIndustryForDefenseExpensesAndFinesOrPenaltiesCoverage BOPPaymentCardIndustryForDefenseExpensesAndFinesOrPenaltiesCoverage)  {
