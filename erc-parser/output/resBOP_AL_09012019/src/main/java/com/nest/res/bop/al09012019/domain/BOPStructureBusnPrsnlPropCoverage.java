...
public class BOPStructureBusnPrsnlPropCoverage    extends Policy  {
	...
	private double BurglaryRobberyPremiumIncrement;
	...
	private int BurglaryRobberyLimit;
	...
	public double  getBurglaryRobberyPremiumIncrement() {
		return this.BurglaryRobberyPremiumIncrement;
	}
	...
	public int  getBurglaryRobberyLimit() {
		return this.BurglaryRobberyLimit;
	}
	...
	public void setBurglaryRobberyLimit(int BurglaryRobberyLimit) {
		this.BurglaryRobberyLimit = BurglaryRobberyLimit;
	}
	...
	public void setBurglaryRobberyPremiumIncrement(double BurglaryRobberyPremiumIncrement) {
		this.BurglaryRobberyPremiumIncrement = BurglaryRobberyPremiumIncrement;
	}
