...
public class BOPDiscretionaryPayrollExpense    extends Policy  {
	...
	private Date RateDt;
	private List<BOPDiscretionaryPayrollExpenseDetail> BOPDiscretionaryPayrollExpenseDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPDiscretionaryPayrollExpenseDetail) {
			childs.addAll(BOPDiscretionaryPayrollExpenseDetail);
		}
		return childs;
	}
	...
	public List<BOPDiscretionaryPayrollExpenseDetail> getBOPDiscretionaryPayrollExpenseDetail() {
		return this.BOPDiscretionaryPayrollExpenseDetail;
	}
	...
	public void setBOPDiscretionaryPayrollExpenseDetail(List<BOPDiscretionaryPayrollExpenseDetail> BOPDiscretionaryPayrollExpenseDetail) {
		this.BOPDiscretionaryPayrollExpenseDetail = BOPDiscretionaryPayrollExpenseDetail;
	}
