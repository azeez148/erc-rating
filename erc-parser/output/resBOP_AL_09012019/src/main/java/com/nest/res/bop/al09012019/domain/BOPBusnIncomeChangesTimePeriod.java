...
public class BOPBusnIncomeChangesTimePeriod    extends Policy  {
	...
	private List<BOPBusnIncomeChangesTimePeriodBldgCoverage> BOPBusnIncomeChangesTimePeriodBldgCoverage;
	private double ShortRatePenalty;
	private double ChangePremium;
	private Date Effective;
	private int EarnedInFullIndicator;
	private List<BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage> BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPBusnIncomeChangesTimePeriodBldgCoverage) {
			childs.addAll(BOPBusnIncomeChangesTimePeriodBldgCoverage);
		}
		if(null != BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage) {
			childs.addAll(BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage);
		}
		return childs;
	}
	...
	public List<BOPBusnIncomeChangesTimePeriodBldgCoverage> getBOPBusnIncomeChangesTimePeriodBldgCoverage() {
		return this.BOPBusnIncomeChangesTimePeriodBldgCoverage;
	}
	...
	public List<BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage> getBOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage() {
		return this.BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage;
	}
	...
	public void setBOPBusnIncomeChangesTimePeriodBldgCoverage(List<BOPBusnIncomeChangesTimePeriodBldgCoverage> BOPBusnIncomeChangesTimePeriodBldgCoverage) {
	...
	public void setBOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage(List<BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage> BOPBusnIncomeChangesTimePeriodBusnPrsnlPropCoverage) {
