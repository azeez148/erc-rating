...
public class BOPAddlInsdManagersLessorsPremises    extends Policy  {
	...
	private List<BOPAddlInsdManagersLessorsPremisesDetail> BOPAddlInsdManagersLessorsPremisesDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdManagersLessorsPremisesDetail) {
			childs.addAll(BOPAddlInsdManagersLessorsPremisesDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdManagersLessorsPremisesDetail> getBOPAddlInsdManagersLessorsPremisesDetail() {
		return this.BOPAddlInsdManagersLessorsPremisesDetail;
	}
	...
	public void setBOPAddlInsdManagersLessorsPremisesDetail(List<BOPAddlInsdManagersLessorsPremisesDetail> BOPAddlInsdManagersLessorsPremisesDetail) {
