...
public class BOPExtddReportingPeriodEmpBenefitsLiabCov    extends Policy  {
	...
	private String PolicyPeriodHeader;
	...
	private Date PolicyPeriodToDate;
	...
	public Date  getPolicyPeriodToDate() {
		return this.PolicyPeriodToDate;
	}
	...
	public int  getEachEmployeeLimit() {
	...
	public String  getPolicyPeriodHeader() {
		return this.PolicyPeriodHeader;
	}
	...
	public Date  getPolicyPeriodFromDate() {
		return this.PolicyPeriodFromDate;
	}
	...
	public void setPolicyPeriodFromDate(Date PolicyPeriodFromDate) {
		this.PolicyPeriodFromDate = PolicyPeriodFromDate;
	}
	...
	public void setEachEmployeeLimit(int EachEmployeeLimit) {
		this.EachEmployeeLimit = EachEmployeeLimit;
	}
	public void setPolicyPeriodHeader(String PolicyPeriodHeader) {
		this.PolicyPeriodHeader = PolicyPeriodHeader;
	}
	...
	public void setPolicyPeriodToDate(Date PolicyPeriodToDate) {
		this.PolicyPeriodToDate = PolicyPeriodToDate;
	}
