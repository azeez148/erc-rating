...
public class BOPSnowPlowProdsCompldOpsHzdCov  {
	...
	private com.nest.res.bop.al09012019.domain.BOPSnowPlowProdsCompldOpsHzdCov BOPSnowPlowProdsCompldOpsHzdCov;
	
	
	
	public  BOPSnowPlowProdsCompldOpsHzdCov (com.nest.res.bop.al09012019.domain.BOPSnowPlowProdsCompldOpsHzdCov BOPSnowPlowProdsCompldOpsHzdCov)  {
