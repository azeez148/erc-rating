...
public class BOPOrdinanceOrLawIncrdPeriodOfRestorationCoverage    extends Policy  {
	...
	private String BusnIncomeAndExtraExpenseOptionalCoverage;
	...
	private String HoursWaitingPeriod;
	...
	private int HoursWaitingPeriodOther;
	...
	public int  getHoursWaitingPeriodOther() {
		return this.HoursWaitingPeriodOther;
	}
	...
	public String  getHoursWaitingPeriod() {
		return this.HoursWaitingPeriod;
	}
	public Date  getCreated() {
		return this.Created;
	}
	public String  getBusnIncomeAndExtraExpenseOptionalCoverage() {
		return this.BusnIncomeAndExtraExpenseOptionalCoverage;
	}
	...
	public void setHoursWaitingPeriod(String HoursWaitingPeriod) {
		this.HoursWaitingPeriod = HoursWaitingPeriod;
	}
	...
	public void setBusnIncomeAndExtraExpenseOptionalCoverage(String BusnIncomeAndExtraExpenseOptionalCoverage) {
		this.BusnIncomeAndExtraExpenseOptionalCoverage = BusnIncomeAndExtraExpenseOptionalCoverage;
	}
	...
	public void setHoursWaitingPeriodOther(int HoursWaitingPeriodOther) {
		this.HoursWaitingPeriodOther = HoursWaitingPeriodOther;
	}
