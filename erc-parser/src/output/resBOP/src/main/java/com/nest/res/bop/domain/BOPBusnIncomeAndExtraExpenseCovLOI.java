...
public class BOPBusnIncomeAndExtraExpenseCovLOI    extends Policy  {
	...
	private double BldgLimitFactor;
	private int TaxIndicator;
	private int PremiumIndicator;
	private double AdjBldgLimit;
	private Date Expiration;
	private double totBPPPremium_1;
	private double ChangePremium;
	private int ShortRateIndicator;
	private double BPPLimitFactor;
	...
	private double modifiedBPPLimitFactor_1;
	private Date RateDt;
	...
	private double modifiedBldgLimitFactor_1;
	private double AdjBPPLimit;
	...
	private double totBldgPremium_1;
	...
	public double  getBldgLimitFactor() {
		return this.BldgLimitFactor;
	}
	...
	public double  getModifiedBldgLimitFactor_1() {
		return this.modifiedBldgLimitFactor_1;
	}
	...
	public double  getTotBldgPremium_1() {
		return this.totBldgPremium_1;
	}
	public double  getTotBPPPremium_1() {
		return this.totBPPPremium_1;
	}
	public String  getType() {
		return this.Type;
	}
	public double  getBPPLimitFactor() {
		return this.BPPLimitFactor;
	}
	...
	public double  getAdjBPPLimit() {
		return this.AdjBPPLimit;
	}
	...
	public double  getAdjBldgLimit() {
		return this.AdjBldgLimit;
	}
	...
	public double  getModifiedBPPLimitFactor_1() {
		return this.modifiedBPPLimitFactor_1;
	}
	...
	public void setBldgLimitFactor(double BldgLimitFactor) {
		this.BldgLimitFactor = BldgLimitFactor;
	}
	public void setTotBPPPremium_1(double totBPPPremium_1) {
		this.totBPPPremium_1 = totBPPPremium_1;
	}
	...
	public void setTotBldgPremium_1(double totBldgPremium_1) {
		this.totBldgPremium_1 = totBldgPremium_1;
	}
	...
	public void setAdjBldgLimit(double AdjBldgLimit) {
		this.AdjBldgLimit = AdjBldgLimit;
	}
	public void setModifiedBPPLimitFactor_1(double modifiedBPPLimitFactor_1) {
		this.modifiedBPPLimitFactor_1 = modifiedBPPLimitFactor_1;
	}
	...
	public void setBPPLimitFactor(double BPPLimitFactor) {
		this.BPPLimitFactor = BPPLimitFactor;
	}
	public void setEffectiveDt(Date EffectiveDt) {
		this.EffectiveDt = EffectiveDt;
	}
	public void setAdjBPPLimit(double AdjBPPLimit) {
		this.AdjBPPLimit = AdjBPPLimit;
	}
	...
	public void setModifiedBldgLimitFactor_1(double modifiedBldgLimitFactor_1) {
		this.modifiedBldgLimitFactor_1 = modifiedBldgLimitFactor_1;
	}
}