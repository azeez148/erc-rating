...
public class BOPAdditionalEarthquakeCov    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private double PolicyTermPremium;
	private Date Modified;
	private String ReconstructionCostLimit;
	...
	private int ReconstructionCostsLimit;
	...
	public int  getReconstructionCostsLimit() {
		return this.ReconstructionCostsLimit;
	}
	...
	public String  getReconstructionCostLimit() {
		return this.ReconstructionCostLimit;
	}
	...
	public void setReconstructionCostsLimit(int ReconstructionCostsLimit) {
		this.ReconstructionCostsLimit = ReconstructionCostsLimit;
	}
	...
	public void setReconstructionCostLimit(String ReconstructionCostLimit) {
		this.ReconstructionCostLimit = ReconstructionCostLimit;
	}
