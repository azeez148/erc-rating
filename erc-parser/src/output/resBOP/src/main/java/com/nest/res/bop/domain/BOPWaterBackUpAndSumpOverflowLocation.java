...
public class BOPWaterBackUpAndSumpOverflowLocation    extends Policy  {
	private int FeeIndicator;
	private String CoveredPropertyAnnualAggregateLimit;
	...
	private int BodilyInjuryExtraExpenseAnnualAggregateLimitOverride;
	private int bppLimit_1;
	private String CreatedBy;
	private String BusinessIncomeExtraExpenseAnnualAggregateLimit;
	...
	private int BusinessIncomeExtraExpenseAnnualAggregateLimitOverride;
	...
	private String BodilyInjuryExtraExpenseAnnualAggregateLimit;
	...
	private int CoveredPropertyAnnualAggregateLimitOverride;
	private String busnPrsnlPropReplmtCostCoverage;
	...
	public String  getCoveredPropertyAnnualAggregateLimit() {
		return this.CoveredPropertyAnnualAggregateLimit;
	}
	...
	public int  getBppLimit_1() {
		return this.bppLimit_1;
	}
	public String  getBusinessIncomeExtraExpenseAnnualAggregateLimit() {
		return this.BusinessIncomeExtraExpenseAnnualAggregateLimit;
	}
	public int  getCoveredPropertyAnnualAggregateLimitOverride() {
		return this.CoveredPropertyAnnualAggregateLimitOverride;
	}
	...
	public String  getBusnPrsnlPropReplmtCostCoverage() {
		return this.busnPrsnlPropReplmtCostCoverage;
	}
	...
	public String  getBodilyInjuryExtraExpenseAnnualAggregateLimit() {
		return this.BodilyInjuryExtraExpenseAnnualAggregateLimit;
	}
	...
	public int  getBodilyInjuryExtraExpenseAnnualAggregateLimitOverride() {
		return this.BodilyInjuryExtraExpenseAnnualAggregateLimitOverride;
	}
	...
	public int  getBusinessIncomeExtraExpenseAnnualAggregateLimitOverride() {
		return this.BusinessIncomeExtraExpenseAnnualAggregateLimitOverride;
	}
	...
	public void setBusinessIncomeExtraExpenseAnnualAggregateLimit(String BusinessIncomeExtraExpenseAnnualAggregateLimit) {
		this.BusinessIncomeExtraExpenseAnnualAggregateLimit = BusinessIncomeExtraExpenseAnnualAggregateLimit;
	}
	public void setEarnedInFullIndicator(int EarnedInFullIndicator) {
		this.EarnedInFullIndicator = EarnedInFullIndicator;
	}
	public void setBppLimit_1(int bppLimit_1) {
		this.bppLimit_1 = bppLimit_1;
	}
	...
	public void setBodilyInjuryExtraExpenseAnnualAggregateLimitOverride(int BodilyInjuryExtraExpenseAnnualAggregateLimitOverride) {
		this.BodilyInjuryExtraExpenseAnnualAggregateLimitOverride = BodilyInjuryExtraExpenseAnnualAggregateLimitOverride;
	}
	...
	public void setBusnPrsnlPropReplmtCostCoverage(String busnPrsnlPropReplmtCostCoverage) {
		this.busnPrsnlPropReplmtCostCoverage = busnPrsnlPropReplmtCostCoverage;
	}
	...
	public void setCoveredPropertyAnnualAggregateLimit(String CoveredPropertyAnnualAggregateLimit) {
		this.CoveredPropertyAnnualAggregateLimit = CoveredPropertyAnnualAggregateLimit;
	}
	...
	public void setBusinessIncomeExtraExpenseAnnualAggregateLimitOverride(int BusinessIncomeExtraExpenseAnnualAggregateLimitOverride) {
		this.BusinessIncomeExtraExpenseAnnualAggregateLimitOverride = BusinessIncomeExtraExpenseAnnualAggregateLimitOverride;
	}
	...
	public void setBodilyInjuryExtraExpenseAnnualAggregateLimit(String BodilyInjuryExtraExpenseAnnualAggregateLimit) {
		this.BodilyInjuryExtraExpenseAnnualAggregateLimit = BodilyInjuryExtraExpenseAnnualAggregateLimit;
	}
	...
	public void setCoveredPropertyAnnualAggregateLimitOverride(int CoveredPropertyAnnualAggregateLimitOverride) {
		this.CoveredPropertyAnnualAggregateLimitOverride = CoveredPropertyAnnualAggregateLimitOverride;
	}
