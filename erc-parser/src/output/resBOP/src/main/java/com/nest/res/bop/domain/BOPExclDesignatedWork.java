...
public class BOPExclDesignatedWork    extends Policy  {
	...
	public String  getDescOfYourWork() {
		return this.DescOfYourWork;
	}
	...
	public void setDescOfYourWork(String DescOfYourWork) {
		this.DescOfYourWork = DescOfYourWork;
	}
