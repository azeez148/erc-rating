...
public class BOPOrdinanceOrLawCov3BroadCoverage    extends Policy  {
	...
	public int  getInclLimit() {
		return this.InclLimit;
	}
	...
	public void setInclLimit(int InclLimit) {
		this.InclLimit = InclLimit;
	}
