...
public class BOPCommercialPesticideApplicators    extends Policy  {
	private String ProdsCompltdOperationsAggLimit;
	...
	private String OtherThanProdsCompltdOperationsAggLimit;
	...
	private String EachOccPropDamageLimit;
	...
	public String  getProdsCompltdOperationsAggLimit() {
		return this.ProdsCompltdOperationsAggLimit;
	}
	...
	public String  getOtherThanProdsCompltdOperationsAggLimit() {
		return this.OtherThanProdsCompltdOperationsAggLimit;
	}
	...
	public String  getEachOccBILimit() {
		return this.EachOccBILimit;
	}
	public int  getPremiumIndicator() {
		return this.PremiumIndicator;
	}
	public String  getEachOccPropDamageLimit() {
		return this.EachOccPropDamageLimit;
	}
	...
	public void setOtherThanProdsCompltdOperationsAggLimit(String OtherThanProdsCompltdOperationsAggLimit) {
		this.OtherThanProdsCompltdOperationsAggLimit = OtherThanProdsCompltdOperationsAggLimit;
	}
	...
	public void setEachOccPropDamageLimit(String EachOccPropDamageLimit) {
		this.EachOccPropDamageLimit = EachOccPropDamageLimit;
	}
	...
	public void setEachOccBILimit(String EachOccBILimit) {
		this.EachOccBILimit = EachOccBILimit;
	}
	...
	public void setProdsCompltdOperationsAggLimit(String ProdsCompltdOperationsAggLimit) {
		this.ProdsCompltdOperationsAggLimit = ProdsCompltdOperationsAggLimit;
	}
}