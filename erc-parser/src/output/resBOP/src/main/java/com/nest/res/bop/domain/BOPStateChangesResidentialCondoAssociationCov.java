...
public class BOPStateChangesResidentialCondoAssociationCov    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private String AdditionalCoveredProperty;
	...
	public String  getAdditionalCoveredProperty() {
		return this.AdditionalCoveredProperty;
	}
	...
	public void setAdditionalCoveredProperty(String AdditionalCoveredProperty) {
		this.AdditionalCoveredProperty = AdditionalCoveredProperty;
	}
