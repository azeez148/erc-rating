...
public class BOPLossPayable    extends Policy  {
	...
	private List<BOPLossPayableDetail> BOPLossPayableDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPLossPayableDetail) {
			childs.addAll(BOPLossPayableDetail);
		}
		return childs;
	}
	...
	public List<BOPLossPayableDetail> getBOPLossPayableDetail() {
		return this.BOPLossPayableDetail;
	}
	...
	public void setBOPLossPayableDetail(List<BOPLossPayableDetail> BOPLossPayableDetail) {
		this.BOPLossPayableDetail = BOPLossPayableDetail;
	}
