...
public class CommercialInlandMarineConditionalExclusionOfTerrorismDispositionOfAct2002Detail    extends Policy  {
	...
	private String CoverageFormPartPolicy;
	...
	public String  getCoverageFormPartPolicy() {
		return this.CoverageFormPartPolicy;
	}
	...
	public void setCoverageFormPartPolicy(String CoverageFormPartPolicy) {
		this.CoverageFormPartPolicy = CoverageFormPartPolicy;
	}
