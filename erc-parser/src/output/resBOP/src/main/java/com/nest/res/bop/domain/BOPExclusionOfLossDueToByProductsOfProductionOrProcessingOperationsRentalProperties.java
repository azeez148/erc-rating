...
public class BOPExclusionOfLossDueToByProductsOfProductionOrProcessingOperationsRentalProperties    extends Policy  {
	private String DescriptionOfRentalUnit;
	...
	public String  getDescriptionOfRentalUnit() {
		return this.DescriptionOfRentalUnit;
	}
	...
	public void setDescriptionOfRentalUnit(String DescriptionOfRentalUnit) {
		this.DescriptionOfRentalUnit = DescriptionOfRentalUnit;
	}
