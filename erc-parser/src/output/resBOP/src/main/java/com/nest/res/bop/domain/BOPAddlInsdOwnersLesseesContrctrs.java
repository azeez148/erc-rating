...
public class BOPAddlInsdOwnersLesseesContrctrs    extends Policy  {
	...
	private List<BOPAddlInsdOwnersLesseesContrctrsDetail> BOPAddlInsdOwnersLesseesContrctrsDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdOwnersLesseesContrctrsDetail) {
			childs.addAll(BOPAddlInsdOwnersLesseesContrctrsDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdOwnersLesseesContrctrsDetail> getBOPAddlInsdOwnersLesseesContrctrsDetail() {
		return this.BOPAddlInsdOwnersLesseesContrctrsDetail;
	}
	...
	public void setBOPAddlInsdOwnersLesseesContrctrsDetail(List<BOPAddlInsdOwnersLesseesContrctrsDetail> BOPAddlInsdOwnersLesseesContrctrsDetail) {
