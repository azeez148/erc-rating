...
public class BOPAddlInsdCoOwnerInsdPremisesDetail    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private Date Modified;
	private double PolicyTermPremium;
	private String LocationOfPremises;
	...
	public String  getLocationOfPremises() {
		return this.LocationOfPremises;
	}
	...
	public void setLocationOfPremises(String LocationOfPremises) {
		this.LocationOfPremises = LocationOfPremises;
	}
