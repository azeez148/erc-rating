...
public class BOPStructuralPesticideApplicators    extends Policy  {
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private int ProductsCompletedOperationsAggregateLimit;
	...
	private int OtherThanProductsCompletedOperationsAggregateLimit;
	private Date Effective;
	private double ChangePremium;
	private int EachOccurrenceBodilyInjuryLimit;
	...
	private int EachOccurrencePropertyDamageLimit;
	...
	public int  getProductsCompletedOperationsAggregateLimit() {
		return this.ProductsCompletedOperationsAggregateLimit;
	}
	...
	public int  getOtherThanProductsCompletedOperationsAggregateLimit() {
		return this.OtherThanProductsCompletedOperationsAggregateLimit;
	}
	...
	public int  getEachOccurrenceBodilyInjuryLimit() {
		return this.EachOccurrenceBodilyInjuryLimit;
	}
	...
	public int  getEachOccurrencePropertyDamageLimit() {
		return this.EachOccurrencePropertyDamageLimit;
	}
	...
	public void setEachOccurrencePropertyDamageLimit(int EachOccurrencePropertyDamageLimit) {
		this.EachOccurrencePropertyDamageLimit = EachOccurrencePropertyDamageLimit;
	}
	...
	public void setEachOccurrenceBodilyInjuryLimit(int EachOccurrenceBodilyInjuryLimit) {
		this.EachOccurrenceBodilyInjuryLimit = EachOccurrenceBodilyInjuryLimit;
	}
	public void setFeeIndicator(int FeeIndicator) {
		this.FeeIndicator = FeeIndicator;
	}
	public void setProductsCompletedOperationsAggregateLimit(int ProductsCompletedOperationsAggregateLimit) {
		this.ProductsCompletedOperationsAggregateLimit = ProductsCompletedOperationsAggregateLimit;
	}
	...
	public void setOtherThanProductsCompletedOperationsAggregateLimit(int OtherThanProductsCompletedOperationsAggregateLimit) {
		this.OtherThanProductsCompletedOperationsAggregateLimit = OtherThanProductsCompletedOperationsAggregateLimit;
	}
