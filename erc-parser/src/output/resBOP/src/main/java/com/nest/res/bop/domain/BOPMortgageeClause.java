...
public class BOPMortgageeClause    extends Policy  {
	...
	public String  getNameOfInsCo() {
		return this.NameOfInsCo;
	}
	...
	public void setNameOfInsCo(String NameOfInsCo) {
		this.NameOfInsCo = NameOfInsCo;
	}
