...
public class BOPAddlInsdControllingInterest    extends Policy  {
	...
	private List<BOPAddlInsdControllingInterestDetail> BOPAddlInsdControllingInterestDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPAddlInsdControllingInterestDetail) {
			childs.addAll(BOPAddlInsdControllingInterestDetail);
		}
		return childs;
	}
	...
	public List<BOPAddlInsdControllingInterestDetail> getBOPAddlInsdControllingInterestDetail() {
		return this.BOPAddlInsdControllingInterestDetail;
	}
	...
	public void setBOPAddlInsdControllingInterestDetail(List<BOPAddlInsdControllingInterestDetail> BOPAddlInsdControllingInterestDetail) {
		this.BOPAddlInsdControllingInterestDetail = BOPAddlInsdControllingInterestDetail;
	}
