...
public class BOPOrdinanceOrLawCov2And3Coverage    extends Policy  {
	...
	private Date RateDt;
	private int Cov3InclddLimit;
	private Date EffectiveDt;
	private double ProRatedPremium;
	private double workingLimit_1;
	...
	public double  getWorkingLimit_1() {
		return this.workingLimit_1;
	}
	...
	public int  getCov3InclddLimit() {
		return this.Cov3InclddLimit;
	}
	...
	public void setCov3InclddLimit(int Cov3InclddLimit) {
		this.Cov3InclddLimit = Cov3InclddLimit;
	}
	public void setWorkingLimit_1(double workingLimit_1) {
		this.workingLimit_1 = workingLimit_1;
	}
