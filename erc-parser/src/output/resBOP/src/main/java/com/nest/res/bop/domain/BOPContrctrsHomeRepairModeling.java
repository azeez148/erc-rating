...
public class BOPContrctrsHomeRepairModeling    extends Policy  {
	...
	public int  getPerOccurrence() {
		return this.PerOccurrence;
	}
	...
	public String  getLiabilityLimitHeader() {
		return this.LiabilityLimitHeader;
	}
	...
	public void setLiabilityLimitHeader(String LiabilityLimitHeader) {
		this.LiabilityLimitHeader = LiabilityLimitHeader;
	}
	public void setVersionedId(String VersionedId) {
		this.VersionedId = VersionedId;
	}
	public void setPerOccurrence(int PerOccurrence) {
		this.PerOccurrence = PerOccurrence;
	}
