...
public class BOPEmployeeDishonestyNamedEmployees    extends Policy  {
	...
	private List<BOPEmployeeDishonestyNamedEmployeesDetail> BOPEmployeeDishonestyNamedEmployeesDetail;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPEmployeeDishonestyNamedEmployeesDetail) {
			childs.addAll(BOPEmployeeDishonestyNamedEmployeesDetail);
		}
		return childs;
	}
	...
	public List<BOPEmployeeDishonestyNamedEmployeesDetail> getBOPEmployeeDishonestyNamedEmployeesDetail() {
		return this.BOPEmployeeDishonestyNamedEmployeesDetail;
	}
	public String  getId() {
		return this.Id;
	}
	...
	public void setBOPEmployeeDishonestyNamedEmployeesDetail(List<BOPEmployeeDishonestyNamedEmployeesDetail> BOPEmployeeDishonestyNamedEmployeesDetail) {
		this.BOPEmployeeDishonestyNamedEmployeesDetail = BOPEmployeeDishonestyNamedEmployeesDetail;
	}
