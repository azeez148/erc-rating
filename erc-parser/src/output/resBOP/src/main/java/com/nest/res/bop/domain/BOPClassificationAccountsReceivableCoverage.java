...
public class BOPClassificationAccountsReceivableCoverage    extends Policy  {
	...
	private int OffPremisesInclddLimit;
	...
	private Date RateDt;
	private int OnPremisesInclddLimit;
	...
	public int  getOffPremisesInclddLimit() {
		return this.OffPremisesInclddLimit;
	}
	...
	public int  getOnPremisesInclddLimit() {
		return this.OnPremisesInclddLimit;
	}
	...
	public void setOffPremisesInclddLimit(int OffPremisesInclddLimit) {
		this.OffPremisesInclddLimit = OffPremisesInclddLimit;
	}
	...
	public void setOnPremisesInclddLimit(int OnPremisesInclddLimit) {
		this.OnPremisesInclddLimit = OnPremisesInclddLimit;
	}
