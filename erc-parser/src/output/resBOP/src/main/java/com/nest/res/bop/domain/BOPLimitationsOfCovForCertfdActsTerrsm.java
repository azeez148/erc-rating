...
public class BOPLimitationsOfCovForCertfdActsTerrsm    extends Policy  {
	private int FeeIndicator;
	private String FormNumber;
	private double PolicyTermPremium;
	private int AggregateLimitAsInteger;
	private double EndYearProrateFactor;
	...
	private int CertifiedActsOfTerrorismAggLimit;
	private int EndYear;
	...
	public int  getPolicyTermDays() {
		return this.PolicyTermDays;
	}
	...
	public double  getEndYearProrateFactor() {
		return this.EndYearProrateFactor;
	}
	...
	public String  getCertifiedActsOfTerrorismAggregateLimit() {
		return this.CertifiedActsOfTerrorismAggregateLimit;
	}
	...
	public int  getCertifiedActsOfTerrorismAggLimit() {
		return this.CertifiedActsOfTerrorismAggLimit;
	}
	...
	public int  getEndYearNumDays() {
		return this.EndYearNumDays;
	}
	...
	public int  getBeginYearNumDays() {
		return this.BeginYearNumDays;
	}
	...
	public String  getCertifiedActsSubLimit() {
		return this.CertifiedActsSubLimit;
	}
	...
	public double  getBeginYearProrateFactor() {
		return this.BeginYearProrateFactor;
	}
	...
	public void setEndYearNumDays(int EndYearNumDays) {
		this.EndYearNumDays = EndYearNumDays;
	}
	...
	public void setCertifiedActsSubLimit(String CertifiedActsSubLimit) {
		this.CertifiedActsSubLimit = CertifiedActsSubLimit;
	}
	public void setCertifiedActsOfTerrorismAggLimit(int CertifiedActsOfTerrorismAggLimit) {
		this.CertifiedActsOfTerrorismAggLimit = CertifiedActsOfTerrorismAggLimit;
	}
	public void setEndYear(int EndYear) {
		this.EndYear = EndYear;
	}
	public void setEndYearProrateFactor(double EndYearProrateFactor) {
		this.EndYearProrateFactor = EndYearProrateFactor;
	}
	public void setAggregateLimitAsInteger(int AggregateLimitAsInteger) {
		this.AggregateLimitAsInteger = AggregateLimitAsInteger;
	}
	public void setBeginYearNumDays(int BeginYearNumDays) {
		this.BeginYearNumDays = BeginYearNumDays;
	}
	...
	public void setBeginYearProrateFactor(double BeginYearProrateFactor) {
		this.BeginYearProrateFactor = BeginYearProrateFactor;
	}
	...
	public void setPolicyTermDays(int PolicyTermDays) {
		this.PolicyTermDays = PolicyTermDays;
	}
	...
	public void setCertifiedActsOfTerrorismAggregateLimit(String CertifiedActsOfTerrorismAggregateLimit) {
		this.CertifiedActsOfTerrorismAggregateLimit = CertifiedActsOfTerrorismAggregateLimit;
	}
