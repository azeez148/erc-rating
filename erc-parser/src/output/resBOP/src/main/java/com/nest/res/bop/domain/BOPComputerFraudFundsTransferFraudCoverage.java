...
public class BOPComputerFraudFundsTransferFraudCoverage    extends Policy  {
	...
	private int numberOfAdditionalLocations;
	...
	private int NumEmployeesMinus5;
	...
	public int  getNumAddlLocations() {
		return this.NumAddlLocations;
	}
	...
	public int  getNumberOfAdditionalLocations() {
		return this.numberOfAdditionalLocations;
	}
	...
	public int  getNumEmployeesMinus5() {
		return this.NumEmployeesMinus5;
	}
	...
	public void setNumberOfAdditionalLocations(int numberOfAdditionalLocations) {
		this.numberOfAdditionalLocations = numberOfAdditionalLocations;
	}
	...
	public void setMaximumExposure(int MaximumExposure) {
	...
	public void setNumAddlLocations(int NumAddlLocations) {
		this.NumAddlLocations = NumAddlLocations;
	}
	...
	public void setNumEmployeesMinus5(int NumEmployeesMinus5) {
		this.NumEmployeesMinus5 = NumEmployeesMinus5;
	}
