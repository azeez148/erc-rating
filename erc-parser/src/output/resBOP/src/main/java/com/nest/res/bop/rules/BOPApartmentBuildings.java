...
public class BOPApartmentBuildings  {
	...
	private com.nest.res.bop.domain.BOPApartmentBuildings BOPApartmentBuildings;
	
	
	
	public  BOPApartmentBuildings (com.nest.res.bop.domain.BOPApartmentBuildings BOPApartmentBuildings)  {
	...
	public void PremiumIndicator ()  {
		...
		if(this.BOPApartmentBuildings.getPremium() != (double)0.0){
			this.BOPApartmentBuildings.setPremiumIndicator((int)1.0);
		}
		else{
			this.BOPApartmentBuildings.setPremiumIndicator((int)0.0);
		}
