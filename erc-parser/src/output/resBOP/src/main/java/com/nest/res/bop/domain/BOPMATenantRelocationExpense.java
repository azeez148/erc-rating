...
public class BOPMATenantRelocationExpense    extends Policy  {
	...
	private double AdjdBldgBasicGroupIRate;
	...
	private int NumOfLivingQuarters;
	...
	public double  getAdjdBldgBasicGroupIRate() {
		return this.AdjdBldgBasicGroupIRate;
	}
	...
	public int  getNumOfLivingQuarters() {
		return this.NumOfLivingQuarters;
	}
	...
	public void setAdjdBldgBasicGroupIRate(double AdjdBldgBasicGroupIRate) {
		this.AdjdBldgBasicGroupIRate = AdjdBldgBasicGroupIRate;
	}
	...
	public void setNumOfLivingQuarters(int NumOfLivingQuarters) {
		this.NumOfLivingQuarters = NumOfLivingQuarters;
	}
