...
public class BOPMAChangesLeadPoisoningEndorsement    extends Policy  {
	...
	private int NumCoveredUnits;
	private String FormName;
	private int TermFactorIndicator;
	private int NumUnitsWithLetterInterimControl;
	...
	private int NumUnitsWOLetterInterimControl;
	...
	public int  getNumCoveredUnits() {
		return this.NumCoveredUnits;
	}
	...
	public int  getNumUnitsWOLetterInterimControl() {
		return this.NumUnitsWOLetterInterimControl;
	}
	...
	public int  getNumUnitsWithLetterInterimControl() {
		return this.NumUnitsWithLetterInterimControl;
	}
	...
	public void setNumUnitsWithLetterInterimControl(int NumUnitsWithLetterInterimControl) {
		this.NumUnitsWithLetterInterimControl = NumUnitsWithLetterInterimControl;
	}
	...
	public void setNumUnitsWOLetterInterimControl(int NumUnitsWOLetterInterimControl) {
		this.NumUnitsWOLetterInterimControl = NumUnitsWOLetterInterimControl;
	}
	...
	public void setNumCoveredUnits(int NumCoveredUnits) {
		this.NumCoveredUnits = NumCoveredUnits;
	}
