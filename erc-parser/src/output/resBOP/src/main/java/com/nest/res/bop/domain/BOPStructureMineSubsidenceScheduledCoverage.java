...
public class BOPStructureMineSubsidenceScheduledCoverage    extends Policy  {
	private int FeeIndicator;
	private double MinePremium;
	...
	private double MineSubsidenceAdditionalPremium;
	...
	private double AdditionalLivingExpensePremium;
	private int EarnedInFullIndicator;
	private double MineAdditionalPremium;
	private int dsLimit;
	...
	public double  getAdditionalLivingExpensePremium() {
		return this.AdditionalLivingExpensePremium;
	}
	public double  getEvaluatedPremium() {
		return this.EvaluatedPremium;
	}
	public double  getMineSubsidenceAdditionalPremium() {
		return this.MineSubsidenceAdditionalPremium;
	}
	...
	public int  getAdditionalLivingExpensesLimit() {
		return this.AdditionalLivingExpensesLimit;
	}
	...
	public double  getMineAdditionalPremium() {
		return this.MineAdditionalPremium;
	}
	public int  getEarnedInFullIndicator() {
		return this.EarnedInFullIndicator;
	}
	public double  getManualPremiumALE() {
		return this.ManualPremiumALE;
	}
	...
	public double  getMinePremium() {
		return this.MinePremium;
	}
	...
	public double  getMineBuildingPremium() {
		return this.MineBuildingPremium;
	}
	public double  getAddlFactor() {
		return this.AddlFactor;
	}
	...
	public void setAdditionalLivingExpensePremium(double AdditionalLivingExpensePremium) {
		this.AdditionalLivingExpensePremium = AdditionalLivingExpensePremium;
	}
	public void setMineBuildingPremium(double MineBuildingPremium) {
		this.MineBuildingPremium = MineBuildingPremium;
	}
	...
	public void setMinePremium(double MinePremium) {
		this.MinePremium = MinePremium;
	}
	...
	public void setAddlFactor(double AddlFactor) {
		this.AddlFactor = AddlFactor;
	}
	...
	public void setMineSubsidenceAdditionalPremium(double MineSubsidenceAdditionalPremium) {
		this.MineSubsidenceAdditionalPremium = MineSubsidenceAdditionalPremium;
	}
	...
	public void setAdditionalLivingExpensesLimit(int AdditionalLivingExpensesLimit) {
		this.AdditionalLivingExpensesLimit = AdditionalLivingExpensesLimit;
	}
	...
	public void setMineAdditionalPremium(double MineAdditionalPremium) {
		this.MineAdditionalPremium = MineAdditionalPremium;
	}
	...
	public void setManualPremiumALE(double ManualPremiumALE) {
		this.ManualPremiumALE = ManualPremiumALE;
	}
