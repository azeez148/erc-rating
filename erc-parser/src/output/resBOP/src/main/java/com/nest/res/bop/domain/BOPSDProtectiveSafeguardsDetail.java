...
public class BOPSDProtectiveSafeguardsDetail    extends Policy  {
	...
	public String  getProtectiveDeviceOrService() {
		return this.ProtectiveDeviceOrService;
	}
	...
	public String  getDescProtectiveDevice() {
		return this.DescProtectiveDevice;
	}
	...
	public String  getAlarmProtection() {
		return this.AlarmProtection;
	}
	...
	public void setP9Desc(String P9Desc) {
		this.P9Desc = P9Desc;
	}
	...
	public void setProtectiveDeviceOrService(String ProtectiveDeviceOrService) {
		this.ProtectiveDeviceOrService = ProtectiveDeviceOrService;
	}
	...
	public void setDescProtectiveDevice(String DescProtectiveDevice) {
		this.DescProtectiveDevice = DescProtectiveDevice;
	}
	...
	public void setAlarmProtection(String AlarmProtection) {
		this.AlarmProtection = AlarmProtection;
	}
