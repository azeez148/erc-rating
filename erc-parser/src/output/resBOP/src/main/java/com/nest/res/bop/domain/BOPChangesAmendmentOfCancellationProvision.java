...
public class BOPChangesAmendmentOfCancellationProvision    extends Policy  {
	...
	private int NumberDaysAdvanceNotice;
	...
	public int  getNumberDaysAdvanceNotice() {
		return this.NumberDaysAdvanceNotice;
	}
	...
	public void setNumberDaysAdvanceNotice(int NumberDaysAdvanceNotice) {
		this.NumberDaysAdvanceNotice = NumberDaysAdvanceNotice;
	}
