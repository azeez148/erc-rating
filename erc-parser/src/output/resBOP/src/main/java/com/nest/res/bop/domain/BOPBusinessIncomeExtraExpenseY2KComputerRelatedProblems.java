...
public class BOPBusinessIncomeExtraExpenseY2KComputerRelatedProblems    extends Policy  {
	...
	public String  getDescPremises() {
		return this.DescPremises;
	}
	...
	public void setDescPremises(String DescPremises) {
		this.DescPremises = DescPremises;
	}
