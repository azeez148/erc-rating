...
public class BOPY2KComputerRelatedProblemsExclSpecifiedCov    extends Policy  {
	private String ASLOBStatCode;
	private int FeeIndicator;
	private double AnnualPremium;
	private String FormNumber;
	private String PersonalAdvertisingInjuryExcl;
	...
	private List<BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail> BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail;
	private String BodilyInjuryExcl;
	...
	private String PropertyDamageExcl;
	...
	public List<Policy> getChilds() {
		...
		if(null != BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail) {
			childs.addAll(BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail);
		}
		return childs;
	}
	...
	public String  getPersonalAdvertisingInjuryExcl() {
		return this.PersonalAdvertisingInjuryExcl;
	}
	public String  getPriorId() {
		return this.PriorId;
	}
	public String  getPropertyDamageExcl() {
		return this.PropertyDamageExcl;
	}
	...
	public String  getBodilyInjuryExcl() {
		return this.BodilyInjuryExcl;
	}
	...
	public List<BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail> getBOPY2KComputerRelatedProblemsExclSpecifiedCovDetail() {
		return this.BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail;
	}
	...
	public void setPersonalAdvertisingInjuryExcl(String PersonalAdvertisingInjuryExcl) {
		this.PersonalAdvertisingInjuryExcl = PersonalAdvertisingInjuryExcl;
	}
	...
	public void setPropertyDamageExcl(String PropertyDamageExcl) {
		this.PropertyDamageExcl = PropertyDamageExcl;
	}
	...
	public void setBodilyInjuryExcl(String BodilyInjuryExcl) {
		this.BodilyInjuryExcl = BodilyInjuryExcl;
	}
	public void setBOPY2KComputerRelatedProblemsExclSpecifiedCovDetail(List<BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail> BOPY2KComputerRelatedProblemsExclSpecifiedCovDetail) {
