...
public interface JavaERCProjectService {
	public String pingTemplate();
	
	//public boolean buildJavaProject(Map<String, PojoClassConstruct> pojoClassMap, AlgParserOutput algParserOutput,LOBName lobName );
	public boolean buildJavaProject(ERCProcessorOutput ercProcessorOutput,String lobName );
...
//	public boolean writePojoClass(ERCProcessorOutput ercProcessorOutput, String projectName, String className, String serverport, String projectMainPackageStructure,String lobName)
//			throws FileNotFoundException, IOException;
	...
	// Changes for micro service changes
